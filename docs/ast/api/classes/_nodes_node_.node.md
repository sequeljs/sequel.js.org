---
id: '_nodes_node_.node'
title: 'Node'
sidebar_label: 'Node'
---

[@sequeljs/ast](../index.md) › [Globals](../globals.md) ›
["nodes/Node"](../modules/_nodes_node_.md) › [Node](_nodes_node_.node.md)
...
- [NodeMethods](_mixins_nodemethods_.nodemethods.md)
  ...
  ↳ [CurrentRow](_nodes_currentrow_.currentrow.md)
...
- [\_\_sequelASTUnquotable](_nodes_node_.node.md#private-readonly-__sequelastunquotable)

### Methods

- [and](_nodes_node_.node.md#and)
- [coalesce](_nodes_node_.node.md#coalesce)
- [createAnd](_nodes_node_.node.md#createand)
- [createFalse](_nodes_node_.node.md#createfalse)
- [createJoin](_nodes_node_.node.md#createjoin)
- [createOn](_nodes_node_.node.md#createon)
- [createStringJoin](_nodes_node_.node.md#createstringjoin)
- [createTableAlias](_nodes_node_.node.md#createtablealias)
- [createTrue](_nodes_node_.node.md#createtrue)
- [grouping](_nodes_node_.node.md#grouping)
- [lower](_nodes_node_.node.md#lower)
- [not](_nodes_node_.node.md#not)
- [or](_nodes_node_.node.md#or)
- [toSQL](_nodes_node_.node.md#tosql)

## Properties

### `Private` `Readonly` \_\_sequelASTUnquotable

• **\_\_sequelASTUnquotable**: _true_ = true

_Defined in
[src/nodes/Node.ts:14](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/Node.ts#L14)_
