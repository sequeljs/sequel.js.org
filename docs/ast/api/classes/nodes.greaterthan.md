...
[Nodes](../modules/nodes.md) / GreaterThan
...
- [constructor](nodes.greaterthan.md#constructor)

### Properties

- [left](nodes.greaterthan.md#left)
- [right](nodes.greaterthan.md#right)

### Methods

- [add](nodes.greaterthan.md#add)
- [and](nodes.greaterthan.md#and)
- [as](nodes.greaterthan.md#as)
- [asc](nodes.greaterthan.md#asc)
- [average](nodes.greaterthan.md#average)
- [between](nodes.greaterthan.md#between)
- [bitwiseAnd](nodes.greaterthan.md#bitwiseand)
- [bitwiseNot](nodes.greaterthan.md#bitwisenot)
- [bitwiseOr](nodes.greaterthan.md#bitwiseor)
- [bitwiseShiftLeft](nodes.greaterthan.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.greaterthan.md#bitwiseshiftright)
- [bitwiseXor](nodes.greaterthan.md#bitwisexor)
- [coalesce](nodes.greaterthan.md#coalesce)
- [concat](nodes.greaterthan.md#concat)
- [count](nodes.greaterthan.md#count)
- [createAnd](nodes.greaterthan.md#createand)
- [createFalse](nodes.greaterthan.md#createfalse)
- [createJoin](nodes.greaterthan.md#createjoin)
- [createOn](nodes.greaterthan.md#createon)
- [createStringJoin](nodes.greaterthan.md#createstringjoin)
- [createTableAlias](nodes.greaterthan.md#createtablealias)
- [createTrue](nodes.greaterthan.md#createtrue)
- [desc](nodes.greaterthan.md#desc)
- [divide](nodes.greaterthan.md#divide)
- [doesNotMatch](nodes.greaterthan.md#doesnotmatch)
- [doesNotMatchAll](nodes.greaterthan.md#doesnotmatchall)
- [doesNotMatchAny](nodes.greaterthan.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.greaterthan.md#doesnotmatchregexp)
- [eq](nodes.greaterthan.md#eq)
- [eqAll](nodes.greaterthan.md#eqall)
- [eqAny](nodes.greaterthan.md#eqany)
- [extract](nodes.greaterthan.md#extract)
- [grouping](nodes.greaterthan.md#grouping)
- [groupingAll](nodes.greaterthan.md#groupingall)
- [groupingAny](nodes.greaterthan.md#groupingany)
- [gt](nodes.greaterthan.md#gt)
- [gtAll](nodes.greaterthan.md#gtall)
- [gtAny](nodes.greaterthan.md#gtany)
- [gteq](nodes.greaterthan.md#gteq)
- [gteqAll](nodes.greaterthan.md#gteqall)
- [gteqAny](nodes.greaterthan.md#gteqany)
- [inAll](nodes.greaterthan.md#inall)
- [inAny](nodes.greaterthan.md#inany)
- [inVal](nodes.greaterthan.md#inval)
- [isDistinctFrom](nodes.greaterthan.md#isdistinctfrom)
- [isInfinity](nodes.greaterthan.md#isinfinity)
- [isNotDistinctFrom](nodes.greaterthan.md#isnotdistinctfrom)
- [isOpenEnded](nodes.greaterthan.md#isopenended)
- [isUnboundable](nodes.greaterthan.md#isunboundable)
- [lower](nodes.greaterthan.md#lower)
- [lt](nodes.greaterthan.md#lt)
- [ltAll](nodes.greaterthan.md#ltall)
- [ltAny](nodes.greaterthan.md#ltany)
- [lteq](nodes.greaterthan.md#lteq)
- [lteqAll](nodes.greaterthan.md#lteqall)
- [lteqAny](nodes.greaterthan.md#lteqany)
- [matches](nodes.greaterthan.md#matches)
- [matchesAll](nodes.greaterthan.md#matchesall)
- [matchesAny](nodes.greaterthan.md#matchesany)
- [matchesRegexp](nodes.greaterthan.md#matchesregexp)
- [maximum](nodes.greaterthan.md#maximum)
- [minimum](nodes.greaterthan.md#minimum)
- [multiply](nodes.greaterthan.md#multiply)
- [not](nodes.greaterthan.md#not)
- [notBetween](nodes.greaterthan.md#notbetween)
- [notEq](nodes.greaterthan.md#noteq)
- [notEqAll](nodes.greaterthan.md#noteqall)
- [notEqAny](nodes.greaterthan.md#noteqany)
- [notInAll](nodes.greaterthan.md#notinall)
- [notInAny](nodes.greaterthan.md#notinany)
- [notInVal](nodes.greaterthan.md#notinval)
- [or](nodes.greaterthan.md#or)
- [quotedArray](nodes.greaterthan.md#quotedarray)
- [quotedNode](nodes.greaterthan.md#quotednode)
- [subtract](nodes.greaterthan.md#subtract)
- [sum](nodes.greaterthan.md#sum)
- [toSQL](nodes.greaterthan.md#tosql)
- [when](nodes.greaterthan.md#when)

## Constructors

### constructor

\+ **new GreaterThan**(`left`: _any_, `right`: _any_):
