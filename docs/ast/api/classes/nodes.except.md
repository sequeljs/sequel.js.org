...
- [constructor](nodes.except.md#constructor)

### Properties

- [left](nodes.except.md#left)
- [right](nodes.except.md#right)

### Methods

- [add](nodes.except.md#add)
- [and](nodes.except.md#and)
- [as](nodes.except.md#as)
- [asc](nodes.except.md#asc)
- [average](nodes.except.md#average)
- [between](nodes.except.md#between)
- [bitwiseAnd](nodes.except.md#bitwiseand)
- [bitwiseNot](nodes.except.md#bitwisenot)
- [bitwiseOr](nodes.except.md#bitwiseor)
- [bitwiseShiftLeft](nodes.except.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.except.md#bitwiseshiftright)
- [bitwiseXor](nodes.except.md#bitwisexor)
- [coalesce](nodes.except.md#coalesce)
- [concat](nodes.except.md#concat)
- [count](nodes.except.md#count)
- [createAnd](nodes.except.md#createand)
- [createFalse](nodes.except.md#createfalse)
- [createJoin](nodes.except.md#createjoin)
- [createOn](nodes.except.md#createon)
- [createStringJoin](nodes.except.md#createstringjoin)
- [createTableAlias](nodes.except.md#createtablealias)
- [createTrue](nodes.except.md#createtrue)
- [desc](nodes.except.md#desc)
- [divide](nodes.except.md#divide)
- [doesNotMatch](nodes.except.md#doesnotmatch)
- [doesNotMatchAll](nodes.except.md#doesnotmatchall)
- [doesNotMatchAny](nodes.except.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.except.md#doesnotmatchregexp)
- [eq](nodes.except.md#eq)
- [eqAll](nodes.except.md#eqall)
- [eqAny](nodes.except.md#eqany)
- [extract](nodes.except.md#extract)
- [grouping](nodes.except.md#grouping)
- [groupingAll](nodes.except.md#groupingall)
- [groupingAny](nodes.except.md#groupingany)
- [gt](nodes.except.md#gt)
- [gtAll](nodes.except.md#gtall)
- [gtAny](nodes.except.md#gtany)
- [gteq](nodes.except.md#gteq)
- [gteqAll](nodes.except.md#gteqall)
- [gteqAny](nodes.except.md#gteqany)
- [inAll](nodes.except.md#inall)
- [inAny](nodes.except.md#inany)
- [inVal](nodes.except.md#inval)
- [isDistinctFrom](nodes.except.md#isdistinctfrom)
- [isInfinity](nodes.except.md#isinfinity)
- [isNotDistinctFrom](nodes.except.md#isnotdistinctfrom)
- [isOpenEnded](nodes.except.md#isopenended)
- [isUnboundable](nodes.except.md#isunboundable)
- [lower](nodes.except.md#lower)
- [lt](nodes.except.md#lt)
- [ltAll](nodes.except.md#ltall)
- [ltAny](nodes.except.md#ltany)
- [lteq](nodes.except.md#lteq)
- [lteqAll](nodes.except.md#lteqall)
- [lteqAny](nodes.except.md#lteqany)
- [matches](nodes.except.md#matches)
- [matchesAll](nodes.except.md#matchesall)
- [matchesAny](nodes.except.md#matchesany)
- [matchesRegexp](nodes.except.md#matchesregexp)
- [maximum](nodes.except.md#maximum)
- [minimum](nodes.except.md#minimum)
- [multiply](nodes.except.md#multiply)
- [not](nodes.except.md#not)
- [notBetween](nodes.except.md#notbetween)
- [notEq](nodes.except.md#noteq)
- [notEqAll](nodes.except.md#noteqall)
- [notEqAny](nodes.except.md#noteqany)
- [notInAll](nodes.except.md#notinall)
- [notInAny](nodes.except.md#notinany)
- [notInVal](nodes.except.md#notinval)
- [or](nodes.except.md#or)
- [quotedArray](nodes.except.md#quotedarray)
- [quotedNode](nodes.except.md#quotednode)
- [subtract](nodes.except.md#subtract)
- [sum](nodes.except.md#sum)
- [toSQL](nodes.except.md#tosql)
- [when](nodes.except.md#when)

## Constructors

### constructor

\+ **new Except**(`left`: _any_, `right`: _any_): [_Except_](nodes.except.md)
