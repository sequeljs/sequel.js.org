...
[Nodes](../modules/nodes.md) / SelectStatement
...
- [constructor](nodes.selectstatement.md#constructor)

### Properties

- [cores](nodes.selectstatement.md#cores)
- [limit](nodes.selectstatement.md#limit)
- [lock](nodes.selectstatement.md#lock)
- [offset](nodes.selectstatement.md#offset)
- [orders](nodes.selectstatement.md#orders)
- [with](nodes.selectstatement.md#with)

### Methods

- [add](nodes.selectstatement.md#add)
- [and](nodes.selectstatement.md#and)
- [as](nodes.selectstatement.md#as)
- [asc](nodes.selectstatement.md#asc)
- [average](nodes.selectstatement.md#average)
- [between](nodes.selectstatement.md#between)
- [bitwiseAnd](nodes.selectstatement.md#bitwiseand)
- [bitwiseNot](nodes.selectstatement.md#bitwisenot)
- [bitwiseOr](nodes.selectstatement.md#bitwiseor)
- [bitwiseShiftLeft](nodes.selectstatement.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.selectstatement.md#bitwiseshiftright)
- [bitwiseXor](nodes.selectstatement.md#bitwisexor)
- [coalesce](nodes.selectstatement.md#coalesce)
- [concat](nodes.selectstatement.md#concat)
- [count](nodes.selectstatement.md#count)
- [createAnd](nodes.selectstatement.md#createand)
- [createFalse](nodes.selectstatement.md#createfalse)
- [createJoin](nodes.selectstatement.md#createjoin)
- [createOn](nodes.selectstatement.md#createon)
- [createStringJoin](nodes.selectstatement.md#createstringjoin)
- [createTableAlias](nodes.selectstatement.md#createtablealias)
- [createTrue](nodes.selectstatement.md#createtrue)
- [desc](nodes.selectstatement.md#desc)
- [divide](nodes.selectstatement.md#divide)
- [doesNotMatch](nodes.selectstatement.md#doesnotmatch)
- [doesNotMatchAll](nodes.selectstatement.md#doesnotmatchall)
- [doesNotMatchAny](nodes.selectstatement.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.selectstatement.md#doesnotmatchregexp)
- [eq](nodes.selectstatement.md#eq)
- [eqAll](nodes.selectstatement.md#eqall)
- [eqAny](nodes.selectstatement.md#eqany)
- [extract](nodes.selectstatement.md#extract)
- [grouping](nodes.selectstatement.md#grouping)
- [groupingAll](nodes.selectstatement.md#groupingall)
- [groupingAny](nodes.selectstatement.md#groupingany)
- [gt](nodes.selectstatement.md#gt)
- [gtAll](nodes.selectstatement.md#gtall)
- [gtAny](nodes.selectstatement.md#gtany)
- [gteq](nodes.selectstatement.md#gteq)
- [gteqAll](nodes.selectstatement.md#gteqall)
- [gteqAny](nodes.selectstatement.md#gteqany)
- [inAll](nodes.selectstatement.md#inall)
- [inAny](nodes.selectstatement.md#inany)
- [inVal](nodes.selectstatement.md#inval)
- [isDistinctFrom](nodes.selectstatement.md#isdistinctfrom)
- [isInfinity](nodes.selectstatement.md#isinfinity)
- [isNotDistinctFrom](nodes.selectstatement.md#isnotdistinctfrom)
- [isOpenEnded](nodes.selectstatement.md#isopenended)
- [isUnboundable](nodes.selectstatement.md#isunboundable)
- [lower](nodes.selectstatement.md#lower)
- [lt](nodes.selectstatement.md#lt)
- [ltAll](nodes.selectstatement.md#ltall)
- [ltAny](nodes.selectstatement.md#ltany)
- [lteq](nodes.selectstatement.md#lteq)
- [lteqAll](nodes.selectstatement.md#lteqall)
- [lteqAny](nodes.selectstatement.md#lteqany)
- [matches](nodes.selectstatement.md#matches)
- [matchesAll](nodes.selectstatement.md#matchesall)
- [matchesAny](nodes.selectstatement.md#matchesany)
- [matchesRegexp](nodes.selectstatement.md#matchesregexp)
- [maximum](nodes.selectstatement.md#maximum)
- [minimum](nodes.selectstatement.md#minimum)
- [multiply](nodes.selectstatement.md#multiply)
- [not](nodes.selectstatement.md#not)
- [notBetween](nodes.selectstatement.md#notbetween)
- [notEq](nodes.selectstatement.md#noteq)
- [notEqAll](nodes.selectstatement.md#noteqall)
- [notEqAny](nodes.selectstatement.md#noteqany)
- [notInAll](nodes.selectstatement.md#notinall)
- [notInAny](nodes.selectstatement.md#notinany)
- [notInVal](nodes.selectstatement.md#notinval)
- [or](nodes.selectstatement.md#or)
- [quotedArray](nodes.selectstatement.md#quotedarray)
- [quotedNode](nodes.selectstatement.md#quotednode)
- [subtract](nodes.selectstatement.md#subtract)
- [sum](nodes.selectstatement.md#sum)
- [toSQL](nodes.selectstatement.md#tosql)
- [when](nodes.selectstatement.md#when)

## Constructors

### constructor

\+ **new SelectStatement**(`cores?`: [_SelectCore_](nodes.selectcore.md)[]):
...
| ------- | ------------------------------------- | ------------- |
| `cores` | [_SelectCore_](nodes.selectcore.md)[] | ...           |

**Returns:** [_SelectStatement_](nodes.selectstatement.md)

Inherited from: [NodeExpression](nodes.nodeexpression.md)

Defined in:
[src/nodes/SelectStatement.ts:17](https://github.com/sequeljs/ast/blob/6632050/src/nodes/SelectStatement.ts#L17)

## Properties

### cores

• `Readonly` **cores**: [_SelectCore_](nodes.selectcore.md)[]

Defined in:
[src/nodes/SelectStatement.ts:7](https://github.com/sequeljs/ast/blob/6632050/src/nodes/SelectStatement.ts#L7)
...
Defined in:
[src/nodes/SelectStatement.ts:9](https://github.com/sequeljs/ast/blob/6632050/src/nodes/SelectStatement.ts#L9)
...
Defined in:
[src/nodes/SelectStatement.ts:11](https://github.com/sequeljs/ast/blob/6632050/src/nodes/SelectStatement.ts#L11)
...
Defined in:
[src/nodes/SelectStatement.ts:13](https://github.com/sequeljs/ast/blob/6632050/src/nodes/SelectStatement.ts#L13)
...
Defined in:
[src/nodes/SelectStatement.ts:15](https://github.com/sequeljs/ast/blob/6632050/src/nodes/SelectStatement.ts#L15)
