...
- [constructor](nodes.addition.md#constructor)

### Properties

- [left](nodes.addition.md#left)
- [operator](nodes.addition.md#operator)
- [right](nodes.addition.md#right)

### Methods

- [add](nodes.addition.md#add)
- [and](nodes.addition.md#and)
- [as](nodes.addition.md#as)
- [asc](nodes.addition.md#asc)
- [average](nodes.addition.md#average)
- [between](nodes.addition.md#between)
- [bitwiseAnd](nodes.addition.md#bitwiseand)
- [bitwiseNot](nodes.addition.md#bitwisenot)
- [bitwiseOr](nodes.addition.md#bitwiseor)
- [bitwiseShiftLeft](nodes.addition.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.addition.md#bitwiseshiftright)
- [bitwiseXor](nodes.addition.md#bitwisexor)
- [coalesce](nodes.addition.md#coalesce)
- [concat](nodes.addition.md#concat)
- [count](nodes.addition.md#count)
- [createAnd](nodes.addition.md#createand)
- [createFalse](nodes.addition.md#createfalse)
- [createJoin](nodes.addition.md#createjoin)
- [createOn](nodes.addition.md#createon)
- [createStringJoin](nodes.addition.md#createstringjoin)
- [createTableAlias](nodes.addition.md#createtablealias)
- [createTrue](nodes.addition.md#createtrue)
- [desc](nodes.addition.md#desc)
- [divide](nodes.addition.md#divide)
- [doesNotMatch](nodes.addition.md#doesnotmatch)
- [doesNotMatchAll](nodes.addition.md#doesnotmatchall)
- [doesNotMatchAny](nodes.addition.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.addition.md#doesnotmatchregexp)
- [eq](nodes.addition.md#eq)
- [eqAll](nodes.addition.md#eqall)
- [eqAny](nodes.addition.md#eqany)
- [extract](nodes.addition.md#extract)
- [grouping](nodes.addition.md#grouping)
- [groupingAll](nodes.addition.md#groupingall)
- [groupingAny](nodes.addition.md#groupingany)
- [gt](nodes.addition.md#gt)
- [gtAll](nodes.addition.md#gtall)
- [gtAny](nodes.addition.md#gtany)
- [gteq](nodes.addition.md#gteq)
- [gteqAll](nodes.addition.md#gteqall)
- [gteqAny](nodes.addition.md#gteqany)
- [inAll](nodes.addition.md#inall)
- [inAny](nodes.addition.md#inany)
- [inVal](nodes.addition.md#inval)
- [isDistinctFrom](nodes.addition.md#isdistinctfrom)
- [isInfinity](nodes.addition.md#isinfinity)
- [isNotDistinctFrom](nodes.addition.md#isnotdistinctfrom)
- [isOpenEnded](nodes.addition.md#isopenended)
- [isUnboundable](nodes.addition.md#isunboundable)
- [lower](nodes.addition.md#lower)
- [lt](nodes.addition.md#lt)
- [ltAll](nodes.addition.md#ltall)
- [ltAny](nodes.addition.md#ltany)
- [lteq](nodes.addition.md#lteq)
- [lteqAll](nodes.addition.md#lteqall)
- [lteqAny](nodes.addition.md#lteqany)
- [matches](nodes.addition.md#matches)
- [matchesAll](nodes.addition.md#matchesall)
- [matchesAny](nodes.addition.md#matchesany)
- [matchesRegexp](nodes.addition.md#matchesregexp)
- [maximum](nodes.addition.md#maximum)
- [minimum](nodes.addition.md#minimum)
- [multiply](nodes.addition.md#multiply)
- [not](nodes.addition.md#not)
- [notBetween](nodes.addition.md#notbetween)
- [notEq](nodes.addition.md#noteq)
- [notEqAll](nodes.addition.md#noteqall)
- [notEqAny](nodes.addition.md#noteqany)
- [notInAll](nodes.addition.md#notinall)
- [notInAny](nodes.addition.md#notinany)
- [notInVal](nodes.addition.md#notinval)
- [or](nodes.addition.md#or)
- [quotedArray](nodes.addition.md#quotedarray)
- [quotedNode](nodes.addition.md#quotednode)
- [subtract](nodes.addition.md#subtract)
- [sum](nodes.addition.md#sum)
- [toSQL](nodes.addition.md#tosql)
- [when](nodes.addition.md#when)
...
Defined in:
[src/nodes/Addition.ts:3](https://github.com/sequeljs/ast/blob/8de61b1/src/nodes/Addition.ts#L3)
