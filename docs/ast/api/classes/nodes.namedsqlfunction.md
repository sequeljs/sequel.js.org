...
[Nodes](../modules/nodes.md) / NamedSQLFunction

# Class: NamedSQLFunction
...
- [constructor](nodes.namedsqlfunction.md#constructor)

### Properties

- [alias](nodes.namedsqlfunction.md#alias)
- [distinct](nodes.namedsqlfunction.md#distinct)
- [expressions](nodes.namedsqlfunction.md#expressions)
- [name](nodes.namedsqlfunction.md#name)

### Methods

- [add](nodes.namedsqlfunction.md#add)
- [and](nodes.namedsqlfunction.md#and)
- [as](nodes.namedsqlfunction.md#as)
- [asc](nodes.namedsqlfunction.md#asc)
- [average](nodes.namedsqlfunction.md#average)
- [between](nodes.namedsqlfunction.md#between)
- [bitwiseAnd](nodes.namedsqlfunction.md#bitwiseand)
- [bitwiseNot](nodes.namedsqlfunction.md#bitwisenot)
- [bitwiseOr](nodes.namedsqlfunction.md#bitwiseor)
- [bitwiseShiftLeft](nodes.namedsqlfunction.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.namedsqlfunction.md#bitwiseshiftright)
- [bitwiseXor](nodes.namedsqlfunction.md#bitwisexor)
- [coalesce](nodes.namedsqlfunction.md#coalesce)
- [concat](nodes.namedsqlfunction.md#concat)
- [count](nodes.namedsqlfunction.md#count)
- [createAnd](nodes.namedsqlfunction.md#createand)
- [createFalse](nodes.namedsqlfunction.md#createfalse)
- [createJoin](nodes.namedsqlfunction.md#createjoin)
- [createOn](nodes.namedsqlfunction.md#createon)
- [createStringJoin](nodes.namedsqlfunction.md#createstringjoin)
- [createTableAlias](nodes.namedsqlfunction.md#createtablealias)
- [createTrue](nodes.namedsqlfunction.md#createtrue)
- [desc](nodes.namedsqlfunction.md#desc)
- [divide](nodes.namedsqlfunction.md#divide)
- [doesNotMatch](nodes.namedsqlfunction.md#doesnotmatch)
- [doesNotMatchAll](nodes.namedsqlfunction.md#doesnotmatchall)
- [doesNotMatchAny](nodes.namedsqlfunction.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.namedsqlfunction.md#doesnotmatchregexp)
- [eq](nodes.namedsqlfunction.md#eq)
- [eqAll](nodes.namedsqlfunction.md#eqall)
- [eqAny](nodes.namedsqlfunction.md#eqany)
- [extract](nodes.namedsqlfunction.md#extract)
- [grouping](nodes.namedsqlfunction.md#grouping)
- [groupingAll](nodes.namedsqlfunction.md#groupingall)
- [groupingAny](nodes.namedsqlfunction.md#groupingany)
- [gt](nodes.namedsqlfunction.md#gt)
- [gtAll](nodes.namedsqlfunction.md#gtall)
- [gtAny](nodes.namedsqlfunction.md#gtany)
- [gteq](nodes.namedsqlfunction.md#gteq)
- [gteqAll](nodes.namedsqlfunction.md#gteqall)
- [gteqAny](nodes.namedsqlfunction.md#gteqany)
- [inAll](nodes.namedsqlfunction.md#inall)
- [inAny](nodes.namedsqlfunction.md#inany)
- [inVal](nodes.namedsqlfunction.md#inval)
- [isDistinctFrom](nodes.namedsqlfunction.md#isdistinctfrom)
- [isInfinity](nodes.namedsqlfunction.md#isinfinity)
- [isNotDistinctFrom](nodes.namedsqlfunction.md#isnotdistinctfrom)
- [isOpenEnded](nodes.namedsqlfunction.md#isopenended)
- [isUnboundable](nodes.namedsqlfunction.md#isunboundable)
- [lower](nodes.namedsqlfunction.md#lower)
- [lt](nodes.namedsqlfunction.md#lt)
- [ltAll](nodes.namedsqlfunction.md#ltall)
- [ltAny](nodes.namedsqlfunction.md#ltany)
- [lteq](nodes.namedsqlfunction.md#lteq)
- [lteqAll](nodes.namedsqlfunction.md#lteqall)
- [lteqAny](nodes.namedsqlfunction.md#lteqany)
- [matches](nodes.namedsqlfunction.md#matches)
- [matchesAll](nodes.namedsqlfunction.md#matchesall)
- [matchesAny](nodes.namedsqlfunction.md#matchesany)
- [matchesRegexp](nodes.namedsqlfunction.md#matchesregexp)
- [maximum](nodes.namedsqlfunction.md#maximum)
- [minimum](nodes.namedsqlfunction.md#minimum)
- [multiply](nodes.namedsqlfunction.md#multiply)
- [not](nodes.namedsqlfunction.md#not)
- [notBetween](nodes.namedsqlfunction.md#notbetween)
- [notEq](nodes.namedsqlfunction.md#noteq)
- [notEqAll](nodes.namedsqlfunction.md#noteqall)
- [notEqAny](nodes.namedsqlfunction.md#noteqany)
- [notInAll](nodes.namedsqlfunction.md#notinall)
- [notInAny](nodes.namedsqlfunction.md#notinany)
- [notInVal](nodes.namedsqlfunction.md#notinval)
- [or](nodes.namedsqlfunction.md#or)
- [over](nodes.namedsqlfunction.md#over)
- [quotedArray](nodes.namedsqlfunction.md#quotedarray)
- [quotedNode](nodes.namedsqlfunction.md#quotednode)
- [subtract](nodes.namedsqlfunction.md#subtract)
- [sum](nodes.namedsqlfunction.md#sum)
- [toSQL](nodes.namedsqlfunction.md#tosql)
- [when](nodes.namedsqlfunction.md#when)

## Constructors

### constructor

\+ **new NamedSQLFunction**(`name`: _any_, `expr`: _any_, `aliaz?`: _any_):
...
Defined in:
[src/nodes/NamedSQLFunction.ts:4](https://github.com/sequeljs/ast/blob/8de61b1/src/nodes/NamedSQLFunction.ts#L4)
...
▸ **as**(`aliaz`: _any_): [_NamedSQLFunction_](nodes.namedsqlfunction.md)
...
Overrides: [SQLFunction](nodes.sqlfunction.md)

Defined in:
[src/nodes/NamedSQLFunction.ts:12](https://github.com/sequeljs/ast/blob/8de61b1/src/nodes/NamedSQLFunction.ts#L12)
