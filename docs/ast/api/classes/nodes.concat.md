...
- [constructor](nodes.concat.md#constructor)

### Properties

- [left](nodes.concat.md#left)
- [operator](nodes.concat.md#operator)
- [right](nodes.concat.md#right)

### Methods

- [add](nodes.concat.md#add)
- [and](nodes.concat.md#and)
- [as](nodes.concat.md#as)
- [asc](nodes.concat.md#asc)
- [average](nodes.concat.md#average)
- [between](nodes.concat.md#between)
- [bitwiseAnd](nodes.concat.md#bitwiseand)
- [bitwiseNot](nodes.concat.md#bitwisenot)
- [bitwiseOr](nodes.concat.md#bitwiseor)
- [bitwiseShiftLeft](nodes.concat.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.concat.md#bitwiseshiftright)
- [bitwiseXor](nodes.concat.md#bitwisexor)
- [coalesce](nodes.concat.md#coalesce)
- [concat](nodes.concat.md#concat)
- [count](nodes.concat.md#count)
- [createAnd](nodes.concat.md#createand)
- [createFalse](nodes.concat.md#createfalse)
- [createJoin](nodes.concat.md#createjoin)
- [createOn](nodes.concat.md#createon)
- [createStringJoin](nodes.concat.md#createstringjoin)
- [createTableAlias](nodes.concat.md#createtablealias)
- [createTrue](nodes.concat.md#createtrue)
- [desc](nodes.concat.md#desc)
- [divide](nodes.concat.md#divide)
- [doesNotMatch](nodes.concat.md#doesnotmatch)
- [doesNotMatchAll](nodes.concat.md#doesnotmatchall)
- [doesNotMatchAny](nodes.concat.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.concat.md#doesnotmatchregexp)
- [eq](nodes.concat.md#eq)
- [eqAll](nodes.concat.md#eqall)
- [eqAny](nodes.concat.md#eqany)
- [extract](nodes.concat.md#extract)
- [grouping](nodes.concat.md#grouping)
- [groupingAll](nodes.concat.md#groupingall)
- [groupingAny](nodes.concat.md#groupingany)
- [gt](nodes.concat.md#gt)
- [gtAll](nodes.concat.md#gtall)
- [gtAny](nodes.concat.md#gtany)
- [gteq](nodes.concat.md#gteq)
- [gteqAll](nodes.concat.md#gteqall)
- [gteqAny](nodes.concat.md#gteqany)
- [inAll](nodes.concat.md#inall)
- [inAny](nodes.concat.md#inany)
- [inVal](nodes.concat.md#inval)
- [isDistinctFrom](nodes.concat.md#isdistinctfrom)
- [isInfinity](nodes.concat.md#isinfinity)
- [isNotDistinctFrom](nodes.concat.md#isnotdistinctfrom)
- [isOpenEnded](nodes.concat.md#isopenended)
- [isUnboundable](nodes.concat.md#isunboundable)
- [lower](nodes.concat.md#lower)
- [lt](nodes.concat.md#lt)
- [ltAll](nodes.concat.md#ltall)
- [ltAny](nodes.concat.md#ltany)
- [lteq](nodes.concat.md#lteq)
- [lteqAll](nodes.concat.md#lteqall)
- [lteqAny](nodes.concat.md#lteqany)
- [matches](nodes.concat.md#matches)
- [matchesAll](nodes.concat.md#matchesall)
- [matchesAny](nodes.concat.md#matchesany)
- [matchesRegexp](nodes.concat.md#matchesregexp)
- [maximum](nodes.concat.md#maximum)
- [minimum](nodes.concat.md#minimum)
- [multiply](nodes.concat.md#multiply)
- [not](nodes.concat.md#not)
- [notBetween](nodes.concat.md#notbetween)
- [notEq](nodes.concat.md#noteq)
- [notEqAll](nodes.concat.md#noteqall)
- [notEqAny](nodes.concat.md#noteqany)
- [notInAll](nodes.concat.md#notinall)
- [notInAny](nodes.concat.md#notinany)
- [notInVal](nodes.concat.md#notinval)
- [or](nodes.concat.md#or)
- [quotedArray](nodes.concat.md#quotedarray)
- [quotedNode](nodes.concat.md#quotednode)
- [subtract](nodes.concat.md#subtract)
- [sum](nodes.concat.md#sum)
- [toSQL](nodes.concat.md#tosql)
- [when](nodes.concat.md#when)

## Constructors

### constructor

\+ **new Concat**(`left`: _any_, `right`: _any_): [_Concat_](nodes.concat.md)
...
Defined in:
[src/nodes/Concat.ts:3](https://github.com/sequeljs/ast/blob/8de61b1/src/nodes/Concat.ts#L3)
