...
[Nodes](../modules/nodes.md) / TableAlias
...
- [constructor](nodes.tablealias.md#constructor)

### Properties

- [left](nodes.tablealias.md#left)
- [right](nodes.tablealias.md#right)

### Accessors

- [name](nodes.tablealias.md#name)
- [relation](nodes.tablealias.md#relation)
- [tableAlias](nodes.tablealias.md#tablealias)
- [tableName](nodes.tablealias.md#tablename)

### Methods

- [add](nodes.tablealias.md#add)
- [and](nodes.tablealias.md#and)
- [as](nodes.tablealias.md#as)
- [asc](nodes.tablealias.md#asc)
- [average](nodes.tablealias.md#average)
- [between](nodes.tablealias.md#between)
- [bitwiseAnd](nodes.tablealias.md#bitwiseand)
- [bitwiseNot](nodes.tablealias.md#bitwisenot)
- [bitwiseOr](nodes.tablealias.md#bitwiseor)
- [bitwiseShiftLeft](nodes.tablealias.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.tablealias.md#bitwiseshiftright)
- [bitwiseXor](nodes.tablealias.md#bitwisexor)
- [coalesce](nodes.tablealias.md#coalesce)
- [concat](nodes.tablealias.md#concat)
- [count](nodes.tablealias.md#count)
- [createAnd](nodes.tablealias.md#createand)
- [createFalse](nodes.tablealias.md#createfalse)
- [createJoin](nodes.tablealias.md#createjoin)
- [createOn](nodes.tablealias.md#createon)
- [createStringJoin](nodes.tablealias.md#createstringjoin)
- [createTableAlias](nodes.tablealias.md#createtablealias)
- [createTrue](nodes.tablealias.md#createtrue)
- [desc](nodes.tablealias.md#desc)
- [divide](nodes.tablealias.md#divide)
- [doesNotMatch](nodes.tablealias.md#doesnotmatch)
- [doesNotMatchAll](nodes.tablealias.md#doesnotmatchall)
- [doesNotMatchAny](nodes.tablealias.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.tablealias.md#doesnotmatchregexp)
- [eq](nodes.tablealias.md#eq)
- [eqAll](nodes.tablealias.md#eqall)
- [eqAny](nodes.tablealias.md#eqany)
- [extract](nodes.tablealias.md#extract)
- [get](nodes.tablealias.md#get)
- [grouping](nodes.tablealias.md#grouping)
- [groupingAll](nodes.tablealias.md#groupingall)
- [groupingAny](nodes.tablealias.md#groupingany)
- [gt](nodes.tablealias.md#gt)
- [gtAll](nodes.tablealias.md#gtall)
- [gtAny](nodes.tablealias.md#gtany)
- [gteq](nodes.tablealias.md#gteq)
- [gteqAll](nodes.tablealias.md#gteqall)
- [gteqAny](nodes.tablealias.md#gteqany)
- [inAll](nodes.tablealias.md#inall)
- [inAny](nodes.tablealias.md#inany)
- [inVal](nodes.tablealias.md#inval)
- [isAbleToTypeCast](nodes.tablealias.md#isabletotypecast)
- [isDistinctFrom](nodes.tablealias.md#isdistinctfrom)
- [isInfinity](nodes.tablealias.md#isinfinity)
- [isNotDistinctFrom](nodes.tablealias.md#isnotdistinctfrom)
- [isOpenEnded](nodes.tablealias.md#isopenended)
- [isUnboundable](nodes.tablealias.md#isunboundable)
- [lower](nodes.tablealias.md#lower)
- [lt](nodes.tablealias.md#lt)
- [ltAll](nodes.tablealias.md#ltall)
- [ltAny](nodes.tablealias.md#ltany)
- [lteq](nodes.tablealias.md#lteq)
- [lteqAll](nodes.tablealias.md#lteqall)
- [lteqAny](nodes.tablealias.md#lteqany)
- [matches](nodes.tablealias.md#matches)
- [matchesAll](nodes.tablealias.md#matchesall)
- [matchesAny](nodes.tablealias.md#matchesany)
- [matchesRegexp](nodes.tablealias.md#matchesregexp)
- [maximum](nodes.tablealias.md#maximum)
- [minimum](nodes.tablealias.md#minimum)
- [multiply](nodes.tablealias.md#multiply)
- [not](nodes.tablealias.md#not)
- [notBetween](nodes.tablealias.md#notbetween)
- [notEq](nodes.tablealias.md#noteq)
- [notEqAll](nodes.tablealias.md#noteqall)
- [notEqAny](nodes.tablealias.md#noteqany)
- [notInAll](nodes.tablealias.md#notinall)
- [notInAny](nodes.tablealias.md#notinany)
- [notInVal](nodes.tablealias.md#notinval)
- [or](nodes.tablealias.md#or)
- [quotedArray](nodes.tablealias.md#quotedarray)
- [quotedNode](nodes.tablealias.md#quotednode)
- [subtract](nodes.tablealias.md#subtract)
- [sum](nodes.tablealias.md#sum)
- [toSQL](nodes.tablealias.md#tosql)
- [typeCastForDatabase](nodes.tablealias.md#typecastfordatabase)
- [when](nodes.tablealias.md#when)

## Constructors

### constructor

\+ **new TableAlias**(`left`: _any_, `right`: _any_):
...
Defined in:
[src/nodes/TableAlias.ts:12](https://github.com/sequeljs/ast/blob/6632050/src/nodes/TableAlias.ts#L12)

• **name**(`val`: _string_ \| [_SQLLiteral_](nodes.sqlliteral.md)): _void_

#### Parameters:

| Name  | Type                                            |
| ----- | ----------------------------------------------- |
| `val` | _string_ \| [_SQLLiteral_](nodes.sqlliteral.md) |

**Returns:** _void_

Defined in:
[src/nodes/TableAlias.ts:16](https://github.com/sequeljs/ast/blob/6632050/src/nodes/TableAlias.ts#L16)
...
Defined in:
[src/nodes/TableAlias.ts:20](https://github.com/sequeljs/ast/blob/6632050/src/nodes/TableAlias.ts#L20)

• **relation**(`val`: [_Relation_](../modules/interfaces.md#relation)): _void_

#### Parameters:

| Name  | Type                                            |
| ----- | ----------------------------------------------- |
| `val` | [_Relation_](../modules/interfaces.md#relation) |

**Returns:** _void_

Defined in:
[src/nodes/TableAlias.ts:24](https://github.com/sequeljs/ast/blob/6632050/src/nodes/TableAlias.ts#L24)

---

### tableAlias

• **tableAlias**(): _string_ \| [_SQLLiteral_](nodes.sqlliteral.md)

**Returns:** _string_ \| [_SQLLiteral_](nodes.sqlliteral.md)

Defined in:
[src/nodes/TableAlias.ts:28](https://github.com/sequeljs/ast/blob/6632050/src/nodes/TableAlias.ts#L28)

• **tableAlias**(`val`: _string_ \| [_SQLLiteral_](nodes.sqlliteral.md)): _void_
...
Defined in:
[src/nodes/TableAlias.ts:32](https://github.com/sequeljs/ast/blob/6632050/src/nodes/TableAlias.ts#L32)

---

### tableName

• **tableName**(): _string_ \| [_SQLLiteral_](nodes.sqlliteral.md)

**Returns:** _string_ \| [_SQLLiteral_](nodes.sqlliteral.md)

Defined in:
[src/nodes/TableAlias.ts:36](https://github.com/sequeljs/ast/blob/6632050/src/nodes/TableAlias.ts#L36)
...
Defined in:
[src/nodes/TableAlias.ts:44](https://github.com/sequeljs/ast/blob/6632050/src/nodes/TableAlias.ts#L44)
...
Defined in:
[src/nodes/TableAlias.ts:48](https://github.com/sequeljs/ast/blob/6632050/src/nodes/TableAlias.ts#L48)
...
Defined in:
[src/nodes/TableAlias.ts:54](https://github.com/sequeljs/ast/blob/6632050/src/nodes/TableAlias.ts#L54)
