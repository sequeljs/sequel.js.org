...
- [constructor](_attributes_float_.float.md#constructor)

### Properties

- [name](_attributes_float_.float.md#name)
- [relation](_attributes_float_.float.md#relation)

### Methods

- [add](_attributes_float_.float.md#add)
- [as](_attributes_float_.float.md#as)
- [asc](_attributes_float_.float.md#asc)
- [average](_attributes_float_.float.md#average)
- [between](_attributes_float_.float.md#between)
- [bitwiseAnd](_attributes_float_.float.md#bitwiseand)
- [bitwiseNot](_attributes_float_.float.md#bitwisenot)
- [bitwiseOr](_attributes_float_.float.md#bitwiseor)
- [bitwiseShiftLeft](_attributes_float_.float.md#bitwiseshiftleft)
- [bitwiseShiftRight](_attributes_float_.float.md#bitwiseshiftright)
- [bitwiseXor](_attributes_float_.float.md#bitwisexor)
- [concat](_attributes_float_.float.md#concat)
- [count](_attributes_float_.float.md#count)
- [desc](_attributes_float_.float.md#desc)
- [divide](_attributes_float_.float.md#divide)
- [doesNotMatch](_attributes_float_.float.md#doesnotmatch)
- [doesNotMatchAll](_attributes_float_.float.md#doesnotmatchall)
- [doesNotMatchAny](_attributes_float_.float.md#doesnotmatchany)
- [doesNotMatchRegexp](_attributes_float_.float.md#doesnotmatchregexp)
- [eq](_attributes_float_.float.md#eq)
- [eqAll](_attributes_float_.float.md#eqall)
- [eqAny](_attributes_float_.float.md#eqany)
- [extract](_attributes_float_.float.md#extract)
- [groupingAll](_attributes_float_.float.md#protected-groupingall)
- [groupingAny](_attributes_float_.float.md#protected-groupingany)
- [gt](_attributes_float_.float.md#gt)
- [gtAll](_attributes_float_.float.md#gtall)
- [gtAny](_attributes_float_.float.md#gtany)
- [gteq](_attributes_float_.float.md#gteq)
- [gteqAll](_attributes_float_.float.md#gteqall)
- [gteqAny](_attributes_float_.float.md#gteqany)
- [inAll](_attributes_float_.float.md#inall)
- [inAny](_attributes_float_.float.md#inany)
- [inVal](_attributes_float_.float.md#inval)
- [isAbleToTypeCast](_attributes_float_.float.md#isabletotypecast)
- [isDistinctFrom](_attributes_float_.float.md#isdistinctfrom)
- [isInfinity](_attributes_float_.float.md#protected-isinfinity)
- [isNotDistinctFrom](_attributes_float_.float.md#isnotdistinctfrom)
- [isOpenEnded](_attributes_float_.float.md#protected-isopenended)
- [isUnboundable](_attributes_float_.float.md#protected-isunboundable)
- [lower](_attributes_float_.float.md#lower)
- [lt](_attributes_float_.float.md#lt)
- [ltAll](_attributes_float_.float.md#ltall)
- [ltAny](_attributes_float_.float.md#ltany)
- [lteq](_attributes_float_.float.md#lteq)
- [lteqAll](_attributes_float_.float.md#lteqall)
- [lteqAny](_attributes_float_.float.md#lteqany)
- [matches](_attributes_float_.float.md#matches)
- [matchesAll](_attributes_float_.float.md#matchesall)
- [matchesAny](_attributes_float_.float.md#matchesany)
- [matchesRegexp](_attributes_float_.float.md#matchesregexp)
- [maximum](_attributes_float_.float.md#maximum)
- [minimum](_attributes_float_.float.md#minimum)
- [multiply](_attributes_float_.float.md#multiply)
- [notBetween](_attributes_float_.float.md#notbetween)
- [notEq](_attributes_float_.float.md#noteq)
- [notEqAll](_attributes_float_.float.md#noteqall)
- [notEqAny](_attributes_float_.float.md#noteqany)
- [notInAll](_attributes_float_.float.md#notinall)
- [notInAny](_attributes_float_.float.md#notinany)
- [notInVal](_attributes_float_.float.md#notinval)
- [quotedArray](_attributes_float_.float.md#quotedarray)
- [quotedNode](_attributes_float_.float.md#quotednode)
- [subtract](_attributes_float_.float.md#subtract)
- [sum](_attributes_float_.float.md#sum)
- [typeCastForDatabase](_attributes_float_.float.md#typecastfordatabase)
- [when](_attributes_float_.float.md#when)
...
_[Float](_attributes_float_.float.md)_
...
**Returns:** _[Float](_attributes_float_.float.md)_
