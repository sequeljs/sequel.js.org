...
- [constructor](_attributes_time_.time.md#constructor)

### Properties

- [name](_attributes_time_.time.md#name)
- [relation](_attributes_time_.time.md#relation)

### Methods

- [add](_attributes_time_.time.md#add)
- [as](_attributes_time_.time.md#as)
- [asc](_attributes_time_.time.md#asc)
- [average](_attributes_time_.time.md#average)
- [between](_attributes_time_.time.md#between)
- [bitwiseAnd](_attributes_time_.time.md#bitwiseand)
- [bitwiseNot](_attributes_time_.time.md#bitwisenot)
- [bitwiseOr](_attributes_time_.time.md#bitwiseor)
- [bitwiseShiftLeft](_attributes_time_.time.md#bitwiseshiftleft)
- [bitwiseShiftRight](_attributes_time_.time.md#bitwiseshiftright)
- [bitwiseXor](_attributes_time_.time.md#bitwisexor)
- [concat](_attributes_time_.time.md#concat)
- [count](_attributes_time_.time.md#count)
- [desc](_attributes_time_.time.md#desc)
- [divide](_attributes_time_.time.md#divide)
- [doesNotMatch](_attributes_time_.time.md#doesnotmatch)
- [doesNotMatchAll](_attributes_time_.time.md#doesnotmatchall)
- [doesNotMatchAny](_attributes_time_.time.md#doesnotmatchany)
- [doesNotMatchRegexp](_attributes_time_.time.md#doesnotmatchregexp)
- [eq](_attributes_time_.time.md#eq)
- [eqAll](_attributes_time_.time.md#eqall)
- [eqAny](_attributes_time_.time.md#eqany)
- [extract](_attributes_time_.time.md#extract)
- [groupingAll](_attributes_time_.time.md#protected-groupingall)
- [groupingAny](_attributes_time_.time.md#protected-groupingany)
- [gt](_attributes_time_.time.md#gt)
- [gtAll](_attributes_time_.time.md#gtall)
- [gtAny](_attributes_time_.time.md#gtany)
- [gteq](_attributes_time_.time.md#gteq)
- [gteqAll](_attributes_time_.time.md#gteqall)
- [gteqAny](_attributes_time_.time.md#gteqany)
- [inAll](_attributes_time_.time.md#inall)
- [inAny](_attributes_time_.time.md#inany)
- [inVal](_attributes_time_.time.md#inval)
- [isAbleToTypeCast](_attributes_time_.time.md#isabletotypecast)
- [isDistinctFrom](_attributes_time_.time.md#isdistinctfrom)
- [isInfinity](_attributes_time_.time.md#protected-isinfinity)
- [isNotDistinctFrom](_attributes_time_.time.md#isnotdistinctfrom)
- [isOpenEnded](_attributes_time_.time.md#protected-isopenended)
- [isUnboundable](_attributes_time_.time.md#protected-isunboundable)
- [lower](_attributes_time_.time.md#lower)
- [lt](_attributes_time_.time.md#lt)
- [ltAll](_attributes_time_.time.md#ltall)
- [ltAny](_attributes_time_.time.md#ltany)
- [lteq](_attributes_time_.time.md#lteq)
- [lteqAll](_attributes_time_.time.md#lteqall)
- [lteqAny](_attributes_time_.time.md#lteqany)
- [matches](_attributes_time_.time.md#matches)
- [matchesAll](_attributes_time_.time.md#matchesall)
- [matchesAny](_attributes_time_.time.md#matchesany)
- [matchesRegexp](_attributes_time_.time.md#matchesregexp)
- [maximum](_attributes_time_.time.md#maximum)
- [minimum](_attributes_time_.time.md#minimum)
- [multiply](_attributes_time_.time.md#multiply)
- [notBetween](_attributes_time_.time.md#notbetween)
- [notEq](_attributes_time_.time.md#noteq)
- [notEqAll](_attributes_time_.time.md#noteqall)
- [notEqAny](_attributes_time_.time.md#noteqany)
- [notInAll](_attributes_time_.time.md#notinall)
- [notInAny](_attributes_time_.time.md#notinany)
- [notInVal](_attributes_time_.time.md#notinval)
- [quotedArray](_attributes_time_.time.md#quotedarray)
- [quotedNode](_attributes_time_.time.md#quotednode)
- [subtract](_attributes_time_.time.md#subtract)
- [sum](_attributes_time_.time.md#sum)
- [typeCastForDatabase](_attributes_time_.time.md#typecastfordatabase)
- [when](_attributes_time_.time.md#when)
...
_[Time](_attributes_time_.time.md)_
...
**Returns:** _[Time](_attributes_time_.time.md)_
