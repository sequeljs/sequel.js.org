...
[Nodes](../modules/nodes.md) / Equality
...
- [constructor](nodes.equality.md#constructor)

### Properties

- [left](nodes.equality.md#left)
- [operator](nodes.equality.md#operator)
- [right](nodes.equality.md#right)

### Accessors

- [operand1](nodes.equality.md#operand1)
- [operand2](nodes.equality.md#operand2)

### Methods

- [add](nodes.equality.md#add)
- [and](nodes.equality.md#and)
- [as](nodes.equality.md#as)
- [asc](nodes.equality.md#asc)
- [average](nodes.equality.md#average)
- [between](nodes.equality.md#between)
- [bitwiseAnd](nodes.equality.md#bitwiseand)
- [bitwiseNot](nodes.equality.md#bitwisenot)
- [bitwiseOr](nodes.equality.md#bitwiseor)
- [bitwiseShiftLeft](nodes.equality.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.equality.md#bitwiseshiftright)
- [bitwiseXor](nodes.equality.md#bitwisexor)
- [coalesce](nodes.equality.md#coalesce)
- [concat](nodes.equality.md#concat)
- [count](nodes.equality.md#count)
- [createAnd](nodes.equality.md#createand)
- [createFalse](nodes.equality.md#createfalse)
- [createJoin](nodes.equality.md#createjoin)
- [createOn](nodes.equality.md#createon)
- [createStringJoin](nodes.equality.md#createstringjoin)
- [createTableAlias](nodes.equality.md#createtablealias)
- [createTrue](nodes.equality.md#createtrue)
- [desc](nodes.equality.md#desc)
- [divide](nodes.equality.md#divide)
- [doesNotMatch](nodes.equality.md#doesnotmatch)
- [doesNotMatchAll](nodes.equality.md#doesnotmatchall)
- [doesNotMatchAny](nodes.equality.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.equality.md#doesnotmatchregexp)
- [eq](nodes.equality.md#eq)
- [eqAll](nodes.equality.md#eqall)
- [eqAny](nodes.equality.md#eqany)
- [extract](nodes.equality.md#extract)
- [grouping](nodes.equality.md#grouping)
- [groupingAll](nodes.equality.md#groupingall)
- [groupingAny](nodes.equality.md#groupingany)
- [gt](nodes.equality.md#gt)
- [gtAll](nodes.equality.md#gtall)
- [gtAny](nodes.equality.md#gtany)
- [gteq](nodes.equality.md#gteq)
- [gteqAll](nodes.equality.md#gteqall)
- [gteqAny](nodes.equality.md#gteqany)
- [inAll](nodes.equality.md#inall)
- [inAny](nodes.equality.md#inany)
- [inVal](nodes.equality.md#inval)
- [isDistinctFrom](nodes.equality.md#isdistinctfrom)
- [isInfinity](nodes.equality.md#isinfinity)
- [isNotDistinctFrom](nodes.equality.md#isnotdistinctfrom)
- [isOpenEnded](nodes.equality.md#isopenended)
- [isUnboundable](nodes.equality.md#isunboundable)
- [lower](nodes.equality.md#lower)
- [lt](nodes.equality.md#lt)
- [ltAll](nodes.equality.md#ltall)
- [ltAny](nodes.equality.md#ltany)
- [lteq](nodes.equality.md#lteq)
- [lteqAll](nodes.equality.md#lteqall)
- [lteqAny](nodes.equality.md#lteqany)
- [matches](nodes.equality.md#matches)
- [matchesAll](nodes.equality.md#matchesall)
- [matchesAny](nodes.equality.md#matchesany)
- [matchesRegexp](nodes.equality.md#matchesregexp)
- [maximum](nodes.equality.md#maximum)
- [minimum](nodes.equality.md#minimum)
- [multiply](nodes.equality.md#multiply)
- [not](nodes.equality.md#not)
- [notBetween](nodes.equality.md#notbetween)
- [notEq](nodes.equality.md#noteq)
- [notEqAll](nodes.equality.md#noteqall)
- [notEqAny](nodes.equality.md#noteqany)
- [notInAll](nodes.equality.md#notinall)
- [notInAny](nodes.equality.md#notinany)
- [notInVal](nodes.equality.md#notinval)
- [or](nodes.equality.md#or)
- [quotedArray](nodes.equality.md#quotedarray)
- [quotedNode](nodes.equality.md#quotednode)
- [subtract](nodes.equality.md#subtract)
- [sum](nodes.equality.md#sum)
- [toSQL](nodes.equality.md#tosql)
- [when](nodes.equality.md#when)

## Constructors

### constructor

\+ **new Equality**<L, R\>(`left`: L, `right`: R):
[_Equality_](nodes.equality.md)<L, R\>
...
**Returns:** [_Equality_](nodes.equality.md)<L, R\>
