---
id: '_nodes_unary_.unary'
title: 'Unary'
sidebar_label: 'Unary'
---

[@sequeljs/ast](../index.md) › [Globals](../globals.md) ›
["nodes/Unary"](../modules/_nodes_unary_.md) › [Unary](_nodes_unary_.unary.md)
...
- [AliasPredication](_mixins_aliaspredication_.aliaspredication.md)
  ...
  ↳ [DistinctOn](_nodes_distincton_.distincton.md)

  ↳ [Group](_nodes_group_.group.md)

  ↳ [Lateral](_nodes_lateral_.lateral.md)

  ↳ [Limit](_nodes_limit_.limit.md)

  ↳ [Lock](_nodes_lock_.lock.md)

  ↳ [Range](_nodes_range_.range.md)

  ↳ [Rows](_nodes_rows_.rows.md)
  ...
  ↳ [Grouping](_nodes_grouping_.grouping.md)
  ...
  ↳ [Else](_nodes_else_.else.md)

  ↳ [Bin](_nodes_bin_.bin.md)

  ↳ [Following](_nodes_following_.following.md)

  ↳ [Not](_nodes_not_.not.md)
...
- [constructor](_nodes_unary_.unary.md#constructor)

### Properties

- [expr](_nodes_unary_.unary.md#expr)

### Accessors

- [value](_nodes_unary_.unary.md#value)

### Methods

- [add](_nodes_unary_.unary.md#add)
- [as](_nodes_unary_.unary.md#as)
- [asc](_nodes_unary_.unary.md#asc)
- [average](_nodes_unary_.unary.md#average)
- [between](_nodes_unary_.unary.md#between)
- [bitwiseAnd](_nodes_unary_.unary.md#bitwiseand)
- [bitwiseNot](_nodes_unary_.unary.md#bitwisenot)
- [bitwiseOr](_nodes_unary_.unary.md#bitwiseor)
- [bitwiseShiftLeft](_nodes_unary_.unary.md#bitwiseshiftleft)
- [bitwiseShiftRight](_nodes_unary_.unary.md#bitwiseshiftright)
- [bitwiseXor](_nodes_unary_.unary.md#bitwisexor)
- [concat](_nodes_unary_.unary.md#concat)
- [count](_nodes_unary_.unary.md#count)
- [desc](_nodes_unary_.unary.md#desc)
- [divide](_nodes_unary_.unary.md#divide)
- [doesNotMatch](_nodes_unary_.unary.md#doesnotmatch)
- [doesNotMatchAll](_nodes_unary_.unary.md#doesnotmatchall)
- [doesNotMatchAny](_nodes_unary_.unary.md#doesnotmatchany)
- [doesNotMatchRegexp](_nodes_unary_.unary.md#doesnotmatchregexp)
- [eq](_nodes_unary_.unary.md#eq)
- [eqAll](_nodes_unary_.unary.md#eqall)
- [eqAny](_nodes_unary_.unary.md#eqany)
- [extract](_nodes_unary_.unary.md#extract)
- [groupingAll](_nodes_unary_.unary.md#protected-groupingall)
- [groupingAny](_nodes_unary_.unary.md#protected-groupingany)
- [gt](_nodes_unary_.unary.md#gt)
- [gtAll](_nodes_unary_.unary.md#gtall)
- [gtAny](_nodes_unary_.unary.md#gtany)
- [gteq](_nodes_unary_.unary.md#gteq)
- [gteqAll](_nodes_unary_.unary.md#gteqall)
- [gteqAny](_nodes_unary_.unary.md#gteqany)
- [inAll](_nodes_unary_.unary.md#inall)
- [inAny](_nodes_unary_.unary.md#inany)
- [inVal](_nodes_unary_.unary.md#inval)
- [isDistinctFrom](_nodes_unary_.unary.md#isdistinctfrom)
- [isInfinity](_nodes_unary_.unary.md#protected-isinfinity)
- [isNotDistinctFrom](_nodes_unary_.unary.md#isnotdistinctfrom)
- [isOpenEnded](_nodes_unary_.unary.md#protected-isopenended)
- [isUnboundable](_nodes_unary_.unary.md#protected-isunboundable)
- [lt](_nodes_unary_.unary.md#lt)
- [ltAll](_nodes_unary_.unary.md#ltall)
- [ltAny](_nodes_unary_.unary.md#ltany)
- [lteq](_nodes_unary_.unary.md#lteq)
- [lteqAll](_nodes_unary_.unary.md#lteqall)
- [lteqAny](_nodes_unary_.unary.md#lteqany)
- [matches](_nodes_unary_.unary.md#matches)
- [matchesAll](_nodes_unary_.unary.md#matchesall)
- [matchesAny](_nodes_unary_.unary.md#matchesany)
- [matchesRegexp](_nodes_unary_.unary.md#matchesregexp)
- [maximum](_nodes_unary_.unary.md#maximum)
- [minimum](_nodes_unary_.unary.md#minimum)
- [multiply](_nodes_unary_.unary.md#multiply)
- [notBetween](_nodes_unary_.unary.md#notbetween)
- [notEq](_nodes_unary_.unary.md#noteq)
- [notEqAll](_nodes_unary_.unary.md#noteqall)
- [notEqAny](_nodes_unary_.unary.md#noteqany)
- [notInAll](_nodes_unary_.unary.md#notinall)
- [notInAny](_nodes_unary_.unary.md#notinany)
- [notInVal](_nodes_unary_.unary.md#notinval)
- [quotedArray](_nodes_unary_.unary.md#quotedarray)
- [quotedNode](_nodes_unary_.unary.md#quotednode)
- [subtract](_nodes_unary_.unary.md#subtract)
- [sum](_nodes_unary_.unary.md#sum)
- [toSQL](_nodes_unary_.unary.md#tosql)
- [when](_nodes_unary_.unary.md#when)

## Constructors

### constructor

\+ **new Unary**(`expr`: T): _[Unary](_nodes_unary_.unary.md)_
...
**Returns:** _[Unary](_nodes_unary_.unary.md)_
