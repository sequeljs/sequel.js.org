...
- [constructor](nodes.on.md#constructor)

### Properties

- [expr](nodes.on.md#expr)

### Accessors

- [value](nodes.on.md#value)
...
- [as](nodes.on.md#as)
- [asc](nodes.on.md#asc)
- [average](nodes.on.md#average)
- [between](nodes.on.md#between)
- [bitwiseAnd](nodes.on.md#bitwiseand)
- [bitwiseNot](nodes.on.md#bitwisenot)
- [bitwiseOr](nodes.on.md#bitwiseor)
- [bitwiseShiftLeft](nodes.on.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.on.md#bitwiseshiftright)
- [bitwiseXor](nodes.on.md#bitwisexor)
- [coalesce](nodes.on.md#coalesce)
- [concat](nodes.on.md#concat)
- [count](nodes.on.md#count)
- [createAnd](nodes.on.md#createand)
- [createFalse](nodes.on.md#createfalse)
- [createJoin](nodes.on.md#createjoin)
- [createOn](nodes.on.md#createon)
- [createStringJoin](nodes.on.md#createstringjoin)
- [createTableAlias](nodes.on.md#createtablealias)
- [createTrue](nodes.on.md#createtrue)
- [desc](nodes.on.md#desc)
- [divide](nodes.on.md#divide)
- [doesNotMatch](nodes.on.md#doesnotmatch)
- [doesNotMatchAll](nodes.on.md#doesnotmatchall)
- [doesNotMatchAny](nodes.on.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.on.md#doesnotmatchregexp)
- [eq](nodes.on.md#eq)
- [eqAll](nodes.on.md#eqall)
- [eqAny](nodes.on.md#eqany)
- [extract](nodes.on.md#extract)
- [grouping](nodes.on.md#grouping)
- [groupingAll](nodes.on.md#groupingall)
- [groupingAny](nodes.on.md#groupingany)
- [gt](nodes.on.md#gt)
- [gtAll](nodes.on.md#gtall)
- [gtAny](nodes.on.md#gtany)
- [gteq](nodes.on.md#gteq)
- [gteqAll](nodes.on.md#gteqall)
- [gteqAny](nodes.on.md#gteqany)
- [inAll](nodes.on.md#inall)
- [inAny](nodes.on.md#inany)
- [inVal](nodes.on.md#inval)
- [isDistinctFrom](nodes.on.md#isdistinctfrom)
- [isInfinity](nodes.on.md#isinfinity)
- [isNotDistinctFrom](nodes.on.md#isnotdistinctfrom)
- [isOpenEnded](nodes.on.md#isopenended)
- [isUnboundable](nodes.on.md#isunboundable)
- [lower](nodes.on.md#lower)
- [lt](nodes.on.md#lt)
- [ltAll](nodes.on.md#ltall)
- [ltAny](nodes.on.md#ltany)
- [lteq](nodes.on.md#lteq)
- [lteqAll](nodes.on.md#lteqall)
- [lteqAny](nodes.on.md#lteqany)
- [matches](nodes.on.md#matches)
- [matchesAll](nodes.on.md#matchesall)
- [matchesAny](nodes.on.md#matchesany)
- [matchesRegexp](nodes.on.md#matchesregexp)
- [maximum](nodes.on.md#maximum)
- [minimum](nodes.on.md#minimum)
- [multiply](nodes.on.md#multiply)
- [not](nodes.on.md#not)
- [notBetween](nodes.on.md#notbetween)
- [notEq](nodes.on.md#noteq)
- [notEqAll](nodes.on.md#noteqall)
- [notEqAny](nodes.on.md#noteqany)
- [notInAll](nodes.on.md#notinall)
- [notInAny](nodes.on.md#notinany)
- [notInVal](nodes.on.md#notinval)
- [or](nodes.on.md#or)
- [quotedArray](nodes.on.md#quotedarray)
- [quotedNode](nodes.on.md#quotednode)
- [subtract](nodes.on.md#subtract)
- [sum](nodes.on.md#sum)
- [toSQL](nodes.on.md#tosql)
- [when](nodes.on.md#when)

## Constructors

### constructor

\+ **new On**(`expr`: [_Visitable_](../modules/visitors.md#visitable)):
[_On_](nodes.on.md)
