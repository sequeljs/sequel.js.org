...
["nodes/On"](../modules/_nodes_on_.md) › [On](_nodes_on_.on.md)
...
- [constructor](_nodes_on_.on.md#constructor)

### Properties

- [expr](_nodes_on_.on.md#expr)

### Accessors

- [value](_nodes_on_.on.md#value)

### Methods

- [as](_nodes_on_.on.md#as)
- [toSQL](_nodes_on_.on.md#tosql)

## Constructors

### constructor

\+ **new On**(`expr`: T): _[On](_nodes_on_.on.md)_
