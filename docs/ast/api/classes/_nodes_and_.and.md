...
["nodes/And"](../modules/_nodes_and_.md) › [And](_nodes_and_.and.md)
...
- [constructor](_nodes_and_.and.md#constructor)

### Properties

- [children](_nodes_and_.and.md#readonly-children)

### Accessors

- [left](_nodes_and_.and.md#left)
- [right](_nodes_and_.and.md#right)

### Methods

- [add](_nodes_and_.and.md#add)
- [as](_nodes_and_.and.md#as)
- [asc](_nodes_and_.and.md#asc)
- [average](_nodes_and_.and.md#average)
- [between](_nodes_and_.and.md#between)
- [bitwiseAnd](_nodes_and_.and.md#bitwiseand)
- [bitwiseNot](_nodes_and_.and.md#bitwisenot)
- [bitwiseOr](_nodes_and_.and.md#bitwiseor)
- [bitwiseShiftLeft](_nodes_and_.and.md#bitwiseshiftleft)
- [bitwiseShiftRight](_nodes_and_.and.md#bitwiseshiftright)
- [bitwiseXor](_nodes_and_.and.md#bitwisexor)
- [concat](_nodes_and_.and.md#concat)
- [count](_nodes_and_.and.md#count)
- [desc](_nodes_and_.and.md#desc)
- [divide](_nodes_and_.and.md#divide)
- [doesNotMatch](_nodes_and_.and.md#doesnotmatch)
- [doesNotMatchAll](_nodes_and_.and.md#doesnotmatchall)
- [doesNotMatchAny](_nodes_and_.and.md#doesnotmatchany)
- [doesNotMatchRegexp](_nodes_and_.and.md#doesnotmatchregexp)
- [eq](_nodes_and_.and.md#eq)
- [eqAll](_nodes_and_.and.md#eqall)
- [eqAny](_nodes_and_.and.md#eqany)
- [extract](_nodes_and_.and.md#extract)
- [groupingAll](_nodes_and_.and.md#protected-groupingall)
- [groupingAny](_nodes_and_.and.md#protected-groupingany)
- [gt](_nodes_and_.and.md#gt)
- [gtAll](_nodes_and_.and.md#gtall)
- [gtAny](_nodes_and_.and.md#gtany)
- [gteq](_nodes_and_.and.md#gteq)
- [gteqAll](_nodes_and_.and.md#gteqall)
- [gteqAny](_nodes_and_.and.md#gteqany)
- [inAll](_nodes_and_.and.md#inall)
- [inAny](_nodes_and_.and.md#inany)
- [inVal](_nodes_and_.and.md#inval)
- [isDistinctFrom](_nodes_and_.and.md#isdistinctfrom)
- [isInfinity](_nodes_and_.and.md#protected-isinfinity)
- [isNotDistinctFrom](_nodes_and_.and.md#isnotdistinctfrom)
- [isOpenEnded](_nodes_and_.and.md#protected-isopenended)
- [isUnboundable](_nodes_and_.and.md#protected-isunboundable)
- [lt](_nodes_and_.and.md#lt)
- [ltAll](_nodes_and_.and.md#ltall)
- [ltAny](_nodes_and_.and.md#ltany)
- [lteq](_nodes_and_.and.md#lteq)
- [lteqAll](_nodes_and_.and.md#lteqall)
- [lteqAny](_nodes_and_.and.md#lteqany)
- [matches](_nodes_and_.and.md#matches)
- [matchesAll](_nodes_and_.and.md#matchesall)
- [matchesAny](_nodes_and_.and.md#matchesany)
- [matchesRegexp](_nodes_and_.and.md#matchesregexp)
- [maximum](_nodes_and_.and.md#maximum)
- [minimum](_nodes_and_.and.md#minimum)
- [multiply](_nodes_and_.and.md#multiply)
- [notBetween](_nodes_and_.and.md#notbetween)
- [notEq](_nodes_and_.and.md#noteq)
- [notEqAll](_nodes_and_.and.md#noteqall)
- [notEqAny](_nodes_and_.and.md#noteqany)
- [notInAll](_nodes_and_.and.md#notinall)
- [notInAny](_nodes_and_.and.md#notinany)
- [notInVal](_nodes_and_.and.md#notinval)
- [quotedArray](_nodes_and_.and.md#quotedarray)
- [quotedNode](_nodes_and_.and.md#quotednode)
- [subtract](_nodes_and_.and.md#subtract)
- [sum](_nodes_and_.and.md#sum)
- [toSQL](_nodes_and_.and.md#tosql)
- [when](_nodes_and_.and.md#when)

## Constructors

### constructor

\+ **new And**(`children`: any[]): _[And](_nodes_and_.and.md)_

_Defined in
[src/nodes/And.ts:14](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/And.ts#L14)_
...
_Defined in
[src/nodes/And.ts:6](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/And.ts#L6)_
...
_Defined in
[src/nodes/And.ts:8](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/And.ts#L8)_
...
_Defined in
[src/nodes/And.ts:12](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/And.ts#L12)_
