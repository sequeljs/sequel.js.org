---
id: '_nodes_distincton_.distincton'
title: 'DistinctOn'
...
- [constructor](_nodes_distincton_.distincton.md#constructor)

### Properties

- [expr](_nodes_distincton_.distincton.md#expr)

### Accessors

- [value](_nodes_distincton_.distincton.md#value)

### Methods

- [as](_nodes_distincton_.distincton.md#as)
- [toSQL](_nodes_distincton_.distincton.md#tosql)

## Constructors

### constructor

\+ **new DistinctOn**(`expr`: T):
_[DistinctOn](_nodes_distincton_.distincton.md)_
...
**Returns:** _[DistinctOn](_nodes_distincton_.distincton.md)_
