...
[Nodes](../modules/nodes.md) / Following
...
- [constructor](nodes.following.md#constructor)

### Properties

- [expr](nodes.following.md#expr)

### Accessors

- [value](nodes.following.md#value)

### Methods

- [add](nodes.following.md#add)
- [and](nodes.following.md#and)
- [as](nodes.following.md#as)
- [asc](nodes.following.md#asc)
- [average](nodes.following.md#average)
- [between](nodes.following.md#between)
- [bitwiseAnd](nodes.following.md#bitwiseand)
- [bitwiseNot](nodes.following.md#bitwisenot)
- [bitwiseOr](nodes.following.md#bitwiseor)
- [bitwiseShiftLeft](nodes.following.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.following.md#bitwiseshiftright)
- [bitwiseXor](nodes.following.md#bitwisexor)
- [coalesce](nodes.following.md#coalesce)
- [concat](nodes.following.md#concat)
- [count](nodes.following.md#count)
- [createAnd](nodes.following.md#createand)
- [createFalse](nodes.following.md#createfalse)
- [createJoin](nodes.following.md#createjoin)
- [createOn](nodes.following.md#createon)
- [createStringJoin](nodes.following.md#createstringjoin)
- [createTableAlias](nodes.following.md#createtablealias)
- [createTrue](nodes.following.md#createtrue)
- [desc](nodes.following.md#desc)
- [divide](nodes.following.md#divide)
- [doesNotMatch](nodes.following.md#doesnotmatch)
- [doesNotMatchAll](nodes.following.md#doesnotmatchall)
- [doesNotMatchAny](nodes.following.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.following.md#doesnotmatchregexp)
- [eq](nodes.following.md#eq)
- [eqAll](nodes.following.md#eqall)
- [eqAny](nodes.following.md#eqany)
- [extract](nodes.following.md#extract)
- [grouping](nodes.following.md#grouping)
- [groupingAll](nodes.following.md#groupingall)
- [groupingAny](nodes.following.md#groupingany)
- [gt](nodes.following.md#gt)
- [gtAll](nodes.following.md#gtall)
- [gtAny](nodes.following.md#gtany)
- [gteq](nodes.following.md#gteq)
- [gteqAll](nodes.following.md#gteqall)
- [gteqAny](nodes.following.md#gteqany)
- [inAll](nodes.following.md#inall)
- [inAny](nodes.following.md#inany)
- [inVal](nodes.following.md#inval)
- [isDistinctFrom](nodes.following.md#isdistinctfrom)
- [isInfinity](nodes.following.md#isinfinity)
- [isNotDistinctFrom](nodes.following.md#isnotdistinctfrom)
- [isOpenEnded](nodes.following.md#isopenended)
- [isUnboundable](nodes.following.md#isunboundable)
- [lower](nodes.following.md#lower)
- [lt](nodes.following.md#lt)
- [ltAll](nodes.following.md#ltall)
- [ltAny](nodes.following.md#ltany)
- [lteq](nodes.following.md#lteq)
- [lteqAll](nodes.following.md#lteqall)
- [lteqAny](nodes.following.md#lteqany)
- [matches](nodes.following.md#matches)
- [matchesAll](nodes.following.md#matchesall)
- [matchesAny](nodes.following.md#matchesany)
- [matchesRegexp](nodes.following.md#matchesregexp)
- [maximum](nodes.following.md#maximum)
- [minimum](nodes.following.md#minimum)
- [multiply](nodes.following.md#multiply)
- [not](nodes.following.md#not)
- [notBetween](nodes.following.md#notbetween)
- [notEq](nodes.following.md#noteq)
- [notEqAll](nodes.following.md#noteqall)
- [notEqAny](nodes.following.md#noteqany)
- [notInAll](nodes.following.md#notinall)
- [notInAny](nodes.following.md#notinany)
- [notInVal](nodes.following.md#notinval)
- [or](nodes.following.md#or)
- [quotedArray](nodes.following.md#quotedarray)
- [quotedNode](nodes.following.md#quotednode)
- [subtract](nodes.following.md#subtract)
- [sum](nodes.following.md#sum)
- [toSQL](nodes.following.md#tosql)
- [when](nodes.following.md#when)

## Constructors

### constructor

\+ **new Following**(`expr?`: _any_): [_Following_](nodes.following.md)
...
**Returns:** [_Following_](nodes.following.md)

Inherited from: [Unary](nodes.unary.md)

Defined in:
[src/nodes/Following.ts:3](https://github.com/sequeljs/ast/blob/6632050/src/nodes/Following.ts#L3)
