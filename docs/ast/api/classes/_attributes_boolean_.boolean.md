---
id: '_attributes_boolean_.boolean'
title: 'Boolean'
...
- [constructor](_attributes_boolean_.boolean.md#constructor)

### Properties

- [name](_attributes_boolean_.boolean.md#name)
- [relation](_attributes_boolean_.boolean.md#relation)

### Methods

- [add](_attributes_boolean_.boolean.md#add)
- [as](_attributes_boolean_.boolean.md#as)
- [asc](_attributes_boolean_.boolean.md#asc)
- [average](_attributes_boolean_.boolean.md#average)
- [between](_attributes_boolean_.boolean.md#between)
- [bitwiseAnd](_attributes_boolean_.boolean.md#bitwiseand)
- [bitwiseNot](_attributes_boolean_.boolean.md#bitwisenot)
- [bitwiseOr](_attributes_boolean_.boolean.md#bitwiseor)
- [bitwiseShiftLeft](_attributes_boolean_.boolean.md#bitwiseshiftleft)
- [bitwiseShiftRight](_attributes_boolean_.boolean.md#bitwiseshiftright)
- [bitwiseXor](_attributes_boolean_.boolean.md#bitwisexor)
- [concat](_attributes_boolean_.boolean.md#concat)
- [count](_attributes_boolean_.boolean.md#count)
- [desc](_attributes_boolean_.boolean.md#desc)
- [divide](_attributes_boolean_.boolean.md#divide)
- [doesNotMatch](_attributes_boolean_.boolean.md#doesnotmatch)
- [doesNotMatchAll](_attributes_boolean_.boolean.md#doesnotmatchall)
- [doesNotMatchAny](_attributes_boolean_.boolean.md#doesnotmatchany)
- [doesNotMatchRegexp](_attributes_boolean_.boolean.md#doesnotmatchregexp)
- [eq](_attributes_boolean_.boolean.md#eq)
- [eqAll](_attributes_boolean_.boolean.md#eqall)
- [eqAny](_attributes_boolean_.boolean.md#eqany)
- [extract](_attributes_boolean_.boolean.md#extract)
- [groupingAll](_attributes_boolean_.boolean.md#protected-groupingall)
- [groupingAny](_attributes_boolean_.boolean.md#protected-groupingany)
- [gt](_attributes_boolean_.boolean.md#gt)
- [gtAll](_attributes_boolean_.boolean.md#gtall)
- [gtAny](_attributes_boolean_.boolean.md#gtany)
- [gteq](_attributes_boolean_.boolean.md#gteq)
- [gteqAll](_attributes_boolean_.boolean.md#gteqall)
- [gteqAny](_attributes_boolean_.boolean.md#gteqany)
- [inAll](_attributes_boolean_.boolean.md#inall)
- [inAny](_attributes_boolean_.boolean.md#inany)
- [inVal](_attributes_boolean_.boolean.md#inval)
- [isAbleToTypeCast](_attributes_boolean_.boolean.md#isabletotypecast)
- [isDistinctFrom](_attributes_boolean_.boolean.md#isdistinctfrom)
- [isInfinity](_attributes_boolean_.boolean.md#protected-isinfinity)
- [isNotDistinctFrom](_attributes_boolean_.boolean.md#isnotdistinctfrom)
- [isOpenEnded](_attributes_boolean_.boolean.md#protected-isopenended)
- [isUnboundable](_attributes_boolean_.boolean.md#protected-isunboundable)
- [lower](_attributes_boolean_.boolean.md#lower)
- [lt](_attributes_boolean_.boolean.md#lt)
- [ltAll](_attributes_boolean_.boolean.md#ltall)
- [ltAny](_attributes_boolean_.boolean.md#ltany)
- [lteq](_attributes_boolean_.boolean.md#lteq)
- [lteqAll](_attributes_boolean_.boolean.md#lteqall)
- [lteqAny](_attributes_boolean_.boolean.md#lteqany)
- [matches](_attributes_boolean_.boolean.md#matches)
- [matchesAll](_attributes_boolean_.boolean.md#matchesall)
- [matchesAny](_attributes_boolean_.boolean.md#matchesany)
- [matchesRegexp](_attributes_boolean_.boolean.md#matchesregexp)
- [maximum](_attributes_boolean_.boolean.md#maximum)
- [minimum](_attributes_boolean_.boolean.md#minimum)
- [multiply](_attributes_boolean_.boolean.md#multiply)
- [notBetween](_attributes_boolean_.boolean.md#notbetween)
- [notEq](_attributes_boolean_.boolean.md#noteq)
- [notEqAll](_attributes_boolean_.boolean.md#noteqall)
- [notEqAny](_attributes_boolean_.boolean.md#noteqany)
- [notInAll](_attributes_boolean_.boolean.md#notinall)
- [notInAny](_attributes_boolean_.boolean.md#notinany)
- [notInVal](_attributes_boolean_.boolean.md#notinval)
- [quotedArray](_attributes_boolean_.boolean.md#quotedarray)
- [quotedNode](_attributes_boolean_.boolean.md#quotednode)
- [subtract](_attributes_boolean_.boolean.md#subtract)
- [sum](_attributes_boolean_.boolean.md#sum)
- [typeCastForDatabase](_attributes_boolean_.boolean.md#typecastfordatabase)
- [when](_attributes_boolean_.boolean.md#when)

## Constructors

### constructor

\+ **new Boolean**(`relation`:
[Relation](../modules/_interfaces_relation_.md#relation), `name`: string |
[SQLLiteral](_nodes_sqlliteral_.sqlliteral.md)):
_[Boolean](_attributes_boolean_.boolean.md)_
...
**Returns:** _[Boolean](_attributes_boolean_.boolean.md)_
