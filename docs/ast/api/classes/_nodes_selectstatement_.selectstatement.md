---
id: '_nodes_selectstatement_.selectstatement'
title: 'SelectStatement'
sidebar_label: 'SelectStatement'
---
...
- [constructor](_nodes_selectstatement_.selectstatement.md#constructor)

### Properties

- [cores](_nodes_selectstatement_.selectstatement.md#readonly-cores)
- [limit](_nodes_selectstatement_.selectstatement.md#limit)
- [lock](_nodes_selectstatement_.selectstatement.md#lock)
- [offset](_nodes_selectstatement_.selectstatement.md#offset)
- [orders](_nodes_selectstatement_.selectstatement.md#orders)
- [with](_nodes_selectstatement_.selectstatement.md#with)

### Methods

- [add](_nodes_selectstatement_.selectstatement.md#add)
- [as](_nodes_selectstatement_.selectstatement.md#as)
- [asc](_nodes_selectstatement_.selectstatement.md#asc)
- [average](_nodes_selectstatement_.selectstatement.md#average)
- [between](_nodes_selectstatement_.selectstatement.md#between)
- [bitwiseAnd](_nodes_selectstatement_.selectstatement.md#bitwiseand)
- [bitwiseNot](_nodes_selectstatement_.selectstatement.md#bitwisenot)
- [bitwiseOr](_nodes_selectstatement_.selectstatement.md#bitwiseor)
- [bitwiseShiftLeft](_nodes_selectstatement_.selectstatement.md#bitwiseshiftleft)
- [bitwiseShiftRight](_nodes_selectstatement_.selectstatement.md#bitwiseshiftright)
- [bitwiseXor](_nodes_selectstatement_.selectstatement.md#bitwisexor)
- [concat](_nodes_selectstatement_.selectstatement.md#concat)
- [count](_nodes_selectstatement_.selectstatement.md#count)
- [desc](_nodes_selectstatement_.selectstatement.md#desc)
- [divide](_nodes_selectstatement_.selectstatement.md#divide)
- [doesNotMatch](_nodes_selectstatement_.selectstatement.md#doesnotmatch)
- [doesNotMatchAll](_nodes_selectstatement_.selectstatement.md#doesnotmatchall)
- [doesNotMatchAny](_nodes_selectstatement_.selectstatement.md#doesnotmatchany)
- [doesNotMatchRegexp](_nodes_selectstatement_.selectstatement.md#doesnotmatchregexp)
- [eq](_nodes_selectstatement_.selectstatement.md#eq)
- [eqAll](_nodes_selectstatement_.selectstatement.md#eqall)
- [eqAny](_nodes_selectstatement_.selectstatement.md#eqany)
- [extract](_nodes_selectstatement_.selectstatement.md#extract)
- [groupingAll](_nodes_selectstatement_.selectstatement.md#protected-groupingall)
- [groupingAny](_nodes_selectstatement_.selectstatement.md#protected-groupingany)
- [gt](_nodes_selectstatement_.selectstatement.md#gt)
- [gtAll](_nodes_selectstatement_.selectstatement.md#gtall)
- [gtAny](_nodes_selectstatement_.selectstatement.md#gtany)
- [gteq](_nodes_selectstatement_.selectstatement.md#gteq)
- [gteqAll](_nodes_selectstatement_.selectstatement.md#gteqall)
- [gteqAny](_nodes_selectstatement_.selectstatement.md#gteqany)
- [inAll](_nodes_selectstatement_.selectstatement.md#inall)
- [inAny](_nodes_selectstatement_.selectstatement.md#inany)
- [inVal](_nodes_selectstatement_.selectstatement.md#inval)
- [isDistinctFrom](_nodes_selectstatement_.selectstatement.md#isdistinctfrom)
- [isInfinity](_nodes_selectstatement_.selectstatement.md#protected-isinfinity)
- [isNotDistinctFrom](_nodes_selectstatement_.selectstatement.md#isnotdistinctfrom)
- [isOpenEnded](_nodes_selectstatement_.selectstatement.md#protected-isopenended)
- [isUnboundable](_nodes_selectstatement_.selectstatement.md#protected-isunboundable)
- [lt](_nodes_selectstatement_.selectstatement.md#lt)
- [ltAll](_nodes_selectstatement_.selectstatement.md#ltall)
- [ltAny](_nodes_selectstatement_.selectstatement.md#ltany)
- [lteq](_nodes_selectstatement_.selectstatement.md#lteq)
- [lteqAll](_nodes_selectstatement_.selectstatement.md#lteqall)
- [lteqAny](_nodes_selectstatement_.selectstatement.md#lteqany)
- [matches](_nodes_selectstatement_.selectstatement.md#matches)
- [matchesAll](_nodes_selectstatement_.selectstatement.md#matchesall)
- [matchesAny](_nodes_selectstatement_.selectstatement.md#matchesany)
- [matchesRegexp](_nodes_selectstatement_.selectstatement.md#matchesregexp)
- [maximum](_nodes_selectstatement_.selectstatement.md#maximum)
- [minimum](_nodes_selectstatement_.selectstatement.md#minimum)
- [multiply](_nodes_selectstatement_.selectstatement.md#multiply)
- [notBetween](_nodes_selectstatement_.selectstatement.md#notbetween)
- [notEq](_nodes_selectstatement_.selectstatement.md#noteq)
- [notEqAll](_nodes_selectstatement_.selectstatement.md#noteqall)
- [notEqAny](_nodes_selectstatement_.selectstatement.md#noteqany)
- [notInAll](_nodes_selectstatement_.selectstatement.md#notinall)
- [notInAny](_nodes_selectstatement_.selectstatement.md#notinany)
- [notInVal](_nodes_selectstatement_.selectstatement.md#notinval)
- [quotedArray](_nodes_selectstatement_.selectstatement.md#quotedarray)
- [quotedNode](_nodes_selectstatement_.selectstatement.md#quotednode)
- [subtract](_nodes_selectstatement_.selectstatement.md#subtract)
- [sum](_nodes_selectstatement_.selectstatement.md#sum)
- [toSQL](_nodes_selectstatement_.selectstatement.md#tosql)
- [when](_nodes_selectstatement_.selectstatement.md#when)

## Constructors

### constructor

\+ **new SelectStatement**(`cores`:
[SelectCore](_nodes_selectcore_.selectcore.md)[]):
_[SelectStatement](_nodes_selectstatement_.selectstatement.md)_

_Defined in
[src/nodes/SelectStatement.ts:17](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/SelectStatement.ts#L17)_

**Parameters:**

| Name    | Type                                             | Default            |
| ------- | ------------------------------------------------ | ------------------ |
| `cores` | [SelectCore](_nodes_selectcore_.selectcore.md)[] | [new SelectCore()] |

**Returns:** _[SelectStatement](_nodes_selectstatement_.selectstatement.md)_

## Properties

### `Readonly` cores

• **cores**: _[SelectCore](_nodes_selectcore_.selectcore.md)[]_

_Defined in
[src/nodes/SelectStatement.ts:7](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/SelectStatement.ts#L7)_
...
_Defined in
[src/nodes/SelectStatement.ts:9](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/SelectStatement.ts#L9)_
...
_Defined in
[src/nodes/SelectStatement.ts:11](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/SelectStatement.ts#L11)_
...
_Defined in
[src/nodes/SelectStatement.ts:13](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/SelectStatement.ts#L13)_
...
_Defined in
[src/nodes/SelectStatement.ts:15](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/SelectStatement.ts#L15)_
