...
- [constructor](nodes.offset.md#constructor)

### Properties

- [expr](nodes.offset.md#expr)

### Accessors

- [value](nodes.offset.md#value)

### Methods

- [add](nodes.offset.md#add)
- [and](nodes.offset.md#and)
- [as](nodes.offset.md#as)
- [asc](nodes.offset.md#asc)
- [average](nodes.offset.md#average)
- [between](nodes.offset.md#between)
- [bitwiseAnd](nodes.offset.md#bitwiseand)
- [bitwiseNot](nodes.offset.md#bitwisenot)
- [bitwiseOr](nodes.offset.md#bitwiseor)
- [bitwiseShiftLeft](nodes.offset.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.offset.md#bitwiseshiftright)
- [bitwiseXor](nodes.offset.md#bitwisexor)
- [coalesce](nodes.offset.md#coalesce)
- [concat](nodes.offset.md#concat)
- [count](nodes.offset.md#count)
- [createAnd](nodes.offset.md#createand)
- [createFalse](nodes.offset.md#createfalse)
- [createJoin](nodes.offset.md#createjoin)
- [createOn](nodes.offset.md#createon)
- [createStringJoin](nodes.offset.md#createstringjoin)
- [createTableAlias](nodes.offset.md#createtablealias)
- [createTrue](nodes.offset.md#createtrue)
- [desc](nodes.offset.md#desc)
- [divide](nodes.offset.md#divide)
- [doesNotMatch](nodes.offset.md#doesnotmatch)
- [doesNotMatchAll](nodes.offset.md#doesnotmatchall)
- [doesNotMatchAny](nodes.offset.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.offset.md#doesnotmatchregexp)
- [eq](nodes.offset.md#eq)
- [eqAll](nodes.offset.md#eqall)
- [eqAny](nodes.offset.md#eqany)
- [extract](nodes.offset.md#extract)
- [grouping](nodes.offset.md#grouping)
- [groupingAll](nodes.offset.md#groupingall)
- [groupingAny](nodes.offset.md#groupingany)
- [gt](nodes.offset.md#gt)
- [gtAll](nodes.offset.md#gtall)
- [gtAny](nodes.offset.md#gtany)
- [gteq](nodes.offset.md#gteq)
- [gteqAll](nodes.offset.md#gteqall)
- [gteqAny](nodes.offset.md#gteqany)
- [inAll](nodes.offset.md#inall)
- [inAny](nodes.offset.md#inany)
- [inVal](nodes.offset.md#inval)
- [isDistinctFrom](nodes.offset.md#isdistinctfrom)
- [isInfinity](nodes.offset.md#isinfinity)
- [isNotDistinctFrom](nodes.offset.md#isnotdistinctfrom)
- [isOpenEnded](nodes.offset.md#isopenended)
- [isUnboundable](nodes.offset.md#isunboundable)
- [lower](nodes.offset.md#lower)
- [lt](nodes.offset.md#lt)
- [ltAll](nodes.offset.md#ltall)
- [ltAny](nodes.offset.md#ltany)
- [lteq](nodes.offset.md#lteq)
- [lteqAll](nodes.offset.md#lteqall)
- [lteqAny](nodes.offset.md#lteqany)
- [matches](nodes.offset.md#matches)
- [matchesAll](nodes.offset.md#matchesall)
- [matchesAny](nodes.offset.md#matchesany)
- [matchesRegexp](nodes.offset.md#matchesregexp)
- [maximum](nodes.offset.md#maximum)
- [minimum](nodes.offset.md#minimum)
- [multiply](nodes.offset.md#multiply)
- [not](nodes.offset.md#not)
- [notBetween](nodes.offset.md#notbetween)
- [notEq](nodes.offset.md#noteq)
- [notEqAll](nodes.offset.md#noteqall)
- [notEqAny](nodes.offset.md#noteqany)
- [notInAll](nodes.offset.md#notinall)
- [notInAny](nodes.offset.md#notinany)
- [notInVal](nodes.offset.md#notinval)
- [or](nodes.offset.md#or)
- [quotedArray](nodes.offset.md#quotedarray)
- [quotedNode](nodes.offset.md#quotednode)
- [subtract](nodes.offset.md#subtract)
- [sum](nodes.offset.md#sum)
- [toSQL](nodes.offset.md#tosql)
- [when](nodes.offset.md#when)

## Constructors

### constructor

\+ **new Offset**(`expr`: [_Visitable_](../modules/visitors.md#visitable)):
...
**Returns:** [_Offset_](nodes.offset.md)
