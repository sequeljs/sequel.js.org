...
- [constructor](nodes.cube.md#constructor)

### Properties

- [expr](nodes.cube.md#expr)

### Accessors

- [value](nodes.cube.md#value)

### Methods

- [add](nodes.cube.md#add)
- [and](nodes.cube.md#and)
- [as](nodes.cube.md#as)
- [asc](nodes.cube.md#asc)
- [average](nodes.cube.md#average)
- [between](nodes.cube.md#between)
- [bitwiseAnd](nodes.cube.md#bitwiseand)
- [bitwiseNot](nodes.cube.md#bitwisenot)
- [bitwiseOr](nodes.cube.md#bitwiseor)
- [bitwiseShiftLeft](nodes.cube.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.cube.md#bitwiseshiftright)
- [bitwiseXor](nodes.cube.md#bitwisexor)
- [coalesce](nodes.cube.md#coalesce)
- [concat](nodes.cube.md#concat)
- [count](nodes.cube.md#count)
- [createAnd](nodes.cube.md#createand)
- [createFalse](nodes.cube.md#createfalse)
- [createJoin](nodes.cube.md#createjoin)
- [createOn](nodes.cube.md#createon)
- [createStringJoin](nodes.cube.md#createstringjoin)
- [createTableAlias](nodes.cube.md#createtablealias)
- [createTrue](nodes.cube.md#createtrue)
- [desc](nodes.cube.md#desc)
- [divide](nodes.cube.md#divide)
- [doesNotMatch](nodes.cube.md#doesnotmatch)
- [doesNotMatchAll](nodes.cube.md#doesnotmatchall)
- [doesNotMatchAny](nodes.cube.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.cube.md#doesnotmatchregexp)
- [eq](nodes.cube.md#eq)
- [eqAll](nodes.cube.md#eqall)
- [eqAny](nodes.cube.md#eqany)
- [extract](nodes.cube.md#extract)
- [grouping](nodes.cube.md#grouping)
- [groupingAll](nodes.cube.md#groupingall)
- [groupingAny](nodes.cube.md#groupingany)
- [gt](nodes.cube.md#gt)
- [gtAll](nodes.cube.md#gtall)
- [gtAny](nodes.cube.md#gtany)
- [gteq](nodes.cube.md#gteq)
- [gteqAll](nodes.cube.md#gteqall)
- [gteqAny](nodes.cube.md#gteqany)
- [inAll](nodes.cube.md#inall)
- [inAny](nodes.cube.md#inany)
- [inVal](nodes.cube.md#inval)
- [isDistinctFrom](nodes.cube.md#isdistinctfrom)
- [isInfinity](nodes.cube.md#isinfinity)
- [isNotDistinctFrom](nodes.cube.md#isnotdistinctfrom)
- [isOpenEnded](nodes.cube.md#isopenended)
- [isUnboundable](nodes.cube.md#isunboundable)
- [lower](nodes.cube.md#lower)
- [lt](nodes.cube.md#lt)
- [ltAll](nodes.cube.md#ltall)
- [ltAny](nodes.cube.md#ltany)
- [lteq](nodes.cube.md#lteq)
- [lteqAll](nodes.cube.md#lteqall)
- [lteqAny](nodes.cube.md#lteqany)
- [matches](nodes.cube.md#matches)
- [matchesAll](nodes.cube.md#matchesall)
- [matchesAny](nodes.cube.md#matchesany)
- [matchesRegexp](nodes.cube.md#matchesregexp)
- [maximum](nodes.cube.md#maximum)
- [minimum](nodes.cube.md#minimum)
- [multiply](nodes.cube.md#multiply)
- [not](nodes.cube.md#not)
- [notBetween](nodes.cube.md#notbetween)
- [notEq](nodes.cube.md#noteq)
- [notEqAll](nodes.cube.md#noteqall)
- [notEqAny](nodes.cube.md#noteqany)
- [notInAll](nodes.cube.md#notinall)
- [notInAny](nodes.cube.md#notinany)
- [notInVal](nodes.cube.md#notinval)
- [or](nodes.cube.md#or)
- [quotedArray](nodes.cube.md#quotedarray)
- [quotedNode](nodes.cube.md#quotednode)
- [subtract](nodes.cube.md#subtract)
- [sum](nodes.cube.md#sum)
- [toSQL](nodes.cube.md#tosql)
- [when](nodes.cube.md#when)

## Constructors

### constructor

\+ **new Cube**(`expr`: [_GroupingElement_](nodes.groupingelement.md) \|
[_Visitable_](../modules/visitors.md#visitable)[]): [_Cube_](nodes.cube.md)
