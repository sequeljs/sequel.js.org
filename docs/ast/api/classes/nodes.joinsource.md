...
[Nodes](../modules/nodes.md) / JoinSource
...
- [constructor](nodes.joinsource.md#constructor)

### Properties

- [left](nodes.joinsource.md#left)
- [right](nodes.joinsource.md#right)

### Methods

- [add](nodes.joinsource.md#add)
- [and](nodes.joinsource.md#and)
- [as](nodes.joinsource.md#as)
- [asc](nodes.joinsource.md#asc)
- [average](nodes.joinsource.md#average)
- [between](nodes.joinsource.md#between)
- [bitwiseAnd](nodes.joinsource.md#bitwiseand)
- [bitwiseNot](nodes.joinsource.md#bitwisenot)
- [bitwiseOr](nodes.joinsource.md#bitwiseor)
- [bitwiseShiftLeft](nodes.joinsource.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.joinsource.md#bitwiseshiftright)
- [bitwiseXor](nodes.joinsource.md#bitwisexor)
- [coalesce](nodes.joinsource.md#coalesce)
- [concat](nodes.joinsource.md#concat)
- [count](nodes.joinsource.md#count)
- [createAnd](nodes.joinsource.md#createand)
- [createFalse](nodes.joinsource.md#createfalse)
- [createJoin](nodes.joinsource.md#createjoin)
- [createOn](nodes.joinsource.md#createon)
- [createStringJoin](nodes.joinsource.md#createstringjoin)
- [createTableAlias](nodes.joinsource.md#createtablealias)
- [createTrue](nodes.joinsource.md#createtrue)
- [desc](nodes.joinsource.md#desc)
- [divide](nodes.joinsource.md#divide)
- [doesNotMatch](nodes.joinsource.md#doesnotmatch)
- [doesNotMatchAll](nodes.joinsource.md#doesnotmatchall)
- [doesNotMatchAny](nodes.joinsource.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.joinsource.md#doesnotmatchregexp)
- [eq](nodes.joinsource.md#eq)
- [eqAll](nodes.joinsource.md#eqall)
- [eqAny](nodes.joinsource.md#eqany)
- [extract](nodes.joinsource.md#extract)
- [grouping](nodes.joinsource.md#grouping)
- [groupingAll](nodes.joinsource.md#groupingall)
- [groupingAny](nodes.joinsource.md#groupingany)
- [gt](nodes.joinsource.md#gt)
- [gtAll](nodes.joinsource.md#gtall)
- [gtAny](nodes.joinsource.md#gtany)
- [gteq](nodes.joinsource.md#gteq)
- [gteqAll](nodes.joinsource.md#gteqall)
- [gteqAny](nodes.joinsource.md#gteqany)
- [inAll](nodes.joinsource.md#inall)
- [inAny](nodes.joinsource.md#inany)
- [inVal](nodes.joinsource.md#inval)
- [isDistinctFrom](nodes.joinsource.md#isdistinctfrom)
- [isInfinity](nodes.joinsource.md#isinfinity)
- [isNotDistinctFrom](nodes.joinsource.md#isnotdistinctfrom)
- [isOpenEnded](nodes.joinsource.md#isopenended)
- [isUnboundable](nodes.joinsource.md#isunboundable)
- [lower](nodes.joinsource.md#lower)
- [lt](nodes.joinsource.md#lt)
- [ltAll](nodes.joinsource.md#ltall)
- [ltAny](nodes.joinsource.md#ltany)
- [lteq](nodes.joinsource.md#lteq)
- [lteqAll](nodes.joinsource.md#lteqall)
- [lteqAny](nodes.joinsource.md#lteqany)
- [matches](nodes.joinsource.md#matches)
- [matchesAll](nodes.joinsource.md#matchesall)
- [matchesAny](nodes.joinsource.md#matchesany)
- [matchesRegexp](nodes.joinsource.md#matchesregexp)
- [maximum](nodes.joinsource.md#maximum)
- [minimum](nodes.joinsource.md#minimum)
- [multiply](nodes.joinsource.md#multiply)
- [not](nodes.joinsource.md#not)
- [notBetween](nodes.joinsource.md#notbetween)
- [notEq](nodes.joinsource.md#noteq)
- [notEqAll](nodes.joinsource.md#noteqall)
- [notEqAny](nodes.joinsource.md#noteqany)
- [notInAll](nodes.joinsource.md#notinall)
- [notInAny](nodes.joinsource.md#notinany)
- [notInVal](nodes.joinsource.md#notinval)
- [or](nodes.joinsource.md#or)
- [quotedArray](nodes.joinsource.md#quotedarray)
- [quotedNode](nodes.joinsource.md#quotednode)
- [subtract](nodes.joinsource.md#subtract)
- [sum](nodes.joinsource.md#sum)
- [toSQL](nodes.joinsource.md#tosql)
- [when](nodes.joinsource.md#when)

## Constructors

### constructor

\+ **new JoinSource**(`singleSource`: _any_, `joinop?`: _any_[]):
...
Defined in:
[src/nodes/JoinSource.ts:3](https://github.com/sequeljs/ast/blob/6632050/src/nodes/JoinSource.ts#L3)
