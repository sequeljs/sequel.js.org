...
["nodes/As"](../modules/_nodes_as_.md) › [As](_nodes_as_.as.md)
...
- [constructor](_nodes_as_.as.md#constructor)

### Properties

- [left](_nodes_as_.as.md#left)
- [right](_nodes_as_.as.md#right)

### Methods

- [as](_nodes_as_.as.md#as)
- [toSQL](_nodes_as_.as.md#tosql)

## Constructors

### constructor

\+ **new As**(`left`: L, `right`: R): _[As](_nodes_as_.as.md)_
