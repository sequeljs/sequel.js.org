...
- [constructor](nodes.quoted.md#constructor)

### Properties

- [expr](nodes.quoted.md#expr)

### Accessors

- [value](nodes.quoted.md#value)

### Methods

- [add](nodes.quoted.md#add)
- [and](nodes.quoted.md#and)
- [as](nodes.quoted.md#as)
- [asc](nodes.quoted.md#asc)
- [average](nodes.quoted.md#average)
- [between](nodes.quoted.md#between)
- [bitwiseAnd](nodes.quoted.md#bitwiseand)
- [bitwiseNot](nodes.quoted.md#bitwisenot)
- [bitwiseOr](nodes.quoted.md#bitwiseor)
- [bitwiseShiftLeft](nodes.quoted.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.quoted.md#bitwiseshiftright)
- [bitwiseXor](nodes.quoted.md#bitwisexor)
- [coalesce](nodes.quoted.md#coalesce)
- [concat](nodes.quoted.md#concat)
- [count](nodes.quoted.md#count)
- [createAnd](nodes.quoted.md#createand)
- [createFalse](nodes.quoted.md#createfalse)
- [createJoin](nodes.quoted.md#createjoin)
- [createOn](nodes.quoted.md#createon)
- [createStringJoin](nodes.quoted.md#createstringjoin)
- [createTableAlias](nodes.quoted.md#createtablealias)
- [createTrue](nodes.quoted.md#createtrue)
- [desc](nodes.quoted.md#desc)
- [divide](nodes.quoted.md#divide)
- [doesNotMatch](nodes.quoted.md#doesnotmatch)
- [doesNotMatchAll](nodes.quoted.md#doesnotmatchall)
- [doesNotMatchAny](nodes.quoted.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.quoted.md#doesnotmatchregexp)
- [eq](nodes.quoted.md#eq)
- [eqAll](nodes.quoted.md#eqall)
- [eqAny](nodes.quoted.md#eqany)
- [extract](nodes.quoted.md#extract)
- [grouping](nodes.quoted.md#grouping)
- [groupingAll](nodes.quoted.md#groupingall)
- [groupingAny](nodes.quoted.md#groupingany)
- [gt](nodes.quoted.md#gt)
- [gtAll](nodes.quoted.md#gtall)
- [gtAny](nodes.quoted.md#gtany)
- [gteq](nodes.quoted.md#gteq)
- [gteqAll](nodes.quoted.md#gteqall)
- [gteqAny](nodes.quoted.md#gteqany)
- [inAll](nodes.quoted.md#inall)
- [inAny](nodes.quoted.md#inany)
- [inVal](nodes.quoted.md#inval)
- [isDistinctFrom](nodes.quoted.md#isdistinctfrom)
- [isInfinite](nodes.quoted.md#isinfinite)
- [isInfinity](nodes.quoted.md#isinfinity)
- [isNotDistinctFrom](nodes.quoted.md#isnotdistinctfrom)
- [isOpenEnded](nodes.quoted.md#isopenended)
- [isUnboundable](nodes.quoted.md#isunboundable)
- [lower](nodes.quoted.md#lower)
- [lt](nodes.quoted.md#lt)
- [ltAll](nodes.quoted.md#ltall)
- [ltAny](nodes.quoted.md#ltany)
- [lteq](nodes.quoted.md#lteq)
- [lteqAll](nodes.quoted.md#lteqall)
- [lteqAny](nodes.quoted.md#lteqany)
- [matches](nodes.quoted.md#matches)
- [matchesAll](nodes.quoted.md#matchesall)
- [matchesAny](nodes.quoted.md#matchesany)
- [matchesRegexp](nodes.quoted.md#matchesregexp)
- [maximum](nodes.quoted.md#maximum)
- [minimum](nodes.quoted.md#minimum)
- [multiply](nodes.quoted.md#multiply)
- [not](nodes.quoted.md#not)
- [notBetween](nodes.quoted.md#notbetween)
- [notEq](nodes.quoted.md#noteq)
- [notEqAll](nodes.quoted.md#noteqall)
- [notEqAny](nodes.quoted.md#noteqany)
- [notInAll](nodes.quoted.md#notinall)
- [notInAny](nodes.quoted.md#notinany)
- [notInVal](nodes.quoted.md#notinval)
- [or](nodes.quoted.md#or)
- [quotedArray](nodes.quoted.md#quotedarray)
- [quotedNode](nodes.quoted.md#quotednode)
- [subtract](nodes.quoted.md#subtract)
- [sum](nodes.quoted.md#sum)
- [toSQL](nodes.quoted.md#tosql)
- [when](nodes.quoted.md#when)
...
Defined in:
[src/nodes/Quoted.ts:4](https://github.com/sequeljs/ast/blob/6632050/src/nodes/Quoted.ts#L4)
