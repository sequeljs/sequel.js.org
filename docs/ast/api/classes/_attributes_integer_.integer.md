---
id: '_attributes_integer_.integer'
title: 'Integer'
...
- [constructor](_attributes_integer_.integer.md#constructor)

### Properties

- [name](_attributes_integer_.integer.md#name)
- [relation](_attributes_integer_.integer.md#relation)

### Methods

- [add](_attributes_integer_.integer.md#add)
- [as](_attributes_integer_.integer.md#as)
- [asc](_attributes_integer_.integer.md#asc)
- [average](_attributes_integer_.integer.md#average)
- [between](_attributes_integer_.integer.md#between)
- [bitwiseAnd](_attributes_integer_.integer.md#bitwiseand)
- [bitwiseNot](_attributes_integer_.integer.md#bitwisenot)
- [bitwiseOr](_attributes_integer_.integer.md#bitwiseor)
- [bitwiseShiftLeft](_attributes_integer_.integer.md#bitwiseshiftleft)
- [bitwiseShiftRight](_attributes_integer_.integer.md#bitwiseshiftright)
- [bitwiseXor](_attributes_integer_.integer.md#bitwisexor)
- [concat](_attributes_integer_.integer.md#concat)
- [count](_attributes_integer_.integer.md#count)
- [desc](_attributes_integer_.integer.md#desc)
- [divide](_attributes_integer_.integer.md#divide)
- [doesNotMatch](_attributes_integer_.integer.md#doesnotmatch)
- [doesNotMatchAll](_attributes_integer_.integer.md#doesnotmatchall)
- [doesNotMatchAny](_attributes_integer_.integer.md#doesnotmatchany)
- [doesNotMatchRegexp](_attributes_integer_.integer.md#doesnotmatchregexp)
- [eq](_attributes_integer_.integer.md#eq)
- [eqAll](_attributes_integer_.integer.md#eqall)
- [eqAny](_attributes_integer_.integer.md#eqany)
- [extract](_attributes_integer_.integer.md#extract)
- [groupingAll](_attributes_integer_.integer.md#protected-groupingall)
- [groupingAny](_attributes_integer_.integer.md#protected-groupingany)
- [gt](_attributes_integer_.integer.md#gt)
- [gtAll](_attributes_integer_.integer.md#gtall)
- [gtAny](_attributes_integer_.integer.md#gtany)
- [gteq](_attributes_integer_.integer.md#gteq)
- [gteqAll](_attributes_integer_.integer.md#gteqall)
- [gteqAny](_attributes_integer_.integer.md#gteqany)
- [inAll](_attributes_integer_.integer.md#inall)
- [inAny](_attributes_integer_.integer.md#inany)
- [inVal](_attributes_integer_.integer.md#inval)
- [isAbleToTypeCast](_attributes_integer_.integer.md#isabletotypecast)
- [isDistinctFrom](_attributes_integer_.integer.md#isdistinctfrom)
- [isInfinity](_attributes_integer_.integer.md#protected-isinfinity)
- [isNotDistinctFrom](_attributes_integer_.integer.md#isnotdistinctfrom)
- [isOpenEnded](_attributes_integer_.integer.md#protected-isopenended)
- [isUnboundable](_attributes_integer_.integer.md#protected-isunboundable)
- [lower](_attributes_integer_.integer.md#lower)
- [lt](_attributes_integer_.integer.md#lt)
- [ltAll](_attributes_integer_.integer.md#ltall)
- [ltAny](_attributes_integer_.integer.md#ltany)
- [lteq](_attributes_integer_.integer.md#lteq)
- [lteqAll](_attributes_integer_.integer.md#lteqall)
- [lteqAny](_attributes_integer_.integer.md#lteqany)
- [matches](_attributes_integer_.integer.md#matches)
- [matchesAll](_attributes_integer_.integer.md#matchesall)
- [matchesAny](_attributes_integer_.integer.md#matchesany)
- [matchesRegexp](_attributes_integer_.integer.md#matchesregexp)
- [maximum](_attributes_integer_.integer.md#maximum)
- [minimum](_attributes_integer_.integer.md#minimum)
- [multiply](_attributes_integer_.integer.md#multiply)
- [notBetween](_attributes_integer_.integer.md#notbetween)
- [notEq](_attributes_integer_.integer.md#noteq)
- [notEqAll](_attributes_integer_.integer.md#noteqall)
- [notEqAny](_attributes_integer_.integer.md#noteqany)
- [notInAll](_attributes_integer_.integer.md#notinall)
- [notInAny](_attributes_integer_.integer.md#notinany)
- [notInVal](_attributes_integer_.integer.md#notinval)
- [quotedArray](_attributes_integer_.integer.md#quotedarray)
- [quotedNode](_attributes_integer_.integer.md#quotednode)
- [subtract](_attributes_integer_.integer.md#subtract)
- [sum](_attributes_integer_.integer.md#sum)
- [typeCastForDatabase](_attributes_integer_.integer.md#typecastfordatabase)
- [when](_attributes_integer_.integer.md#when)

## Constructors

### constructor

\+ **new Integer**(`relation`:
[Relation](../modules/_interfaces_relation_.md#relation), `name`: string |
[SQLLiteral](_nodes_sqlliteral_.sqlliteral.md)):
_[Integer](_attributes_integer_.integer.md)_
...
**Returns:** _[Integer](_attributes_integer_.integer.md)_
