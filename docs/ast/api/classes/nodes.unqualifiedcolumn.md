...
[Nodes](../modules/nodes.md) / UnqualifiedColumn

# Class: UnqualifiedColumn

## Hierarchy

- [_Unary_](nodes.unary.md)<[_Attribute_](attributes.attribute.md)\>
...
- [constructor](nodes.unqualifiedcolumn.md#constructor)

### Properties

- [expr](nodes.unqualifiedcolumn.md#expr)

### Accessors

- [attribute](nodes.unqualifiedcolumn.md#attribute)
- [column](nodes.unqualifiedcolumn.md#column)
- [name](nodes.unqualifiedcolumn.md#name)
- [relation](nodes.unqualifiedcolumn.md#relation)
- [value](nodes.unqualifiedcolumn.md#value)

### Methods

- [add](nodes.unqualifiedcolumn.md#add)
- [and](nodes.unqualifiedcolumn.md#and)
- [as](nodes.unqualifiedcolumn.md#as)
- [asc](nodes.unqualifiedcolumn.md#asc)
- [average](nodes.unqualifiedcolumn.md#average)
- [between](nodes.unqualifiedcolumn.md#between)
- [bitwiseAnd](nodes.unqualifiedcolumn.md#bitwiseand)
- [bitwiseNot](nodes.unqualifiedcolumn.md#bitwisenot)
- [bitwiseOr](nodes.unqualifiedcolumn.md#bitwiseor)
- [bitwiseShiftLeft](nodes.unqualifiedcolumn.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.unqualifiedcolumn.md#bitwiseshiftright)
- [bitwiseXor](nodes.unqualifiedcolumn.md#bitwisexor)
- [coalesce](nodes.unqualifiedcolumn.md#coalesce)
- [concat](nodes.unqualifiedcolumn.md#concat)
- [count](nodes.unqualifiedcolumn.md#count)
- [createAnd](nodes.unqualifiedcolumn.md#createand)
- [createFalse](nodes.unqualifiedcolumn.md#createfalse)
- [createJoin](nodes.unqualifiedcolumn.md#createjoin)
- [createOn](nodes.unqualifiedcolumn.md#createon)
- [createStringJoin](nodes.unqualifiedcolumn.md#createstringjoin)
- [createTableAlias](nodes.unqualifiedcolumn.md#createtablealias)
- [createTrue](nodes.unqualifiedcolumn.md#createtrue)
- [desc](nodes.unqualifiedcolumn.md#desc)
- [divide](nodes.unqualifiedcolumn.md#divide)
- [doesNotMatch](nodes.unqualifiedcolumn.md#doesnotmatch)
- [doesNotMatchAll](nodes.unqualifiedcolumn.md#doesnotmatchall)
- [doesNotMatchAny](nodes.unqualifiedcolumn.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.unqualifiedcolumn.md#doesnotmatchregexp)
- [eq](nodes.unqualifiedcolumn.md#eq)
- [eqAll](nodes.unqualifiedcolumn.md#eqall)
- [eqAny](nodes.unqualifiedcolumn.md#eqany)
- [extract](nodes.unqualifiedcolumn.md#extract)
- [grouping](nodes.unqualifiedcolumn.md#grouping)
- [groupingAll](nodes.unqualifiedcolumn.md#groupingall)
- [groupingAny](nodes.unqualifiedcolumn.md#groupingany)
- [gt](nodes.unqualifiedcolumn.md#gt)
- [gtAll](nodes.unqualifiedcolumn.md#gtall)
- [gtAny](nodes.unqualifiedcolumn.md#gtany)
- [gteq](nodes.unqualifiedcolumn.md#gteq)
- [gteqAll](nodes.unqualifiedcolumn.md#gteqall)
- [gteqAny](nodes.unqualifiedcolumn.md#gteqany)
- [inAll](nodes.unqualifiedcolumn.md#inall)
- [inAny](nodes.unqualifiedcolumn.md#inany)
- [inVal](nodes.unqualifiedcolumn.md#inval)
- [isDistinctFrom](nodes.unqualifiedcolumn.md#isdistinctfrom)
- [isInfinity](nodes.unqualifiedcolumn.md#isinfinity)
- [isNotDistinctFrom](nodes.unqualifiedcolumn.md#isnotdistinctfrom)
- [isOpenEnded](nodes.unqualifiedcolumn.md#isopenended)
- [isUnboundable](nodes.unqualifiedcolumn.md#isunboundable)
- [lower](nodes.unqualifiedcolumn.md#lower)
- [lt](nodes.unqualifiedcolumn.md#lt)
- [ltAll](nodes.unqualifiedcolumn.md#ltall)
- [ltAny](nodes.unqualifiedcolumn.md#ltany)
- [lteq](nodes.unqualifiedcolumn.md#lteq)
- [lteqAll](nodes.unqualifiedcolumn.md#lteqall)
- [lteqAny](nodes.unqualifiedcolumn.md#lteqany)
- [matches](nodes.unqualifiedcolumn.md#matches)
- [matchesAll](nodes.unqualifiedcolumn.md#matchesall)
- [matchesAny](nodes.unqualifiedcolumn.md#matchesany)
- [matchesRegexp](nodes.unqualifiedcolumn.md#matchesregexp)
- [maximum](nodes.unqualifiedcolumn.md#maximum)
- [minimum](nodes.unqualifiedcolumn.md#minimum)
- [multiply](nodes.unqualifiedcolumn.md#multiply)
- [not](nodes.unqualifiedcolumn.md#not)
- [notBetween](nodes.unqualifiedcolumn.md#notbetween)
- [notEq](nodes.unqualifiedcolumn.md#noteq)
- [notEqAll](nodes.unqualifiedcolumn.md#noteqall)
- [notEqAny](nodes.unqualifiedcolumn.md#noteqany)
- [notInAll](nodes.unqualifiedcolumn.md#notinall)
- [notInAny](nodes.unqualifiedcolumn.md#notinany)
- [notInVal](nodes.unqualifiedcolumn.md#notinval)
- [or](nodes.unqualifiedcolumn.md#or)
- [quotedArray](nodes.unqualifiedcolumn.md#quotedarray)
- [quotedNode](nodes.unqualifiedcolumn.md#quotednode)
- [subtract](nodes.unqualifiedcolumn.md#subtract)
- [sum](nodes.unqualifiedcolumn.md#sum)
- [toSQL](nodes.unqualifiedcolumn.md#tosql)
- [when](nodes.unqualifiedcolumn.md#when)

## Constructors

### constructor

\+ **new UnqualifiedColumn**(`expr`: [_Attribute_](attributes.attribute.md)):
...
| Name   | Type                                   |
| ------ | -------------------------------------- |
| `expr` | [_Attribute_](attributes.attribute.md) |

**Returns:** [_UnqualifiedColumn_](nodes.unqualifiedcolumn.md)

Inherited from: [Unary](nodes.unary.md)

Defined in:
[src/nodes/UnqualifiedColumn.ts:24](https://github.com/sequeljs/ast/blob/6632050/src/nodes/UnqualifiedColumn.ts#L24)
...
• **attribute**(): _this_[*expr*]

**Returns:** _this_[*expr*]

Defined in:
[src/nodes/UnqualifiedColumn.ts:6](https://github.com/sequeljs/ast/blob/6632050/src/nodes/UnqualifiedColumn.ts#L6)

• **attribute**(`val`: _this_[*expr*]): _void_
...
Defined in:
[src/nodes/UnqualifiedColumn.ts:10](https://github.com/sequeljs/ast/blob/6632050/src/nodes/UnqualifiedColumn.ts#L10)
...
Defined in:
[src/nodes/UnqualifiedColumn.ts:14](https://github.com/sequeljs/ast/blob/6632050/src/nodes/UnqualifiedColumn.ts#L14)
...
Defined in:
[src/nodes/UnqualifiedColumn.ts:18](https://github.com/sequeljs/ast/blob/6632050/src/nodes/UnqualifiedColumn.ts#L18)
...
**Returns:** [_Relation_](../modules/interfaces.md#relation)

Defined in:
[src/nodes/UnqualifiedColumn.ts:22](https://github.com/sequeljs/ast/blob/6632050/src/nodes/UnqualifiedColumn.ts#L22)
