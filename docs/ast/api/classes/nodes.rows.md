...
- [constructor](nodes.rows.md#constructor)

### Properties

- [expr](nodes.rows.md#expr)

### Accessors

- [value](nodes.rows.md#value)

### Methods

- [add](nodes.rows.md#add)
- [and](nodes.rows.md#and)
- [as](nodes.rows.md#as)
- [asc](nodes.rows.md#asc)
- [average](nodes.rows.md#average)
- [between](nodes.rows.md#between)
- [bitwiseAnd](nodes.rows.md#bitwiseand)
- [bitwiseNot](nodes.rows.md#bitwisenot)
- [bitwiseOr](nodes.rows.md#bitwiseor)
- [bitwiseShiftLeft](nodes.rows.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.rows.md#bitwiseshiftright)
- [bitwiseXor](nodes.rows.md#bitwisexor)
- [coalesce](nodes.rows.md#coalesce)
- [concat](nodes.rows.md#concat)
- [count](nodes.rows.md#count)
- [createAnd](nodes.rows.md#createand)
- [createFalse](nodes.rows.md#createfalse)
- [createJoin](nodes.rows.md#createjoin)
- [createOn](nodes.rows.md#createon)
- [createStringJoin](nodes.rows.md#createstringjoin)
- [createTableAlias](nodes.rows.md#createtablealias)
- [createTrue](nodes.rows.md#createtrue)
- [desc](nodes.rows.md#desc)
- [divide](nodes.rows.md#divide)
- [doesNotMatch](nodes.rows.md#doesnotmatch)
- [doesNotMatchAll](nodes.rows.md#doesnotmatchall)
- [doesNotMatchAny](nodes.rows.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.rows.md#doesnotmatchregexp)
- [eq](nodes.rows.md#eq)
- [eqAll](nodes.rows.md#eqall)
- [eqAny](nodes.rows.md#eqany)
- [extract](nodes.rows.md#extract)
- [grouping](nodes.rows.md#grouping)
- [groupingAll](nodes.rows.md#groupingall)
- [groupingAny](nodes.rows.md#groupingany)
- [gt](nodes.rows.md#gt)
- [gtAll](nodes.rows.md#gtall)
- [gtAny](nodes.rows.md#gtany)
- [gteq](nodes.rows.md#gteq)
- [gteqAll](nodes.rows.md#gteqall)
- [gteqAny](nodes.rows.md#gteqany)
- [inAll](nodes.rows.md#inall)
- [inAny](nodes.rows.md#inany)
- [inVal](nodes.rows.md#inval)
- [isDistinctFrom](nodes.rows.md#isdistinctfrom)
- [isInfinity](nodes.rows.md#isinfinity)
- [isNotDistinctFrom](nodes.rows.md#isnotdistinctfrom)
- [isOpenEnded](nodes.rows.md#isopenended)
- [isUnboundable](nodes.rows.md#isunboundable)
- [lower](nodes.rows.md#lower)
- [lt](nodes.rows.md#lt)
- [ltAll](nodes.rows.md#ltall)
- [ltAny](nodes.rows.md#ltany)
- [lteq](nodes.rows.md#lteq)
- [lteqAll](nodes.rows.md#lteqall)
- [lteqAny](nodes.rows.md#lteqany)
- [matches](nodes.rows.md#matches)
- [matchesAll](nodes.rows.md#matchesall)
- [matchesAny](nodes.rows.md#matchesany)
- [matchesRegexp](nodes.rows.md#matchesregexp)
- [maximum](nodes.rows.md#maximum)
- [minimum](nodes.rows.md#minimum)
- [multiply](nodes.rows.md#multiply)
- [not](nodes.rows.md#not)
- [notBetween](nodes.rows.md#notbetween)
- [notEq](nodes.rows.md#noteq)
- [notEqAll](nodes.rows.md#noteqall)
- [notEqAny](nodes.rows.md#noteqany)
- [notInAll](nodes.rows.md#notinall)
- [notInAny](nodes.rows.md#notinany)
- [notInVal](nodes.rows.md#notinval)
- [or](nodes.rows.md#or)
- [quotedArray](nodes.rows.md#quotedarray)
- [quotedNode](nodes.rows.md#quotednode)
- [subtract](nodes.rows.md#subtract)
- [sum](nodes.rows.md#sum)
- [toSQL](nodes.rows.md#tosql)
- [when](nodes.rows.md#when)

## Constructors

### constructor

\+ **new Rows**(`expr?`: _any_): [_Rows_](nodes.rows.md)
...
Defined in:
[src/nodes/Rows.ts:3](https://github.com/sequeljs/ast/blob/6632050/src/nodes/Rows.ts#L3)
