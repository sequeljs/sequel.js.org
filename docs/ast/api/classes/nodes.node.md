...
- [constructor](nodes.node.md#constructor)

### Properties

- [\_\_sequelASTUnquotable](nodes.node.md#__sequelastunquotable)

### Methods

- [and](nodes.node.md#and)
- [coalesce](nodes.node.md#coalesce)
- [createAnd](nodes.node.md#createand)
- [createFalse](nodes.node.md#createfalse)
- [createJoin](nodes.node.md#createjoin)
- [createOn](nodes.node.md#createon)
- [createStringJoin](nodes.node.md#createstringjoin)
- [createTableAlias](nodes.node.md#createtablealias)
- [createTrue](nodes.node.md#createtrue)
- [grouping](nodes.node.md#grouping)
- [lower](nodes.node.md#lower)
- [not](nodes.node.md#not)
- [or](nodes.node.md#or)
- [toSQL](nodes.node.md#tosql)
...
Defined in:
[src/nodes/Node.ts:14](https://github.com/sequeljs/ast/blob/6632050/src/nodes/Node.ts#L14)
