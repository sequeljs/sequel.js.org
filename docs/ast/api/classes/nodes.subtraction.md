...
[Nodes](../modules/nodes.md) / Subtraction
...
- [constructor](nodes.subtraction.md#constructor)

### Properties

- [left](nodes.subtraction.md#left)
- [operator](nodes.subtraction.md#operator)
- [right](nodes.subtraction.md#right)

### Methods

- [add](nodes.subtraction.md#add)
- [and](nodes.subtraction.md#and)
- [as](nodes.subtraction.md#as)
- [asc](nodes.subtraction.md#asc)
- [average](nodes.subtraction.md#average)
- [between](nodes.subtraction.md#between)
- [bitwiseAnd](nodes.subtraction.md#bitwiseand)
- [bitwiseNot](nodes.subtraction.md#bitwisenot)
- [bitwiseOr](nodes.subtraction.md#bitwiseor)
- [bitwiseShiftLeft](nodes.subtraction.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.subtraction.md#bitwiseshiftright)
- [bitwiseXor](nodes.subtraction.md#bitwisexor)
- [coalesce](nodes.subtraction.md#coalesce)
- [concat](nodes.subtraction.md#concat)
- [count](nodes.subtraction.md#count)
- [createAnd](nodes.subtraction.md#createand)
- [createFalse](nodes.subtraction.md#createfalse)
- [createJoin](nodes.subtraction.md#createjoin)
- [createOn](nodes.subtraction.md#createon)
- [createStringJoin](nodes.subtraction.md#createstringjoin)
- [createTableAlias](nodes.subtraction.md#createtablealias)
- [createTrue](nodes.subtraction.md#createtrue)
- [desc](nodes.subtraction.md#desc)
- [divide](nodes.subtraction.md#divide)
- [doesNotMatch](nodes.subtraction.md#doesnotmatch)
- [doesNotMatchAll](nodes.subtraction.md#doesnotmatchall)
- [doesNotMatchAny](nodes.subtraction.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.subtraction.md#doesnotmatchregexp)
- [eq](nodes.subtraction.md#eq)
- [eqAll](nodes.subtraction.md#eqall)
- [eqAny](nodes.subtraction.md#eqany)
- [extract](nodes.subtraction.md#extract)
- [grouping](nodes.subtraction.md#grouping)
- [groupingAll](nodes.subtraction.md#groupingall)
- [groupingAny](nodes.subtraction.md#groupingany)
- [gt](nodes.subtraction.md#gt)
- [gtAll](nodes.subtraction.md#gtall)
- [gtAny](nodes.subtraction.md#gtany)
- [gteq](nodes.subtraction.md#gteq)
- [gteqAll](nodes.subtraction.md#gteqall)
- [gteqAny](nodes.subtraction.md#gteqany)
- [inAll](nodes.subtraction.md#inall)
- [inAny](nodes.subtraction.md#inany)
- [inVal](nodes.subtraction.md#inval)
- [isDistinctFrom](nodes.subtraction.md#isdistinctfrom)
- [isInfinity](nodes.subtraction.md#isinfinity)
- [isNotDistinctFrom](nodes.subtraction.md#isnotdistinctfrom)
- [isOpenEnded](nodes.subtraction.md#isopenended)
- [isUnboundable](nodes.subtraction.md#isunboundable)
- [lower](nodes.subtraction.md#lower)
- [lt](nodes.subtraction.md#lt)
- [ltAll](nodes.subtraction.md#ltall)
- [ltAny](nodes.subtraction.md#ltany)
- [lteq](nodes.subtraction.md#lteq)
- [lteqAll](nodes.subtraction.md#lteqall)
- [lteqAny](nodes.subtraction.md#lteqany)
- [matches](nodes.subtraction.md#matches)
- [matchesAll](nodes.subtraction.md#matchesall)
- [matchesAny](nodes.subtraction.md#matchesany)
- [matchesRegexp](nodes.subtraction.md#matchesregexp)
- [maximum](nodes.subtraction.md#maximum)
- [minimum](nodes.subtraction.md#minimum)
- [multiply](nodes.subtraction.md#multiply)
- [not](nodes.subtraction.md#not)
- [notBetween](nodes.subtraction.md#notbetween)
- [notEq](nodes.subtraction.md#noteq)
- [notEqAll](nodes.subtraction.md#noteqall)
- [notEqAny](nodes.subtraction.md#noteqany)
- [notInAll](nodes.subtraction.md#notinall)
- [notInAny](nodes.subtraction.md#notinany)
- [notInVal](nodes.subtraction.md#notinval)
- [or](nodes.subtraction.md#or)
- [quotedArray](nodes.subtraction.md#quotedarray)
- [quotedNode](nodes.subtraction.md#quotednode)
- [subtract](nodes.subtraction.md#subtract)
- [sum](nodes.subtraction.md#sum)
- [toSQL](nodes.subtraction.md#tosql)
- [when](nodes.subtraction.md#when)

## Constructors

### constructor

\+ **new Subtraction**(`left`: _any_, `right`: _any_):
...
**Returns:** [_Subtraction_](nodes.subtraction.md)

Inherited from: [InfixOperation](nodes.infixoperation.md)

Defined in:
[src/nodes/Subtraction.ts:3](https://github.com/sequeljs/ast/blob/6632050/src/nodes/Subtraction.ts#L3)
