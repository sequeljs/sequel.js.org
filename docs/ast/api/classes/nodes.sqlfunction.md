...
[Nodes](../modules/nodes.md) / SQLFunction
...
- _WindowPredication_
  ...
  ↳↳ [_Count_](nodes.count.md)

  ↳↳ [_Exists_](nodes.exists.md)
...
- [constructor](nodes.sqlfunction.md#constructor)

### Properties

- [alias](nodes.sqlfunction.md#alias)
- [distinct](nodes.sqlfunction.md#distinct)
- [expressions](nodes.sqlfunction.md#expressions)

### Methods

- [add](nodes.sqlfunction.md#add)
- [and](nodes.sqlfunction.md#and)
- [as](nodes.sqlfunction.md#as)
- [asc](nodes.sqlfunction.md#asc)
- [average](nodes.sqlfunction.md#average)
- [between](nodes.sqlfunction.md#between)
- [bitwiseAnd](nodes.sqlfunction.md#bitwiseand)
- [bitwiseNot](nodes.sqlfunction.md#bitwisenot)
- [bitwiseOr](nodes.sqlfunction.md#bitwiseor)
- [bitwiseShiftLeft](nodes.sqlfunction.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.sqlfunction.md#bitwiseshiftright)
- [bitwiseXor](nodes.sqlfunction.md#bitwisexor)
- [coalesce](nodes.sqlfunction.md#coalesce)
- [concat](nodes.sqlfunction.md#concat)
- [count](nodes.sqlfunction.md#count)
- [createAnd](nodes.sqlfunction.md#createand)
- [createFalse](nodes.sqlfunction.md#createfalse)
- [createJoin](nodes.sqlfunction.md#createjoin)
- [createOn](nodes.sqlfunction.md#createon)
- [createStringJoin](nodes.sqlfunction.md#createstringjoin)
- [createTableAlias](nodes.sqlfunction.md#createtablealias)
- [createTrue](nodes.sqlfunction.md#createtrue)
- [desc](nodes.sqlfunction.md#desc)
- [divide](nodes.sqlfunction.md#divide)
- [doesNotMatch](nodes.sqlfunction.md#doesnotmatch)
- [doesNotMatchAll](nodes.sqlfunction.md#doesnotmatchall)
- [doesNotMatchAny](nodes.sqlfunction.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.sqlfunction.md#doesnotmatchregexp)
- [eq](nodes.sqlfunction.md#eq)
- [eqAll](nodes.sqlfunction.md#eqall)
- [eqAny](nodes.sqlfunction.md#eqany)
- [extract](nodes.sqlfunction.md#extract)
- [grouping](nodes.sqlfunction.md#grouping)
- [groupingAll](nodes.sqlfunction.md#groupingall)
- [groupingAny](nodes.sqlfunction.md#groupingany)
- [gt](nodes.sqlfunction.md#gt)
- [gtAll](nodes.sqlfunction.md#gtall)
- [gtAny](nodes.sqlfunction.md#gtany)
- [gteq](nodes.sqlfunction.md#gteq)
- [gteqAll](nodes.sqlfunction.md#gteqall)
- [gteqAny](nodes.sqlfunction.md#gteqany)
- [inAll](nodes.sqlfunction.md#inall)
- [inAny](nodes.sqlfunction.md#inany)
- [inVal](nodes.sqlfunction.md#inval)
- [isDistinctFrom](nodes.sqlfunction.md#isdistinctfrom)
- [isInfinity](nodes.sqlfunction.md#isinfinity)
- [isNotDistinctFrom](nodes.sqlfunction.md#isnotdistinctfrom)
- [isOpenEnded](nodes.sqlfunction.md#isopenended)
- [isUnboundable](nodes.sqlfunction.md#isunboundable)
- [lower](nodes.sqlfunction.md#lower)
- [lt](nodes.sqlfunction.md#lt)
- [ltAll](nodes.sqlfunction.md#ltall)
- [ltAny](nodes.sqlfunction.md#ltany)
- [lteq](nodes.sqlfunction.md#lteq)
- [lteqAll](nodes.sqlfunction.md#lteqall)
- [lteqAny](nodes.sqlfunction.md#lteqany)
- [matches](nodes.sqlfunction.md#matches)
- [matchesAll](nodes.sqlfunction.md#matchesall)
- [matchesAny](nodes.sqlfunction.md#matchesany)
- [matchesRegexp](nodes.sqlfunction.md#matchesregexp)
- [maximum](nodes.sqlfunction.md#maximum)
- [minimum](nodes.sqlfunction.md#minimum)
- [multiply](nodes.sqlfunction.md#multiply)
- [not](nodes.sqlfunction.md#not)
- [notBetween](nodes.sqlfunction.md#notbetween)
- [notEq](nodes.sqlfunction.md#noteq)
- [notEqAll](nodes.sqlfunction.md#noteqall)
- [notEqAny](nodes.sqlfunction.md#noteqany)
- [notInAll](nodes.sqlfunction.md#notinall)
- [notInAny](nodes.sqlfunction.md#notinany)
- [notInVal](nodes.sqlfunction.md#notinval)
- [or](nodes.sqlfunction.md#or)
- [over](nodes.sqlfunction.md#over)
- [quotedArray](nodes.sqlfunction.md#quotedarray)
- [quotedNode](nodes.sqlfunction.md#quotednode)
- [subtract](nodes.sqlfunction.md#subtract)
- [sum](nodes.sqlfunction.md#sum)
- [toSQL](nodes.sqlfunction.md#tosql)
- [when](nodes.sqlfunction.md#when)

## Constructors

### constructor

\+ **new SQLFunction**(`expr`: _any_, `aliaz?`: _null_ \| _string_ \|
[_SQLLiteral_](nodes.sqlliteral.md)): [_SQLFunction_](nodes.sqlfunction.md)
