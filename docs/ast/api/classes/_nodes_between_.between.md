...
- [constructor](_nodes_between_.between.md#constructor)

### Properties

- [left](_nodes_between_.between.md#left)
- [right](_nodes_between_.between.md#right)

### Methods

- [as](_nodes_between_.between.md#as)
- [toSQL](_nodes_between_.between.md#tosql)

## Constructors

### constructor

\+ **new Between**(`left`: L, `right`: R):
_[Between](_nodes_between_.between.md)_
...
**Returns:** _[Between](_nodes_between_.between.md)_
