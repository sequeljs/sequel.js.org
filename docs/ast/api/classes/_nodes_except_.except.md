...
- [constructor](_nodes_except_.except.md#constructor)

### Properties

- [left](_nodes_except_.except.md#left)
- [right](_nodes_except_.except.md#right)

### Methods

- [as](_nodes_except_.except.md#as)
- [toSQL](_nodes_except_.except.md#tosql)

## Constructors

### constructor

\+ **new Except**(`left`: L, `right`: R): _[Except](_nodes_except_.except.md)_
