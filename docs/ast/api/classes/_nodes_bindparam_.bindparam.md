---
id: '_nodes_bindparam_.bindparam'
title: 'BindParam'
sidebar_label: 'BindParam'
---
...
- [constructor](_nodes_bindparam_.bindparam.md#constructor)

### Properties

- [value](_nodes_bindparam_.bindparam.md#readonly-value)

### Methods

- [and](_nodes_bindparam_.bindparam.md#and)
- [coalesce](_nodes_bindparam_.bindparam.md#coalesce)
- [createAnd](_nodes_bindparam_.bindparam.md#createand)
- [createFalse](_nodes_bindparam_.bindparam.md#createfalse)
- [createJoin](_nodes_bindparam_.bindparam.md#createjoin)
- [createOn](_nodes_bindparam_.bindparam.md#createon)
- [createStringJoin](_nodes_bindparam_.bindparam.md#createstringjoin)
- [createTableAlias](_nodes_bindparam_.bindparam.md#createtablealias)
- [createTrue](_nodes_bindparam_.bindparam.md#createtrue)
- [grouping](_nodes_bindparam_.bindparam.md#grouping)
- [isInfinite](_nodes_bindparam_.bindparam.md#protected-isinfinite)
- [isUnboundable](_nodes_bindparam_.bindparam.md#protected-isunboundable)
- [lower](_nodes_bindparam_.bindparam.md#lower)
- [not](_nodes_bindparam_.bindparam.md#not)
- [or](_nodes_bindparam_.bindparam.md#or)
- [toSQL](_nodes_bindparam_.bindparam.md#tosql)

## Constructors

### constructor

\+ **new BindParam**(`value`: any):
_[BindParam](_nodes_bindparam_.bindparam.md)_

_Defined in
[src/nodes/BindParam.ts:4](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/BindParam.ts#L4)_
...
**Returns:** _[BindParam](_nodes_bindparam_.bindparam.md)_
...
_Defined in
[src/nodes/BindParam.ts:12](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/BindParam.ts#L12)_
...
▸ **isUnboundable**(): _boolean_

_Defined in
[src/nodes/BindParam.ts:16](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/BindParam.ts#L16)_
