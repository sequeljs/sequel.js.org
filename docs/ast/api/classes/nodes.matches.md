...
[Nodes](../modules/nodes.md) / Matches
...
- [_Binary_](nodes.binary.md)
  ...
  ↳↳ [_DoesNotMatch_](nodes.doesnotmatch.md)

## Table of contents

### Constructors

- [constructor](nodes.matches.md#constructor)

### Properties

- [caseSensitive](nodes.matches.md#casesensitive)
- [escape](nodes.matches.md#escape)
- [left](nodes.matches.md#left)
- [right](nodes.matches.md#right)

### Methods

- [add](nodes.matches.md#add)
- [and](nodes.matches.md#and)
- [as](nodes.matches.md#as)
- [asc](nodes.matches.md#asc)
- [average](nodes.matches.md#average)
- [between](nodes.matches.md#between)
- [bitwiseAnd](nodes.matches.md#bitwiseand)
- [bitwiseNot](nodes.matches.md#bitwisenot)
- [bitwiseOr](nodes.matches.md#bitwiseor)
- [bitwiseShiftLeft](nodes.matches.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.matches.md#bitwiseshiftright)
- [bitwiseXor](nodes.matches.md#bitwisexor)
- [coalesce](nodes.matches.md#coalesce)
- [concat](nodes.matches.md#concat)
- [count](nodes.matches.md#count)
- [createAnd](nodes.matches.md#createand)
- [createFalse](nodes.matches.md#createfalse)
- [createJoin](nodes.matches.md#createjoin)
- [createOn](nodes.matches.md#createon)
- [createStringJoin](nodes.matches.md#createstringjoin)
- [createTableAlias](nodes.matches.md#createtablealias)
- [createTrue](nodes.matches.md#createtrue)
- [desc](nodes.matches.md#desc)
- [divide](nodes.matches.md#divide)
- [doesNotMatch](nodes.matches.md#doesnotmatch)
- [doesNotMatchAll](nodes.matches.md#doesnotmatchall)
- [doesNotMatchAny](nodes.matches.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.matches.md#doesnotmatchregexp)
- [eq](nodes.matches.md#eq)
- [eqAll](nodes.matches.md#eqall)
- [eqAny](nodes.matches.md#eqany)
- [extract](nodes.matches.md#extract)
- [grouping](nodes.matches.md#grouping)
- [groupingAll](nodes.matches.md#groupingall)
- [groupingAny](nodes.matches.md#groupingany)
- [gt](nodes.matches.md#gt)
- [gtAll](nodes.matches.md#gtall)
- [gtAny](nodes.matches.md#gtany)
- [gteq](nodes.matches.md#gteq)
- [gteqAll](nodes.matches.md#gteqall)
- [gteqAny](nodes.matches.md#gteqany)
- [inAll](nodes.matches.md#inall)
- [inAny](nodes.matches.md#inany)
- [inVal](nodes.matches.md#inval)
- [isDistinctFrom](nodes.matches.md#isdistinctfrom)
- [isInfinity](nodes.matches.md#isinfinity)
- [isNotDistinctFrom](nodes.matches.md#isnotdistinctfrom)
- [isOpenEnded](nodes.matches.md#isopenended)
- [isUnboundable](nodes.matches.md#isunboundable)
- [lower](nodes.matches.md#lower)
- [lt](nodes.matches.md#lt)
- [ltAll](nodes.matches.md#ltall)
- [ltAny](nodes.matches.md#ltany)
- [lteq](nodes.matches.md#lteq)
- [lteqAll](nodes.matches.md#lteqall)
- [lteqAny](nodes.matches.md#lteqany)
- [matches](nodes.matches.md#matches)
- [matchesAll](nodes.matches.md#matchesall)
- [matchesAny](nodes.matches.md#matchesany)
- [matchesRegexp](nodes.matches.md#matchesregexp)
- [maximum](nodes.matches.md#maximum)
- [minimum](nodes.matches.md#minimum)
- [multiply](nodes.matches.md#multiply)
- [not](nodes.matches.md#not)
- [notBetween](nodes.matches.md#notbetween)
- [notEq](nodes.matches.md#noteq)
- [notEqAll](nodes.matches.md#noteqall)
- [notEqAny](nodes.matches.md#noteqany)
- [notInAll](nodes.matches.md#notinall)
- [notInAny](nodes.matches.md#notinany)
- [notInVal](nodes.matches.md#notinval)
- [or](nodes.matches.md#or)
- [quotedArray](nodes.matches.md#quotedarray)
- [quotedNode](nodes.matches.md#quotednode)
- [subtract](nodes.matches.md#subtract)
- [sum](nodes.matches.md#sum)
- [toSQL](nodes.matches.md#tosql)
- [when](nodes.matches.md#when)

## Constructors

### constructor

\+ **new Matches**(`left`: _any_, `right`: _any_, `escape?`: _any_,
`caseSensitive?`: _boolean_): [_Matches_](nodes.matches.md)
