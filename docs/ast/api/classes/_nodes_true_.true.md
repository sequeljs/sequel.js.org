---
id: '_nodes_true_.true'
title: 'True'
sidebar_label: 'True'
---

[@sequeljs/ast](../index.md) › [Globals](../globals.md) ›
["nodes/True"](../modules/_nodes_true_.md) › [True](_nodes_true_.true.md)
...
- [add](_nodes_true_.true.md#add)
- [as](_nodes_true_.true.md#as)
- [asc](_nodes_true_.true.md#asc)
- [average](_nodes_true_.true.md#average)
- [between](_nodes_true_.true.md#between)
- [bitwiseAnd](_nodes_true_.true.md#bitwiseand)
- [bitwiseNot](_nodes_true_.true.md#bitwisenot)
- [bitwiseOr](_nodes_true_.true.md#bitwiseor)
- [bitwiseShiftLeft](_nodes_true_.true.md#bitwiseshiftleft)
- [bitwiseShiftRight](_nodes_true_.true.md#bitwiseshiftright)
- [bitwiseXor](_nodes_true_.true.md#bitwisexor)
- [concat](_nodes_true_.true.md#concat)
- [count](_nodes_true_.true.md#count)
- [desc](_nodes_true_.true.md#desc)
- [divide](_nodes_true_.true.md#divide)
- [doesNotMatch](_nodes_true_.true.md#doesnotmatch)
- [doesNotMatchAll](_nodes_true_.true.md#doesnotmatchall)
- [doesNotMatchAny](_nodes_true_.true.md#doesnotmatchany)
- [doesNotMatchRegexp](_nodes_true_.true.md#doesnotmatchregexp)
- [eq](_nodes_true_.true.md#eq)
- [eqAll](_nodes_true_.true.md#eqall)
- [eqAny](_nodes_true_.true.md#eqany)
- [extract](_nodes_true_.true.md#extract)
- [groupingAll](_nodes_true_.true.md#protected-groupingall)
- [groupingAny](_nodes_true_.true.md#protected-groupingany)
- [gt](_nodes_true_.true.md#gt)
- [gtAll](_nodes_true_.true.md#gtall)
- [gtAny](_nodes_true_.true.md#gtany)
- [gteq](_nodes_true_.true.md#gteq)
- [gteqAll](_nodes_true_.true.md#gteqall)
- [gteqAny](_nodes_true_.true.md#gteqany)
- [inAll](_nodes_true_.true.md#inall)
- [inAny](_nodes_true_.true.md#inany)
- [inVal](_nodes_true_.true.md#inval)
- [isDistinctFrom](_nodes_true_.true.md#isdistinctfrom)
- [isInfinity](_nodes_true_.true.md#protected-isinfinity)
- [isNotDistinctFrom](_nodes_true_.true.md#isnotdistinctfrom)
- [isOpenEnded](_nodes_true_.true.md#protected-isopenended)
- [isUnboundable](_nodes_true_.true.md#protected-isunboundable)
- [lt](_nodes_true_.true.md#lt)
- [ltAll](_nodes_true_.true.md#ltall)
- [ltAny](_nodes_true_.true.md#ltany)
- [lteq](_nodes_true_.true.md#lteq)
- [lteqAll](_nodes_true_.true.md#lteqall)
- [lteqAny](_nodes_true_.true.md#lteqany)
- [matches](_nodes_true_.true.md#matches)
- [matchesAll](_nodes_true_.true.md#matchesall)
- [matchesAny](_nodes_true_.true.md#matchesany)
- [matchesRegexp](_nodes_true_.true.md#matchesregexp)
- [maximum](_nodes_true_.true.md#maximum)
- [minimum](_nodes_true_.true.md#minimum)
- [multiply](_nodes_true_.true.md#multiply)
- [notBetween](_nodes_true_.true.md#notbetween)
- [notEq](_nodes_true_.true.md#noteq)
- [notEqAll](_nodes_true_.true.md#noteqall)
- [notEqAny](_nodes_true_.true.md#noteqany)
- [notInAll](_nodes_true_.true.md#notinall)
- [notInAny](_nodes_true_.true.md#notinany)
- [notInVal](_nodes_true_.true.md#notinval)
- [quotedArray](_nodes_true_.true.md#quotedarray)
- [quotedNode](_nodes_true_.true.md#quotednode)
- [subtract](_nodes_true_.true.md#subtract)
- [sum](_nodes_true_.true.md#sum)
- [toSQL](_nodes_true_.true.md#tosql)
- [when](_nodes_true_.true.md#when)
