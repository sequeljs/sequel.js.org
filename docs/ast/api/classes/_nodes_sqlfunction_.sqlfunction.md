---
id: '_nodes_sqlfunction_.sqlfunction'
title: 'SQLFunction'
sidebar_label: 'SQLFunction'
---
...
- [WindowPredications](_mixins_windowpredication_.windowpredications.md)
  ...
  ↳ [Avg](_nodes_avg_.avg.md)

  ↳ [Count](_nodes_count_.count.md)

  ↳ [Exists](_nodes_exists_.exists.md)

  ↳ [Max](_nodes_max_.max.md)

  ↳ [Min](_nodes_min_.min.md)

  ↳ [NamedSQLFunction](_nodes_namedsqlfunction_.namedsqlfunction.md)

  ↳ [Sum](_nodes_sum_.sum.md)

## Index

### Constructors

- [constructor](_nodes_sqlfunction_.sqlfunction.md#constructor)

### Properties

- [alias](_nodes_sqlfunction_.sqlfunction.md#alias)
- [distinct](_nodes_sqlfunction_.sqlfunction.md#distinct)
- [expressions](_nodes_sqlfunction_.sqlfunction.md#expressions)

### Methods

- [add](_nodes_sqlfunction_.sqlfunction.md#add)
- [as](_nodes_sqlfunction_.sqlfunction.md#as)
- [asc](_nodes_sqlfunction_.sqlfunction.md#asc)
- [average](_nodes_sqlfunction_.sqlfunction.md#average)
- [between](_nodes_sqlfunction_.sqlfunction.md#between)
- [bitwiseAnd](_nodes_sqlfunction_.sqlfunction.md#bitwiseand)
- [bitwiseNot](_nodes_sqlfunction_.sqlfunction.md#bitwisenot)
- [bitwiseOr](_nodes_sqlfunction_.sqlfunction.md#bitwiseor)
- [bitwiseShiftLeft](_nodes_sqlfunction_.sqlfunction.md#bitwiseshiftleft)
- [bitwiseShiftRight](_nodes_sqlfunction_.sqlfunction.md#bitwiseshiftright)
- [bitwiseXor](_nodes_sqlfunction_.sqlfunction.md#bitwisexor)
- [concat](_nodes_sqlfunction_.sqlfunction.md#concat)
- [count](_nodes_sqlfunction_.sqlfunction.md#count)
- [desc](_nodes_sqlfunction_.sqlfunction.md#desc)
- [divide](_nodes_sqlfunction_.sqlfunction.md#divide)
- [doesNotMatch](_nodes_sqlfunction_.sqlfunction.md#doesnotmatch)
- [doesNotMatchAll](_nodes_sqlfunction_.sqlfunction.md#doesnotmatchall)
- [doesNotMatchAny](_nodes_sqlfunction_.sqlfunction.md#doesnotmatchany)
- [doesNotMatchRegexp](_nodes_sqlfunction_.sqlfunction.md#doesnotmatchregexp)
- [eq](_nodes_sqlfunction_.sqlfunction.md#eq)
- [eqAll](_nodes_sqlfunction_.sqlfunction.md#eqall)
- [eqAny](_nodes_sqlfunction_.sqlfunction.md#eqany)
- [extract](_nodes_sqlfunction_.sqlfunction.md#extract)
- [groupingAll](_nodes_sqlfunction_.sqlfunction.md#protected-groupingall)
- [groupingAny](_nodes_sqlfunction_.sqlfunction.md#protected-groupingany)
- [gt](_nodes_sqlfunction_.sqlfunction.md#gt)
- [gtAll](_nodes_sqlfunction_.sqlfunction.md#gtall)
- [gtAny](_nodes_sqlfunction_.sqlfunction.md#gtany)
- [gteq](_nodes_sqlfunction_.sqlfunction.md#gteq)
- [gteqAll](_nodes_sqlfunction_.sqlfunction.md#gteqall)
- [gteqAny](_nodes_sqlfunction_.sqlfunction.md#gteqany)
- [inAll](_nodes_sqlfunction_.sqlfunction.md#inall)
- [inAny](_nodes_sqlfunction_.sqlfunction.md#inany)
- [inVal](_nodes_sqlfunction_.sqlfunction.md#inval)
- [isDistinctFrom](_nodes_sqlfunction_.sqlfunction.md#isdistinctfrom)
- [isInfinity](_nodes_sqlfunction_.sqlfunction.md#protected-isinfinity)
- [isNotDistinctFrom](_nodes_sqlfunction_.sqlfunction.md#isnotdistinctfrom)
- [isOpenEnded](_nodes_sqlfunction_.sqlfunction.md#protected-isopenended)
- [isUnboundable](_nodes_sqlfunction_.sqlfunction.md#protected-isunboundable)
- [lt](_nodes_sqlfunction_.sqlfunction.md#lt)
- [ltAll](_nodes_sqlfunction_.sqlfunction.md#ltall)
- [ltAny](_nodes_sqlfunction_.sqlfunction.md#ltany)
- [lteq](_nodes_sqlfunction_.sqlfunction.md#lteq)
- [lteqAll](_nodes_sqlfunction_.sqlfunction.md#lteqall)
- [lteqAny](_nodes_sqlfunction_.sqlfunction.md#lteqany)
- [matches](_nodes_sqlfunction_.sqlfunction.md#matches)
- [matchesAll](_nodes_sqlfunction_.sqlfunction.md#matchesall)
- [matchesAny](_nodes_sqlfunction_.sqlfunction.md#matchesany)
- [matchesRegexp](_nodes_sqlfunction_.sqlfunction.md#matchesregexp)
- [maximum](_nodes_sqlfunction_.sqlfunction.md#maximum)
- [minimum](_nodes_sqlfunction_.sqlfunction.md#minimum)
- [multiply](_nodes_sqlfunction_.sqlfunction.md#multiply)
- [notBetween](_nodes_sqlfunction_.sqlfunction.md#notbetween)
- [notEq](_nodes_sqlfunction_.sqlfunction.md#noteq)
- [notEqAll](_nodes_sqlfunction_.sqlfunction.md#noteqall)
- [notEqAny](_nodes_sqlfunction_.sqlfunction.md#noteqany)
- [notInAll](_nodes_sqlfunction_.sqlfunction.md#notinall)
- [notInAny](_nodes_sqlfunction_.sqlfunction.md#notinany)
- [notInVal](_nodes_sqlfunction_.sqlfunction.md#notinval)
- [over](_nodes_sqlfunction_.sqlfunction.md#over)
- [quotedArray](_nodes_sqlfunction_.sqlfunction.md#quotedarray)
- [quotedNode](_nodes_sqlfunction_.sqlfunction.md#quotednode)
- [subtract](_nodes_sqlfunction_.sqlfunction.md#subtract)
- [sum](_nodes_sqlfunction_.sqlfunction.md#sum)
- [toSQL](_nodes_sqlfunction_.sqlfunction.md#tosql)
- [when](_nodes_sqlfunction_.sqlfunction.md#when)

## Constructors

### constructor

\+ **new SQLFunction**(`expr`: any, `aliaz`: string |
[SQLLiteral](_nodes_sqlliteral_.sqlliteral.md) | null):
_[SQLFunction](_nodes_sqlfunction_.sqlfunction.md)_
