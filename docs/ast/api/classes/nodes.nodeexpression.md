...
[Nodes](../modules/nodes.md) / NodeExpression
...
- _WhenPredication_
  ...
  ↳↳ [_Case_](nodes.case.md)

  ↳↳ [_Casted_](nodes.casted.md)

  ↳↳ [_Distinct_](nodes.distinct.md)

  ↳↳ [_False_](nodes.false.md)

  ↳↳ [_SQLFunction_](nodes.sqlfunction.md)

  ↳↳ [_SelectStatement_](nodes.selectstatement.md)

  ↳↳ [_True_](nodes.true.md)
...
- [constructor](nodes.nodeexpression.md#constructor)

### Methods

- [add](nodes.nodeexpression.md#add)
- [and](nodes.nodeexpression.md#and)
- [asc](nodes.nodeexpression.md#asc)
- [average](nodes.nodeexpression.md#average)
- [between](nodes.nodeexpression.md#between)
- [bitwiseAnd](nodes.nodeexpression.md#bitwiseand)
- [bitwiseNot](nodes.nodeexpression.md#bitwisenot)
- [bitwiseOr](nodes.nodeexpression.md#bitwiseor)
- [bitwiseShiftLeft](nodes.nodeexpression.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.nodeexpression.md#bitwiseshiftright)
- [bitwiseXor](nodes.nodeexpression.md#bitwisexor)
- [coalesce](nodes.nodeexpression.md#coalesce)
- [concat](nodes.nodeexpression.md#concat)
- [count](nodes.nodeexpression.md#count)
- [createAnd](nodes.nodeexpression.md#createand)
- [createFalse](nodes.nodeexpression.md#createfalse)
- [createJoin](nodes.nodeexpression.md#createjoin)
- [createOn](nodes.nodeexpression.md#createon)
- [createStringJoin](nodes.nodeexpression.md#createstringjoin)
- [createTableAlias](nodes.nodeexpression.md#createtablealias)
- [createTrue](nodes.nodeexpression.md#createtrue)
- [desc](nodes.nodeexpression.md#desc)
- [divide](nodes.nodeexpression.md#divide)
- [doesNotMatch](nodes.nodeexpression.md#doesnotmatch)
- [doesNotMatchAll](nodes.nodeexpression.md#doesnotmatchall)
- [doesNotMatchAny](nodes.nodeexpression.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.nodeexpression.md#doesnotmatchregexp)
- [eq](nodes.nodeexpression.md#eq)
- [eqAll](nodes.nodeexpression.md#eqall)
- [eqAny](nodes.nodeexpression.md#eqany)
- [extract](nodes.nodeexpression.md#extract)
- [grouping](nodes.nodeexpression.md#grouping)
- [groupingAll](nodes.nodeexpression.md#groupingall)
- [groupingAny](nodes.nodeexpression.md#groupingany)
- [gt](nodes.nodeexpression.md#gt)
- [gtAll](nodes.nodeexpression.md#gtall)
- [gtAny](nodes.nodeexpression.md#gtany)
- [gteq](nodes.nodeexpression.md#gteq)
- [gteqAll](nodes.nodeexpression.md#gteqall)
- [gteqAny](nodes.nodeexpression.md#gteqany)
- [inAll](nodes.nodeexpression.md#inall)
- [inAny](nodes.nodeexpression.md#inany)
- [inVal](nodes.nodeexpression.md#inval)
- [isDistinctFrom](nodes.nodeexpression.md#isdistinctfrom)
- [isInfinity](nodes.nodeexpression.md#isinfinity)
- [isNotDistinctFrom](nodes.nodeexpression.md#isnotdistinctfrom)
- [isOpenEnded](nodes.nodeexpression.md#isopenended)
- [isUnboundable](nodes.nodeexpression.md#isunboundable)
- [lower](nodes.nodeexpression.md#lower)
- [lt](nodes.nodeexpression.md#lt)
- [ltAll](nodes.nodeexpression.md#ltall)
- [ltAny](nodes.nodeexpression.md#ltany)
- [lteq](nodes.nodeexpression.md#lteq)
- [lteqAll](nodes.nodeexpression.md#lteqall)
- [lteqAny](nodes.nodeexpression.md#lteqany)
- [matches](nodes.nodeexpression.md#matches)
- [matchesAll](nodes.nodeexpression.md#matchesall)
- [matchesAny](nodes.nodeexpression.md#matchesany)
- [matchesRegexp](nodes.nodeexpression.md#matchesregexp)
- [maximum](nodes.nodeexpression.md#maximum)
- [minimum](nodes.nodeexpression.md#minimum)
- [multiply](nodes.nodeexpression.md#multiply)
- [not](nodes.nodeexpression.md#not)
- [notBetween](nodes.nodeexpression.md#notbetween)
- [notEq](nodes.nodeexpression.md#noteq)
- [notEqAll](nodes.nodeexpression.md#noteqall)
- [notEqAny](nodes.nodeexpression.md#noteqany)
- [notInAll](nodes.nodeexpression.md#notinall)
- [notInAny](nodes.nodeexpression.md#notinany)
- [notInVal](nodes.nodeexpression.md#notinval)
- [or](nodes.nodeexpression.md#or)
- [quotedArray](nodes.nodeexpression.md#quotedarray)
- [quotedNode](nodes.nodeexpression.md#quotednode)
- [subtract](nodes.nodeexpression.md#subtract)
- [sum](nodes.nodeexpression.md#sum)
- [toSQL](nodes.nodeexpression.md#tosql)
- [when](nodes.nodeexpression.md#when)

## Constructors

### constructor

\+ **new NodeExpression**(): [_NodeExpression_](nodes.nodeexpression.md)

**Returns:** [_NodeExpression_](nodes.nodeexpression.md)
