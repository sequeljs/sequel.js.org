---
id: '_attributes_attribute_.attribute'
title: 'Attribute'
...
- [WhenPredication](_mixins_whenpredication_.whenpredication.md)
  ...
  ↳ [Boolean](_attributes_boolean_.boolean.md)

  ↳ [Decimal](_attributes_decimal_.decimal.md)

  ↳ [Float](_attributes_float_.float.md)

  ↳ [Integer](_attributes_integer_.integer.md)

  ↳ [String](_attributes_string_.string.md)

  ↳ [Time](_attributes_time_.time.md)

  ↳ [Undefined](_attributes_undefined_.undefined.md)

## Index

### Constructors

- [constructor](_attributes_attribute_.attribute.md#constructor)

### Properties

- [name](_attributes_attribute_.attribute.md#name)
- [relation](_attributes_attribute_.attribute.md#relation)

### Methods

- [add](_attributes_attribute_.attribute.md#add)
- [as](_attributes_attribute_.attribute.md#as)
- [asc](_attributes_attribute_.attribute.md#asc)
- [average](_attributes_attribute_.attribute.md#average)
- [between](_attributes_attribute_.attribute.md#between)
- [bitwiseAnd](_attributes_attribute_.attribute.md#bitwiseand)
- [bitwiseNot](_attributes_attribute_.attribute.md#bitwisenot)
- [bitwiseOr](_attributes_attribute_.attribute.md#bitwiseor)
- [bitwiseShiftLeft](_attributes_attribute_.attribute.md#bitwiseshiftleft)
- [bitwiseShiftRight](_attributes_attribute_.attribute.md#bitwiseshiftright)
- [bitwiseXor](_attributes_attribute_.attribute.md#bitwisexor)
- [concat](_attributes_attribute_.attribute.md#concat)
- [count](_attributes_attribute_.attribute.md#count)
- [desc](_attributes_attribute_.attribute.md#desc)
- [divide](_attributes_attribute_.attribute.md#divide)
- [doesNotMatch](_attributes_attribute_.attribute.md#doesnotmatch)
- [doesNotMatchAll](_attributes_attribute_.attribute.md#doesnotmatchall)
- [doesNotMatchAny](_attributes_attribute_.attribute.md#doesnotmatchany)
- [doesNotMatchRegexp](_attributes_attribute_.attribute.md#doesnotmatchregexp)
- [eq](_attributes_attribute_.attribute.md#eq)
- [eqAll](_attributes_attribute_.attribute.md#eqall)
- [eqAny](_attributes_attribute_.attribute.md#eqany)
- [extract](_attributes_attribute_.attribute.md#extract)
- [groupingAll](_attributes_attribute_.attribute.md#protected-groupingall)
- [groupingAny](_attributes_attribute_.attribute.md#protected-groupingany)
- [gt](_attributes_attribute_.attribute.md#gt)
- [gtAll](_attributes_attribute_.attribute.md#gtall)
- [gtAny](_attributes_attribute_.attribute.md#gtany)
- [gteq](_attributes_attribute_.attribute.md#gteq)
- [gteqAll](_attributes_attribute_.attribute.md#gteqall)
- [gteqAny](_attributes_attribute_.attribute.md#gteqany)
- [inAll](_attributes_attribute_.attribute.md#inall)
- [inAny](_attributes_attribute_.attribute.md#inany)
- [inVal](_attributes_attribute_.attribute.md#inval)
- [isAbleToTypeCast](_attributes_attribute_.attribute.md#isabletotypecast)
- [isDistinctFrom](_attributes_attribute_.attribute.md#isdistinctfrom)
- [isInfinity](_attributes_attribute_.attribute.md#protected-isinfinity)
- [isNotDistinctFrom](_attributes_attribute_.attribute.md#isnotdistinctfrom)
- [isOpenEnded](_attributes_attribute_.attribute.md#protected-isopenended)
- [isUnboundable](_attributes_attribute_.attribute.md#protected-isunboundable)
- [lower](_attributes_attribute_.attribute.md#lower)
- [lt](_attributes_attribute_.attribute.md#lt)
- [ltAll](_attributes_attribute_.attribute.md#ltall)
- [ltAny](_attributes_attribute_.attribute.md#ltany)
- [lteq](_attributes_attribute_.attribute.md#lteq)
- [lteqAll](_attributes_attribute_.attribute.md#lteqall)
- [lteqAny](_attributes_attribute_.attribute.md#lteqany)
- [matches](_attributes_attribute_.attribute.md#matches)
- [matchesAll](_attributes_attribute_.attribute.md#matchesall)
- [matchesAny](_attributes_attribute_.attribute.md#matchesany)
- [matchesRegexp](_attributes_attribute_.attribute.md#matchesregexp)
- [maximum](_attributes_attribute_.attribute.md#maximum)
- [minimum](_attributes_attribute_.attribute.md#minimum)
- [multiply](_attributes_attribute_.attribute.md#multiply)
- [notBetween](_attributes_attribute_.attribute.md#notbetween)
- [notEq](_attributes_attribute_.attribute.md#noteq)
- [notEqAll](_attributes_attribute_.attribute.md#noteqall)
- [notEqAny](_attributes_attribute_.attribute.md#noteqany)
- [notInAll](_attributes_attribute_.attribute.md#notinall)
- [notInAny](_attributes_attribute_.attribute.md#notinany)
- [notInVal](_attributes_attribute_.attribute.md#notinval)
- [quotedArray](_attributes_attribute_.attribute.md#quotedarray)
- [quotedNode](_attributes_attribute_.attribute.md#quotednode)
- [subtract](_attributes_attribute_.attribute.md#subtract)
- [sum](_attributes_attribute_.attribute.md#sum)
- [typeCastForDatabase](_attributes_attribute_.attribute.md#typecastfordatabase)
- [when](_attributes_attribute_.attribute.md#when)
