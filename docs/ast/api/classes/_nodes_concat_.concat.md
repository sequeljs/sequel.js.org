...
- [constructor](_nodes_concat_.concat.md#constructor)

### Properties

- [left](_nodes_concat_.concat.md#left)
- [operator](_nodes_concat_.concat.md#readonly-operator)
- [right](_nodes_concat_.concat.md#right)

### Methods

- [add](_nodes_concat_.concat.md#add)
- [as](_nodes_concat_.concat.md#as)
- [asc](_nodes_concat_.concat.md#asc)
- [average](_nodes_concat_.concat.md#average)
- [between](_nodes_concat_.concat.md#between)
- [bitwiseAnd](_nodes_concat_.concat.md#bitwiseand)
- [bitwiseNot](_nodes_concat_.concat.md#bitwisenot)
- [bitwiseOr](_nodes_concat_.concat.md#bitwiseor)
- [bitwiseShiftLeft](_nodes_concat_.concat.md#bitwiseshiftleft)
- [bitwiseShiftRight](_nodes_concat_.concat.md#bitwiseshiftright)
- [bitwiseXor](_nodes_concat_.concat.md#bitwisexor)
- [concat](_nodes_concat_.concat.md#concat)
- [count](_nodes_concat_.concat.md#count)
- [desc](_nodes_concat_.concat.md#desc)
- [divide](_nodes_concat_.concat.md#divide)
- [doesNotMatch](_nodes_concat_.concat.md#doesnotmatch)
- [doesNotMatchAll](_nodes_concat_.concat.md#doesnotmatchall)
- [doesNotMatchAny](_nodes_concat_.concat.md#doesnotmatchany)
- [doesNotMatchRegexp](_nodes_concat_.concat.md#doesnotmatchregexp)
- [eq](_nodes_concat_.concat.md#eq)
- [eqAll](_nodes_concat_.concat.md#eqall)
- [eqAny](_nodes_concat_.concat.md#eqany)
- [extract](_nodes_concat_.concat.md#extract)
- [groupingAll](_nodes_concat_.concat.md#protected-groupingall)
- [groupingAny](_nodes_concat_.concat.md#protected-groupingany)
- [gt](_nodes_concat_.concat.md#gt)
- [gtAll](_nodes_concat_.concat.md#gtall)
- [gtAny](_nodes_concat_.concat.md#gtany)
- [gteq](_nodes_concat_.concat.md#gteq)
- [gteqAll](_nodes_concat_.concat.md#gteqall)
- [gteqAny](_nodes_concat_.concat.md#gteqany)
- [inAll](_nodes_concat_.concat.md#inall)
- [inAny](_nodes_concat_.concat.md#inany)
- [inVal](_nodes_concat_.concat.md#inval)
- [isDistinctFrom](_nodes_concat_.concat.md#isdistinctfrom)
- [isInfinity](_nodes_concat_.concat.md#protected-isinfinity)
- [isNotDistinctFrom](_nodes_concat_.concat.md#isnotdistinctfrom)
- [isOpenEnded](_nodes_concat_.concat.md#protected-isopenended)
- [isUnboundable](_nodes_concat_.concat.md#protected-isunboundable)
- [lt](_nodes_concat_.concat.md#lt)
- [ltAll](_nodes_concat_.concat.md#ltall)
- [ltAny](_nodes_concat_.concat.md#ltany)
- [lteq](_nodes_concat_.concat.md#lteq)
- [lteqAll](_nodes_concat_.concat.md#lteqall)
- [lteqAny](_nodes_concat_.concat.md#lteqany)
- [matches](_nodes_concat_.concat.md#matches)
- [matchesAll](_nodes_concat_.concat.md#matchesall)
- [matchesAny](_nodes_concat_.concat.md#matchesany)
- [matchesRegexp](_nodes_concat_.concat.md#matchesregexp)
- [maximum](_nodes_concat_.concat.md#maximum)
- [minimum](_nodes_concat_.concat.md#minimum)
- [multiply](_nodes_concat_.concat.md#multiply)
- [notBetween](_nodes_concat_.concat.md#notbetween)
- [notEq](_nodes_concat_.concat.md#noteq)
- [notEqAll](_nodes_concat_.concat.md#noteqall)
- [notEqAny](_nodes_concat_.concat.md#noteqany)
- [notInAll](_nodes_concat_.concat.md#notinall)
- [notInAny](_nodes_concat_.concat.md#notinany)
- [notInVal](_nodes_concat_.concat.md#notinval)
- [quotedArray](_nodes_concat_.concat.md#quotedarray)
- [quotedNode](_nodes_concat_.concat.md#quotednode)
- [subtract](_nodes_concat_.concat.md#subtract)
- [sum](_nodes_concat_.concat.md#sum)
- [toSQL](_nodes_concat_.concat.md#tosql)
- [when](_nodes_concat_.concat.md#when)

## Constructors

### constructor

\+ **new Concat**(`left`: any, `right`: any):
_[Concat](_nodes_concat_.concat.md)_
...
_Defined in
[src/nodes/Concat.ts:3](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/Concat.ts#L3)_
