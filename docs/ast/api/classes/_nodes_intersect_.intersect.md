---
id: '_nodes_intersect_.intersect'
title: 'Intersect'
...
- [constructor](_nodes_intersect_.intersect.md#constructor)

### Properties

- [left](_nodes_intersect_.intersect.md#left)
- [right](_nodes_intersect_.intersect.md#right)

### Methods

- [as](_nodes_intersect_.intersect.md#as)
- [toSQL](_nodes_intersect_.intersect.md#tosql)

## Constructors

### constructor

\+ **new Intersect**(`left`: L, `right`: R):
