...
[Nodes](../modules/nodes.md) / LessThanOrEqual
...
- [constructor](nodes.lessthanorequal.md#constructor)

### Properties

- [left](nodes.lessthanorequal.md#left)
- [right](nodes.lessthanorequal.md#right)

### Methods

- [add](nodes.lessthanorequal.md#add)
- [and](nodes.lessthanorequal.md#and)
- [as](nodes.lessthanorequal.md#as)
- [asc](nodes.lessthanorequal.md#asc)
- [average](nodes.lessthanorequal.md#average)
- [between](nodes.lessthanorequal.md#between)
- [bitwiseAnd](nodes.lessthanorequal.md#bitwiseand)
- [bitwiseNot](nodes.lessthanorequal.md#bitwisenot)
- [bitwiseOr](nodes.lessthanorequal.md#bitwiseor)
- [bitwiseShiftLeft](nodes.lessthanorequal.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.lessthanorequal.md#bitwiseshiftright)
- [bitwiseXor](nodes.lessthanorequal.md#bitwisexor)
- [coalesce](nodes.lessthanorequal.md#coalesce)
- [concat](nodes.lessthanorequal.md#concat)
- [count](nodes.lessthanorequal.md#count)
- [createAnd](nodes.lessthanorequal.md#createand)
- [createFalse](nodes.lessthanorequal.md#createfalse)
- [createJoin](nodes.lessthanorequal.md#createjoin)
- [createOn](nodes.lessthanorequal.md#createon)
- [createStringJoin](nodes.lessthanorequal.md#createstringjoin)
- [createTableAlias](nodes.lessthanorequal.md#createtablealias)
- [createTrue](nodes.lessthanorequal.md#createtrue)
- [desc](nodes.lessthanorequal.md#desc)
- [divide](nodes.lessthanorequal.md#divide)
- [doesNotMatch](nodes.lessthanorequal.md#doesnotmatch)
- [doesNotMatchAll](nodes.lessthanorequal.md#doesnotmatchall)
- [doesNotMatchAny](nodes.lessthanorequal.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.lessthanorequal.md#doesnotmatchregexp)
- [eq](nodes.lessthanorequal.md#eq)
- [eqAll](nodes.lessthanorequal.md#eqall)
- [eqAny](nodes.lessthanorequal.md#eqany)
- [extract](nodes.lessthanorequal.md#extract)
- [grouping](nodes.lessthanorequal.md#grouping)
- [groupingAll](nodes.lessthanorequal.md#groupingall)
- [groupingAny](nodes.lessthanorequal.md#groupingany)
- [gt](nodes.lessthanorequal.md#gt)
- [gtAll](nodes.lessthanorequal.md#gtall)
- [gtAny](nodes.lessthanorequal.md#gtany)
- [gteq](nodes.lessthanorequal.md#gteq)
- [gteqAll](nodes.lessthanorequal.md#gteqall)
- [gteqAny](nodes.lessthanorequal.md#gteqany)
- [inAll](nodes.lessthanorequal.md#inall)
- [inAny](nodes.lessthanorequal.md#inany)
- [inVal](nodes.lessthanorequal.md#inval)
- [isDistinctFrom](nodes.lessthanorequal.md#isdistinctfrom)
- [isInfinity](nodes.lessthanorequal.md#isinfinity)
- [isNotDistinctFrom](nodes.lessthanorequal.md#isnotdistinctfrom)
- [isOpenEnded](nodes.lessthanorequal.md#isopenended)
- [isUnboundable](nodes.lessthanorequal.md#isunboundable)
- [lower](nodes.lessthanorequal.md#lower)
- [lt](nodes.lessthanorequal.md#lt)
- [ltAll](nodes.lessthanorequal.md#ltall)
- [ltAny](nodes.lessthanorequal.md#ltany)
- [lteq](nodes.lessthanorequal.md#lteq)
- [lteqAll](nodes.lessthanorequal.md#lteqall)
- [lteqAny](nodes.lessthanorequal.md#lteqany)
- [matches](nodes.lessthanorequal.md#matches)
- [matchesAll](nodes.lessthanorequal.md#matchesall)
- [matchesAny](nodes.lessthanorequal.md#matchesany)
- [matchesRegexp](nodes.lessthanorequal.md#matchesregexp)
- [maximum](nodes.lessthanorequal.md#maximum)
- [minimum](nodes.lessthanorequal.md#minimum)
- [multiply](nodes.lessthanorequal.md#multiply)
- [not](nodes.lessthanorequal.md#not)
- [notBetween](nodes.lessthanorequal.md#notbetween)
- [notEq](nodes.lessthanorequal.md#noteq)
- [notEqAll](nodes.lessthanorequal.md#noteqall)
- [notEqAny](nodes.lessthanorequal.md#noteqany)
- [notInAll](nodes.lessthanorequal.md#notinall)
- [notInAny](nodes.lessthanorequal.md#notinany)
- [notInVal](nodes.lessthanorequal.md#notinval)
- [or](nodes.lessthanorequal.md#or)
- [quotedArray](nodes.lessthanorequal.md#quotedarray)
- [quotedNode](nodes.lessthanorequal.md#quotednode)
- [subtract](nodes.lessthanorequal.md#subtract)
- [sum](nodes.lessthanorequal.md#sum)
- [toSQL](nodes.lessthanorequal.md#tosql)
- [when](nodes.lessthanorequal.md#when)

## Constructors

### constructor

\+ **new LessThanOrEqual**(`left`: _any_, `right`: _any_):
