...
[Nodes](../modules/nodes.md) / UnaryOperation
...
- [_Unary_](nodes.unary.md)
  ...
  ↳↳ [_BitwiseNot_](nodes.bitwisenot.md)

## Index

### Constructors

- [constructor](nodes.unaryoperation.md#constructor)

### Properties

- [expr](nodes.unaryoperation.md#expr)
- [operator](nodes.unaryoperation.md#operator)

### Accessors

- [value](nodes.unaryoperation.md#value)

### Methods

- [add](nodes.unaryoperation.md#add)
- [and](nodes.unaryoperation.md#and)
- [as](nodes.unaryoperation.md#as)
- [asc](nodes.unaryoperation.md#asc)
- [average](nodes.unaryoperation.md#average)
- [between](nodes.unaryoperation.md#between)
- [bitwiseAnd](nodes.unaryoperation.md#bitwiseand)
- [bitwiseNot](nodes.unaryoperation.md#bitwisenot)
- [bitwiseOr](nodes.unaryoperation.md#bitwiseor)
- [bitwiseShiftLeft](nodes.unaryoperation.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.unaryoperation.md#bitwiseshiftright)
- [bitwiseXor](nodes.unaryoperation.md#bitwisexor)
- [coalesce](nodes.unaryoperation.md#coalesce)
- [concat](nodes.unaryoperation.md#concat)
- [count](nodes.unaryoperation.md#count)
- [createAnd](nodes.unaryoperation.md#createand)
- [createFalse](nodes.unaryoperation.md#createfalse)
- [createJoin](nodes.unaryoperation.md#createjoin)
- [createOn](nodes.unaryoperation.md#createon)
- [createStringJoin](nodes.unaryoperation.md#createstringjoin)
- [createTableAlias](nodes.unaryoperation.md#createtablealias)
- [createTrue](nodes.unaryoperation.md#createtrue)
- [desc](nodes.unaryoperation.md#desc)
- [divide](nodes.unaryoperation.md#divide)
- [doesNotMatch](nodes.unaryoperation.md#doesnotmatch)
- [doesNotMatchAll](nodes.unaryoperation.md#doesnotmatchall)
- [doesNotMatchAny](nodes.unaryoperation.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.unaryoperation.md#doesnotmatchregexp)
- [eq](nodes.unaryoperation.md#eq)
- [eqAll](nodes.unaryoperation.md#eqall)
- [eqAny](nodes.unaryoperation.md#eqany)
- [extract](nodes.unaryoperation.md#extract)
- [grouping](nodes.unaryoperation.md#grouping)
- [groupingAll](nodes.unaryoperation.md#groupingall)
- [groupingAny](nodes.unaryoperation.md#groupingany)
- [gt](nodes.unaryoperation.md#gt)
- [gtAll](nodes.unaryoperation.md#gtall)
- [gtAny](nodes.unaryoperation.md#gtany)
- [gteq](nodes.unaryoperation.md#gteq)
- [gteqAll](nodes.unaryoperation.md#gteqall)
- [gteqAny](nodes.unaryoperation.md#gteqany)
- [inAll](nodes.unaryoperation.md#inall)
- [inAny](nodes.unaryoperation.md#inany)
- [inVal](nodes.unaryoperation.md#inval)
- [isDistinctFrom](nodes.unaryoperation.md#isdistinctfrom)
- [isInfinity](nodes.unaryoperation.md#isinfinity)
- [isNotDistinctFrom](nodes.unaryoperation.md#isnotdistinctfrom)
- [isOpenEnded](nodes.unaryoperation.md#isopenended)
- [isUnboundable](nodes.unaryoperation.md#isunboundable)
- [lower](nodes.unaryoperation.md#lower)
- [lt](nodes.unaryoperation.md#lt)
- [ltAll](nodes.unaryoperation.md#ltall)
- [ltAny](nodes.unaryoperation.md#ltany)
- [lteq](nodes.unaryoperation.md#lteq)
- [lteqAll](nodes.unaryoperation.md#lteqall)
- [lteqAny](nodes.unaryoperation.md#lteqany)
- [matches](nodes.unaryoperation.md#matches)
- [matchesAll](nodes.unaryoperation.md#matchesall)
- [matchesAny](nodes.unaryoperation.md#matchesany)
- [matchesRegexp](nodes.unaryoperation.md#matchesregexp)
- [maximum](nodes.unaryoperation.md#maximum)
- [minimum](nodes.unaryoperation.md#minimum)
- [multiply](nodes.unaryoperation.md#multiply)
- [not](nodes.unaryoperation.md#not)
- [notBetween](nodes.unaryoperation.md#notbetween)
- [notEq](nodes.unaryoperation.md#noteq)
- [notEqAll](nodes.unaryoperation.md#noteqall)
- [notEqAny](nodes.unaryoperation.md#noteqany)
- [notInAll](nodes.unaryoperation.md#notinall)
- [notInAny](nodes.unaryoperation.md#notinany)
- [notInVal](nodes.unaryoperation.md#notinval)
- [or](nodes.unaryoperation.md#or)
- [quotedArray](nodes.unaryoperation.md#quotedarray)
- [quotedNode](nodes.unaryoperation.md#quotednode)
- [subtract](nodes.unaryoperation.md#subtract)
- [sum](nodes.unaryoperation.md#sum)
- [toSQL](nodes.unaryoperation.md#tosql)
- [when](nodes.unaryoperation.md#when)

## Constructors

### constructor

\+ **new UnaryOperation**(`operator`: _string_, `operand`: _string_ \| _number_
...
| ---------- | -------------------------------------------------------------- |
| `operator` | _string_                                                       |
| `operand`  | _string_ \| _number_ \| [_Attribute_](attributes.attribute.md) |

**Returns:** [_UnaryOperation_](nodes.unaryoperation.md)

Inherited from: [Unary](nodes.unary.md)

Defined in:
[src/nodes/UnaryOperation.ts:6](https://github.com/sequeljs/ast/blob/6632050/src/nodes/UnaryOperation.ts#L6)
