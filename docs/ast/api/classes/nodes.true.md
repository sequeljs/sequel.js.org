...
- [constructor](nodes.true.md#constructor)

### Methods

- [add](nodes.true.md#add)
- [and](nodes.true.md#and)
- [as](nodes.true.md#as)
- [asc](nodes.true.md#asc)
- [average](nodes.true.md#average)
- [between](nodes.true.md#between)
- [bitwiseAnd](nodes.true.md#bitwiseand)
- [bitwiseNot](nodes.true.md#bitwisenot)
- [bitwiseOr](nodes.true.md#bitwiseor)
- [bitwiseShiftLeft](nodes.true.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.true.md#bitwiseshiftright)
- [bitwiseXor](nodes.true.md#bitwisexor)
- [coalesce](nodes.true.md#coalesce)
- [concat](nodes.true.md#concat)
- [count](nodes.true.md#count)
- [createAnd](nodes.true.md#createand)
- [createFalse](nodes.true.md#createfalse)
- [createJoin](nodes.true.md#createjoin)
- [createOn](nodes.true.md#createon)
- [createStringJoin](nodes.true.md#createstringjoin)
- [createTableAlias](nodes.true.md#createtablealias)
- [createTrue](nodes.true.md#createtrue)
- [desc](nodes.true.md#desc)
- [divide](nodes.true.md#divide)
- [doesNotMatch](nodes.true.md#doesnotmatch)
- [doesNotMatchAll](nodes.true.md#doesnotmatchall)
- [doesNotMatchAny](nodes.true.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.true.md#doesnotmatchregexp)
- [eq](nodes.true.md#eq)
- [eqAll](nodes.true.md#eqall)
- [eqAny](nodes.true.md#eqany)
- [extract](nodes.true.md#extract)
- [grouping](nodes.true.md#grouping)
- [groupingAll](nodes.true.md#groupingall)
- [groupingAny](nodes.true.md#groupingany)
- [gt](nodes.true.md#gt)
- [gtAll](nodes.true.md#gtall)
- [gtAny](nodes.true.md#gtany)
- [gteq](nodes.true.md#gteq)
- [gteqAll](nodes.true.md#gteqall)
- [gteqAny](nodes.true.md#gteqany)
- [inAll](nodes.true.md#inall)
- [inAny](nodes.true.md#inany)
- [inVal](nodes.true.md#inval)
- [isDistinctFrom](nodes.true.md#isdistinctfrom)
- [isInfinity](nodes.true.md#isinfinity)
- [isNotDistinctFrom](nodes.true.md#isnotdistinctfrom)
- [isOpenEnded](nodes.true.md#isopenended)
- [isUnboundable](nodes.true.md#isunboundable)
- [lower](nodes.true.md#lower)
- [lt](nodes.true.md#lt)
- [ltAll](nodes.true.md#ltall)
- [ltAny](nodes.true.md#ltany)
- [lteq](nodes.true.md#lteq)
- [lteqAll](nodes.true.md#lteqall)
- [lteqAny](nodes.true.md#lteqany)
- [matches](nodes.true.md#matches)
- [matchesAll](nodes.true.md#matchesall)
- [matchesAny](nodes.true.md#matchesany)
- [matchesRegexp](nodes.true.md#matchesregexp)
- [maximum](nodes.true.md#maximum)
- [minimum](nodes.true.md#minimum)
- [multiply](nodes.true.md#multiply)
- [not](nodes.true.md#not)
- [notBetween](nodes.true.md#notbetween)
- [notEq](nodes.true.md#noteq)
- [notEqAll](nodes.true.md#noteqall)
- [notEqAny](nodes.true.md#noteqany)
- [notInAll](nodes.true.md#notinall)
- [notInAny](nodes.true.md#notinany)
- [notInVal](nodes.true.md#notinval)
- [or](nodes.true.md#or)
- [quotedArray](nodes.true.md#quotedarray)
- [quotedNode](nodes.true.md#quotednode)
- [subtract](nodes.true.md#subtract)
- [sum](nodes.true.md#sum)
- [toSQL](nodes.true.md#tosql)
- [when](nodes.true.md#when)

## Constructors

### constructor

\+ **new True**(): [_True_](nodes.true.md)
