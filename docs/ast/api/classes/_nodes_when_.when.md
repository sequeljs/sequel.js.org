---
id: '_nodes_when_.when'
title: 'When'
sidebar_label: 'When'
---

[@sequeljs/ast](../index.md) › [Globals](../globals.md) ›
["nodes/When"](../modules/_nodes_when_.md) › [When](_nodes_when_.when.md)
...
- [constructor](_nodes_when_.when.md#constructor)

### Properties

- [left](_nodes_when_.when.md#left)
- [right](_nodes_when_.when.md#right)

### Methods

- [as](_nodes_when_.when.md#as)
- [toSQL](_nodes_when_.when.md#tosql)

## Constructors

### constructor

\+ **new When**(`left`: L, `right`: R): _[When](_nodes_when_.when.md)_
...
**Returns:** _[When](_nodes_when_.when.md)_
