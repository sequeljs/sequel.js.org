...
- [constructor](nodes.over.md#constructor)

### Properties

- [left](nodes.over.md#left)
- [operator](nodes.over.md#operator)
- [right](nodes.over.md#right)

### Methods

- [add](nodes.over.md#add)
- [and](nodes.over.md#and)
- [as](nodes.over.md#as)
- [asc](nodes.over.md#asc)
- [average](nodes.over.md#average)
- [between](nodes.over.md#between)
- [bitwiseAnd](nodes.over.md#bitwiseand)
- [bitwiseNot](nodes.over.md#bitwisenot)
- [bitwiseOr](nodes.over.md#bitwiseor)
- [bitwiseShiftLeft](nodes.over.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.over.md#bitwiseshiftright)
- [bitwiseXor](nodes.over.md#bitwisexor)
- [coalesce](nodes.over.md#coalesce)
- [concat](nodes.over.md#concat)
- [count](nodes.over.md#count)
- [createAnd](nodes.over.md#createand)
- [createFalse](nodes.over.md#createfalse)
- [createJoin](nodes.over.md#createjoin)
- [createOn](nodes.over.md#createon)
- [createStringJoin](nodes.over.md#createstringjoin)
- [createTableAlias](nodes.over.md#createtablealias)
- [createTrue](nodes.over.md#createtrue)
- [desc](nodes.over.md#desc)
- [divide](nodes.over.md#divide)
- [doesNotMatch](nodes.over.md#doesnotmatch)
- [doesNotMatchAll](nodes.over.md#doesnotmatchall)
- [doesNotMatchAny](nodes.over.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.over.md#doesnotmatchregexp)
- [eq](nodes.over.md#eq)
- [eqAll](nodes.over.md#eqall)
- [eqAny](nodes.over.md#eqany)
- [extract](nodes.over.md#extract)
- [grouping](nodes.over.md#grouping)
- [groupingAll](nodes.over.md#groupingall)
- [groupingAny](nodes.over.md#groupingany)
- [gt](nodes.over.md#gt)
- [gtAll](nodes.over.md#gtall)
- [gtAny](nodes.over.md#gtany)
- [gteq](nodes.over.md#gteq)
- [gteqAll](nodes.over.md#gteqall)
- [gteqAny](nodes.over.md#gteqany)
- [inAll](nodes.over.md#inall)
- [inAny](nodes.over.md#inany)
- [inVal](nodes.over.md#inval)
- [isDistinctFrom](nodes.over.md#isdistinctfrom)
- [isInfinity](nodes.over.md#isinfinity)
- [isNotDistinctFrom](nodes.over.md#isnotdistinctfrom)
- [isOpenEnded](nodes.over.md#isopenended)
- [isUnboundable](nodes.over.md#isunboundable)
- [lower](nodes.over.md#lower)
- [lt](nodes.over.md#lt)
- [ltAll](nodes.over.md#ltall)
- [ltAny](nodes.over.md#ltany)
- [lteq](nodes.over.md#lteq)
- [lteqAll](nodes.over.md#lteqall)
- [lteqAny](nodes.over.md#lteqany)
- [matches](nodes.over.md#matches)
- [matchesAll](nodes.over.md#matchesall)
- [matchesAny](nodes.over.md#matchesany)
- [matchesRegexp](nodes.over.md#matchesregexp)
- [maximum](nodes.over.md#maximum)
- [minimum](nodes.over.md#minimum)
- [multiply](nodes.over.md#multiply)
- [not](nodes.over.md#not)
- [notBetween](nodes.over.md#notbetween)
- [notEq](nodes.over.md#noteq)
- [notEqAll](nodes.over.md#noteqall)
- [notEqAny](nodes.over.md#noteqany)
- [notInAll](nodes.over.md#notinall)
- [notInAny](nodes.over.md#notinany)
- [notInVal](nodes.over.md#notinval)
- [or](nodes.over.md#or)
- [quotedArray](nodes.over.md#quotedarray)
- [quotedNode](nodes.over.md#quotednode)
- [subtract](nodes.over.md#subtract)
- [sum](nodes.over.md#sum)
- [toSQL](nodes.over.md#tosql)
- [when](nodes.over.md#when)

## Constructors

### constructor

\+ **new Over**(`left`: _any_, `right?`: _any_): [_Over_](nodes.over.md)
...
Defined in:
[src/nodes/Over.ts:6](https://github.com/sequeljs/ast/blob/8de61b1/src/nodes/Over.ts#L6)
