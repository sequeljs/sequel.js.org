---
id: '_nodes_multiplication_.multiplication'
title: 'Multiplication'
sidebar_label: 'Multiplication'
---
...
- [constructor](_nodes_multiplication_.multiplication.md#constructor)

### Properties

- [left](_nodes_multiplication_.multiplication.md#left)
- [operator](_nodes_multiplication_.multiplication.md#readonly-operator)
- [right](_nodes_multiplication_.multiplication.md#right)

### Methods

- [add](_nodes_multiplication_.multiplication.md#add)
- [as](_nodes_multiplication_.multiplication.md#as)
- [asc](_nodes_multiplication_.multiplication.md#asc)
- [average](_nodes_multiplication_.multiplication.md#average)
- [between](_nodes_multiplication_.multiplication.md#between)
- [bitwiseAnd](_nodes_multiplication_.multiplication.md#bitwiseand)
- [bitwiseNot](_nodes_multiplication_.multiplication.md#bitwisenot)
- [bitwiseOr](_nodes_multiplication_.multiplication.md#bitwiseor)
- [bitwiseShiftLeft](_nodes_multiplication_.multiplication.md#bitwiseshiftleft)
- [bitwiseShiftRight](_nodes_multiplication_.multiplication.md#bitwiseshiftright)
- [bitwiseXor](_nodes_multiplication_.multiplication.md#bitwisexor)
- [concat](_nodes_multiplication_.multiplication.md#concat)
- [count](_nodes_multiplication_.multiplication.md#count)
- [desc](_nodes_multiplication_.multiplication.md#desc)
- [divide](_nodes_multiplication_.multiplication.md#divide)
- [doesNotMatch](_nodes_multiplication_.multiplication.md#doesnotmatch)
- [doesNotMatchAll](_nodes_multiplication_.multiplication.md#doesnotmatchall)
- [doesNotMatchAny](_nodes_multiplication_.multiplication.md#doesnotmatchany)
- [doesNotMatchRegexp](_nodes_multiplication_.multiplication.md#doesnotmatchregexp)
- [eq](_nodes_multiplication_.multiplication.md#eq)
- [eqAll](_nodes_multiplication_.multiplication.md#eqall)
- [eqAny](_nodes_multiplication_.multiplication.md#eqany)
- [extract](_nodes_multiplication_.multiplication.md#extract)
- [groupingAll](_nodes_multiplication_.multiplication.md#protected-groupingall)
- [groupingAny](_nodes_multiplication_.multiplication.md#protected-groupingany)
- [gt](_nodes_multiplication_.multiplication.md#gt)
- [gtAll](_nodes_multiplication_.multiplication.md#gtall)
- [gtAny](_nodes_multiplication_.multiplication.md#gtany)
- [gteq](_nodes_multiplication_.multiplication.md#gteq)
- [gteqAll](_nodes_multiplication_.multiplication.md#gteqall)
- [gteqAny](_nodes_multiplication_.multiplication.md#gteqany)
- [inAll](_nodes_multiplication_.multiplication.md#inall)
- [inAny](_nodes_multiplication_.multiplication.md#inany)
- [inVal](_nodes_multiplication_.multiplication.md#inval)
- [isDistinctFrom](_nodes_multiplication_.multiplication.md#isdistinctfrom)
- [isInfinity](_nodes_multiplication_.multiplication.md#protected-isinfinity)
- [isNotDistinctFrom](_nodes_multiplication_.multiplication.md#isnotdistinctfrom)
- [isOpenEnded](_nodes_multiplication_.multiplication.md#protected-isopenended)
- [isUnboundable](_nodes_multiplication_.multiplication.md#protected-isunboundable)
- [lt](_nodes_multiplication_.multiplication.md#lt)
- [ltAll](_nodes_multiplication_.multiplication.md#ltall)
- [ltAny](_nodes_multiplication_.multiplication.md#ltany)
- [lteq](_nodes_multiplication_.multiplication.md#lteq)
- [lteqAll](_nodes_multiplication_.multiplication.md#lteqall)
- [lteqAny](_nodes_multiplication_.multiplication.md#lteqany)
- [matches](_nodes_multiplication_.multiplication.md#matches)
- [matchesAll](_nodes_multiplication_.multiplication.md#matchesall)
- [matchesAny](_nodes_multiplication_.multiplication.md#matchesany)
- [matchesRegexp](_nodes_multiplication_.multiplication.md#matchesregexp)
- [maximum](_nodes_multiplication_.multiplication.md#maximum)
- [minimum](_nodes_multiplication_.multiplication.md#minimum)
- [multiply](_nodes_multiplication_.multiplication.md#multiply)
- [notBetween](_nodes_multiplication_.multiplication.md#notbetween)
- [notEq](_nodes_multiplication_.multiplication.md#noteq)
- [notEqAll](_nodes_multiplication_.multiplication.md#noteqall)
- [notEqAny](_nodes_multiplication_.multiplication.md#noteqany)
- [notInAll](_nodes_multiplication_.multiplication.md#notinall)
- [notInAny](_nodes_multiplication_.multiplication.md#notinany)
- [notInVal](_nodes_multiplication_.multiplication.md#notinval)
- [quotedArray](_nodes_multiplication_.multiplication.md#quotedarray)
- [quotedNode](_nodes_multiplication_.multiplication.md#quotednode)
- [subtract](_nodes_multiplication_.multiplication.md#subtract)
- [sum](_nodes_multiplication_.multiplication.md#sum)
- [toSQL](_nodes_multiplication_.multiplication.md#tosql)
- [when](_nodes_multiplication_.multiplication.md#when)

## Constructors

### constructor

\+ **new Multiplication**(`left`: any, `right`: any):
...
_Defined in
[src/nodes/Multiplication.ts:3](https://github.com/sequeljs/ast/blob/aa0ef0f/src/nodes/Multiplication.ts#L3)_
