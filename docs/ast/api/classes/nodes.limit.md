...
- [constructor](nodes.limit.md#constructor)

### Properties

- [expr](nodes.limit.md#expr)

### Accessors

- [value](nodes.limit.md#value)

### Methods

- [add](nodes.limit.md#add)
- [and](nodes.limit.md#and)
- [as](nodes.limit.md#as)
- [asc](nodes.limit.md#asc)
- [average](nodes.limit.md#average)
- [between](nodes.limit.md#between)
- [bitwiseAnd](nodes.limit.md#bitwiseand)
- [bitwiseNot](nodes.limit.md#bitwisenot)
- [bitwiseOr](nodes.limit.md#bitwiseor)
- [bitwiseShiftLeft](nodes.limit.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.limit.md#bitwiseshiftright)
- [bitwiseXor](nodes.limit.md#bitwisexor)
- [coalesce](nodes.limit.md#coalesce)
- [concat](nodes.limit.md#concat)
- [count](nodes.limit.md#count)
- [createAnd](nodes.limit.md#createand)
- [createFalse](nodes.limit.md#createfalse)
- [createJoin](nodes.limit.md#createjoin)
- [createOn](nodes.limit.md#createon)
- [createStringJoin](nodes.limit.md#createstringjoin)
- [createTableAlias](nodes.limit.md#createtablealias)
- [createTrue](nodes.limit.md#createtrue)
- [desc](nodes.limit.md#desc)
- [divide](nodes.limit.md#divide)
- [doesNotMatch](nodes.limit.md#doesnotmatch)
- [doesNotMatchAll](nodes.limit.md#doesnotmatchall)
- [doesNotMatchAny](nodes.limit.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.limit.md#doesnotmatchregexp)
- [eq](nodes.limit.md#eq)
- [eqAll](nodes.limit.md#eqall)
- [eqAny](nodes.limit.md#eqany)
- [extract](nodes.limit.md#extract)
- [grouping](nodes.limit.md#grouping)
- [groupingAll](nodes.limit.md#groupingall)
- [groupingAny](nodes.limit.md#groupingany)
- [gt](nodes.limit.md#gt)
- [gtAll](nodes.limit.md#gtall)
- [gtAny](nodes.limit.md#gtany)
- [gteq](nodes.limit.md#gteq)
- [gteqAll](nodes.limit.md#gteqall)
- [gteqAny](nodes.limit.md#gteqany)
- [inAll](nodes.limit.md#inall)
- [inAny](nodes.limit.md#inany)
- [inVal](nodes.limit.md#inval)
- [isDistinctFrom](nodes.limit.md#isdistinctfrom)
- [isInfinity](nodes.limit.md#isinfinity)
- [isNotDistinctFrom](nodes.limit.md#isnotdistinctfrom)
- [isOpenEnded](nodes.limit.md#isopenended)
- [isUnboundable](nodes.limit.md#isunboundable)
- [lower](nodes.limit.md#lower)
- [lt](nodes.limit.md#lt)
- [ltAll](nodes.limit.md#ltall)
- [ltAny](nodes.limit.md#ltany)
- [lteq](nodes.limit.md#lteq)
- [lteqAll](nodes.limit.md#lteqall)
- [lteqAny](nodes.limit.md#lteqany)
- [matches](nodes.limit.md#matches)
- [matchesAll](nodes.limit.md#matchesall)
- [matchesAny](nodes.limit.md#matchesany)
- [matchesRegexp](nodes.limit.md#matchesregexp)
- [maximum](nodes.limit.md#maximum)
- [minimum](nodes.limit.md#minimum)
- [multiply](nodes.limit.md#multiply)
- [not](nodes.limit.md#not)
- [notBetween](nodes.limit.md#notbetween)
- [notEq](nodes.limit.md#noteq)
- [notEqAll](nodes.limit.md#noteqall)
- [notEqAny](nodes.limit.md#noteqany)
- [notInAll](nodes.limit.md#notinall)
- [notInAny](nodes.limit.md#notinany)
- [notInVal](nodes.limit.md#notinval)
- [or](nodes.limit.md#or)
- [quotedArray](nodes.limit.md#quotedarray)
- [quotedNode](nodes.limit.md#quotednode)
- [subtract](nodes.limit.md#subtract)
- [sum](nodes.limit.md#sum)
- [toSQL](nodes.limit.md#tosql)
- [when](nodes.limit.md#when)

## Constructors

### constructor

\+ **new Limit**(`expr`: [_Visitable_](../modules/visitors.md#visitable)):
...
**Returns:** [_Limit_](nodes.limit.md)
