...
- [constructor](nodes.isnotdistinctfrom.md#constructor)

### Properties

- [left](nodes.isnotdistinctfrom.md#left)
- [operator](nodes.isnotdistinctfrom.md#operator)
- [right](nodes.isnotdistinctfrom.md#right)

### Accessors

- [operand1](nodes.isnotdistinctfrom.md#operand1)
- [operand2](nodes.isnotdistinctfrom.md#operand2)

### Methods

- [add](nodes.isnotdistinctfrom.md#add)
- [and](nodes.isnotdistinctfrom.md#and)
- [as](nodes.isnotdistinctfrom.md#as)
- [asc](nodes.isnotdistinctfrom.md#asc)
- [average](nodes.isnotdistinctfrom.md#average)
- [between](nodes.isnotdistinctfrom.md#between)
- [bitwiseAnd](nodes.isnotdistinctfrom.md#bitwiseand)
- [bitwiseNot](nodes.isnotdistinctfrom.md#bitwisenot)
- [bitwiseOr](nodes.isnotdistinctfrom.md#bitwiseor)
- [bitwiseShiftLeft](nodes.isnotdistinctfrom.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.isnotdistinctfrom.md#bitwiseshiftright)
- [bitwiseXor](nodes.isnotdistinctfrom.md#bitwisexor)
- [coalesce](nodes.isnotdistinctfrom.md#coalesce)
- [concat](nodes.isnotdistinctfrom.md#concat)
- [count](nodes.isnotdistinctfrom.md#count)
- [createAnd](nodes.isnotdistinctfrom.md#createand)
- [createFalse](nodes.isnotdistinctfrom.md#createfalse)
- [createJoin](nodes.isnotdistinctfrom.md#createjoin)
- [createOn](nodes.isnotdistinctfrom.md#createon)
- [createStringJoin](nodes.isnotdistinctfrom.md#createstringjoin)
- [createTableAlias](nodes.isnotdistinctfrom.md#createtablealias)
- [createTrue](nodes.isnotdistinctfrom.md#createtrue)
- [desc](nodes.isnotdistinctfrom.md#desc)
- [divide](nodes.isnotdistinctfrom.md#divide)
- [doesNotMatch](nodes.isnotdistinctfrom.md#doesnotmatch)
- [doesNotMatchAll](nodes.isnotdistinctfrom.md#doesnotmatchall)
- [doesNotMatchAny](nodes.isnotdistinctfrom.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.isnotdistinctfrom.md#doesnotmatchregexp)
- [eq](nodes.isnotdistinctfrom.md#eq)
- [eqAll](nodes.isnotdistinctfrom.md#eqall)
- [eqAny](nodes.isnotdistinctfrom.md#eqany)
- [extract](nodes.isnotdistinctfrom.md#extract)
- [grouping](nodes.isnotdistinctfrom.md#grouping)
- [groupingAll](nodes.isnotdistinctfrom.md#groupingall)
- [groupingAny](nodes.isnotdistinctfrom.md#groupingany)
- [gt](nodes.isnotdistinctfrom.md#gt)
- [gtAll](nodes.isnotdistinctfrom.md#gtall)
- [gtAny](nodes.isnotdistinctfrom.md#gtany)
- [gteq](nodes.isnotdistinctfrom.md#gteq)
- [gteqAll](nodes.isnotdistinctfrom.md#gteqall)
- [gteqAny](nodes.isnotdistinctfrom.md#gteqany)
- [inAll](nodes.isnotdistinctfrom.md#inall)
- [inAny](nodes.isnotdistinctfrom.md#inany)
- [inVal](nodes.isnotdistinctfrom.md#inval)
- [isDistinctFrom](nodes.isnotdistinctfrom.md#isdistinctfrom)
- [isInfinity](nodes.isnotdistinctfrom.md#isinfinity)
- [isNotDistinctFrom](nodes.isnotdistinctfrom.md#isnotdistinctfrom)
- [isOpenEnded](nodes.isnotdistinctfrom.md#isopenended)
- [isUnboundable](nodes.isnotdistinctfrom.md#isunboundable)
- [lower](nodes.isnotdistinctfrom.md#lower)
- [lt](nodes.isnotdistinctfrom.md#lt)
- [ltAll](nodes.isnotdistinctfrom.md#ltall)
- [ltAny](nodes.isnotdistinctfrom.md#ltany)
- [lteq](nodes.isnotdistinctfrom.md#lteq)
- [lteqAll](nodes.isnotdistinctfrom.md#lteqall)
- [lteqAny](nodes.isnotdistinctfrom.md#lteqany)
- [matches](nodes.isnotdistinctfrom.md#matches)
- [matchesAll](nodes.isnotdistinctfrom.md#matchesall)
- [matchesAny](nodes.isnotdistinctfrom.md#matchesany)
- [matchesRegexp](nodes.isnotdistinctfrom.md#matchesregexp)
- [maximum](nodes.isnotdistinctfrom.md#maximum)
- [minimum](nodes.isnotdistinctfrom.md#minimum)
- [multiply](nodes.isnotdistinctfrom.md#multiply)
- [not](nodes.isnotdistinctfrom.md#not)
- [notBetween](nodes.isnotdistinctfrom.md#notbetween)
- [notEq](nodes.isnotdistinctfrom.md#noteq)
- [notEqAll](nodes.isnotdistinctfrom.md#noteqall)
- [notEqAny](nodes.isnotdistinctfrom.md#noteqany)
- [notInAll](nodes.isnotdistinctfrom.md#notinall)
- [notInAny](nodes.isnotdistinctfrom.md#notinany)
- [notInVal](nodes.isnotdistinctfrom.md#notinval)
- [or](nodes.isnotdistinctfrom.md#or)
- [quotedArray](nodes.isnotdistinctfrom.md#quotedarray)
- [quotedNode](nodes.isnotdistinctfrom.md#quotednode)
- [subtract](nodes.isnotdistinctfrom.md#subtract)
- [sum](nodes.isnotdistinctfrom.md#sum)
- [toSQL](nodes.isnotdistinctfrom.md#tosql)
- [when](nodes.isnotdistinctfrom.md#when)
...
Defined in:
[src/nodes/Equality.ts:4](https://github.com/sequeljs/ast/blob/8de61b1/src/nodes/Equality.ts#L4)
...
Defined in:
[src/nodes/Equality.ts:6](https://github.com/sequeljs/ast/blob/8de61b1/src/nodes/Equality.ts#L6)
...
Defined in:
[src/nodes/Equality.ts:10](https://github.com/sequeljs/ast/blob/8de61b1/src/nodes/Equality.ts#L10)
