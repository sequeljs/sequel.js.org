...
- [constructor](nodes.regexp.md#constructor)

### Properties

- [caseSensitive](nodes.regexp.md#casesensitive)
- [left](nodes.regexp.md#left)
- [right](nodes.regexp.md#right)

### Methods

- [add](nodes.regexp.md#add)
- [and](nodes.regexp.md#and)
- [as](nodes.regexp.md#as)
- [asc](nodes.regexp.md#asc)
- [average](nodes.regexp.md#average)
- [between](nodes.regexp.md#between)
- [bitwiseAnd](nodes.regexp.md#bitwiseand)
- [bitwiseNot](nodes.regexp.md#bitwisenot)
- [bitwiseOr](nodes.regexp.md#bitwiseor)
- [bitwiseShiftLeft](nodes.regexp.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.regexp.md#bitwiseshiftright)
- [bitwiseXor](nodes.regexp.md#bitwisexor)
- [coalesce](nodes.regexp.md#coalesce)
- [concat](nodes.regexp.md#concat)
- [count](nodes.regexp.md#count)
- [createAnd](nodes.regexp.md#createand)
- [createFalse](nodes.regexp.md#createfalse)
- [createJoin](nodes.regexp.md#createjoin)
- [createOn](nodes.regexp.md#createon)
- [createStringJoin](nodes.regexp.md#createstringjoin)
- [createTableAlias](nodes.regexp.md#createtablealias)
- [createTrue](nodes.regexp.md#createtrue)
- [desc](nodes.regexp.md#desc)
- [divide](nodes.regexp.md#divide)
- [doesNotMatch](nodes.regexp.md#doesnotmatch)
- [doesNotMatchAll](nodes.regexp.md#doesnotmatchall)
- [doesNotMatchAny](nodes.regexp.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.regexp.md#doesnotmatchregexp)
- [eq](nodes.regexp.md#eq)
- [eqAll](nodes.regexp.md#eqall)
- [eqAny](nodes.regexp.md#eqany)
- [extract](nodes.regexp.md#extract)
- [grouping](nodes.regexp.md#grouping)
- [groupingAll](nodes.regexp.md#groupingall)
- [groupingAny](nodes.regexp.md#groupingany)
- [gt](nodes.regexp.md#gt)
- [gtAll](nodes.regexp.md#gtall)
- [gtAny](nodes.regexp.md#gtany)
- [gteq](nodes.regexp.md#gteq)
- [gteqAll](nodes.regexp.md#gteqall)
- [gteqAny](nodes.regexp.md#gteqany)
- [inAll](nodes.regexp.md#inall)
- [inAny](nodes.regexp.md#inany)
- [inVal](nodes.regexp.md#inval)
- [isDistinctFrom](nodes.regexp.md#isdistinctfrom)
- [isInfinity](nodes.regexp.md#isinfinity)
- [isNotDistinctFrom](nodes.regexp.md#isnotdistinctfrom)
- [isOpenEnded](nodes.regexp.md#isopenended)
- [isUnboundable](nodes.regexp.md#isunboundable)
- [lower](nodes.regexp.md#lower)
- [lt](nodes.regexp.md#lt)
- [ltAll](nodes.regexp.md#ltall)
- [ltAny](nodes.regexp.md#ltany)
- [lteq](nodes.regexp.md#lteq)
- [lteqAll](nodes.regexp.md#lteqall)
- [lteqAny](nodes.regexp.md#lteqany)
- [matches](nodes.regexp.md#matches)
- [matchesAll](nodes.regexp.md#matchesall)
- [matchesAny](nodes.regexp.md#matchesany)
- [matchesRegexp](nodes.regexp.md#matchesregexp)
- [maximum](nodes.regexp.md#maximum)
- [minimum](nodes.regexp.md#minimum)
- [multiply](nodes.regexp.md#multiply)
- [not](nodes.regexp.md#not)
- [notBetween](nodes.regexp.md#notbetween)
- [notEq](nodes.regexp.md#noteq)
- [notEqAll](nodes.regexp.md#noteqall)
- [notEqAny](nodes.regexp.md#noteqany)
- [notInAll](nodes.regexp.md#notinall)
- [notInAny](nodes.regexp.md#notinany)
- [notInVal](nodes.regexp.md#notinval)
- [or](nodes.regexp.md#or)
- [quotedArray](nodes.regexp.md#quotedarray)
- [quotedNode](nodes.regexp.md#quotednode)
- [subtract](nodes.regexp.md#subtract)
- [sum](nodes.regexp.md#sum)
- [toSQL](nodes.regexp.md#tosql)
- [when](nodes.regexp.md#when)

## Constructors

### constructor

\+ **new Regexp**(`left`: _any_, `right`: _any_, `caseSensitive?`: _boolean_):
