---
id: '_nodes_currentrow_.currentrow'
title: 'CurrentRow'
sidebar_label: 'CurrentRow'
---
...
- [and](_nodes_currentrow_.currentrow.md#and)
- [coalesce](_nodes_currentrow_.currentrow.md#coalesce)
- [createAnd](_nodes_currentrow_.currentrow.md#createand)
- [createFalse](_nodes_currentrow_.currentrow.md#createfalse)
- [createJoin](_nodes_currentrow_.currentrow.md#createjoin)
- [createOn](_nodes_currentrow_.currentrow.md#createon)
- [createStringJoin](_nodes_currentrow_.currentrow.md#createstringjoin)
- [createTableAlias](_nodes_currentrow_.currentrow.md#createtablealias)
- [createTrue](_nodes_currentrow_.currentrow.md#createtrue)
- [grouping](_nodes_currentrow_.currentrow.md#grouping)
- [lower](_nodes_currentrow_.currentrow.md#lower)
- [not](_nodes_currentrow_.currentrow.md#not)
- [or](_nodes_currentrow_.currentrow.md#or)
- [toSQL](_nodes_currentrow_.currentrow.md#tosql)
