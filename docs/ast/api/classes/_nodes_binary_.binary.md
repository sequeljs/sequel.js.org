...
- [AliasPredication](_mixins_aliaspredication_.aliaspredication.md)
  ...
  ↳ [NotIn](_nodes_notin_.notin.md)

  ↳ [Regexp](_nodes_regexp_.regexp.md)

  ↳ [Or](_nodes_or_.or.md)

  ↳ [When](_nodes_when_.when.md)
...
- [constructor](_nodes_binary_.binary.md#constructor)

### Properties

- [left](_nodes_binary_.binary.md#left)
- [right](_nodes_binary_.binary.md#right)

### Methods

- [add](_nodes_binary_.binary.md#add)
- [as](_nodes_binary_.binary.md#as)
- [asc](_nodes_binary_.binary.md#asc)
- [average](_nodes_binary_.binary.md#average)
- [between](_nodes_binary_.binary.md#between)
- [bitwiseAnd](_nodes_binary_.binary.md#bitwiseand)
- [bitwiseNot](_nodes_binary_.binary.md#bitwisenot)
- [bitwiseOr](_nodes_binary_.binary.md#bitwiseor)
- [bitwiseShiftLeft](_nodes_binary_.binary.md#bitwiseshiftleft)
- [bitwiseShiftRight](_nodes_binary_.binary.md#bitwiseshiftright)
- [bitwiseXor](_nodes_binary_.binary.md#bitwisexor)
- [concat](_nodes_binary_.binary.md#concat)
- [count](_nodes_binary_.binary.md#count)
- [desc](_nodes_binary_.binary.md#desc)
- [divide](_nodes_binary_.binary.md#divide)
- [doesNotMatch](_nodes_binary_.binary.md#doesnotmatch)
- [doesNotMatchAll](_nodes_binary_.binary.md#doesnotmatchall)
- [doesNotMatchAny](_nodes_binary_.binary.md#doesnotmatchany)
- [doesNotMatchRegexp](_nodes_binary_.binary.md#doesnotmatchregexp)
- [eq](_nodes_binary_.binary.md#eq)
- [eqAll](_nodes_binary_.binary.md#eqall)
- [eqAny](_nodes_binary_.binary.md#eqany)
- [extract](_nodes_binary_.binary.md#extract)
- [groupingAll](_nodes_binary_.binary.md#protected-groupingall)
- [groupingAny](_nodes_binary_.binary.md#protected-groupingany)
- [gt](_nodes_binary_.binary.md#gt)
- [gtAll](_nodes_binary_.binary.md#gtall)
- [gtAny](_nodes_binary_.binary.md#gtany)
- [gteq](_nodes_binary_.binary.md#gteq)
- [gteqAll](_nodes_binary_.binary.md#gteqall)
- [gteqAny](_nodes_binary_.binary.md#gteqany)
- [inAll](_nodes_binary_.binary.md#inall)
- [inAny](_nodes_binary_.binary.md#inany)
- [inVal](_nodes_binary_.binary.md#inval)
- [isDistinctFrom](_nodes_binary_.binary.md#isdistinctfrom)
- [isInfinity](_nodes_binary_.binary.md#protected-isinfinity)
- [isNotDistinctFrom](_nodes_binary_.binary.md#isnotdistinctfrom)
- [isOpenEnded](_nodes_binary_.binary.md#protected-isopenended)
- [isUnboundable](_nodes_binary_.binary.md#protected-isunboundable)
- [lt](_nodes_binary_.binary.md#lt)
- [ltAll](_nodes_binary_.binary.md#ltall)
- [ltAny](_nodes_binary_.binary.md#ltany)
- [lteq](_nodes_binary_.binary.md#lteq)
- [lteqAll](_nodes_binary_.binary.md#lteqall)
- [lteqAny](_nodes_binary_.binary.md#lteqany)
- [matches](_nodes_binary_.binary.md#matches)
- [matchesAll](_nodes_binary_.binary.md#matchesall)
- [matchesAny](_nodes_binary_.binary.md#matchesany)
- [matchesRegexp](_nodes_binary_.binary.md#matchesregexp)
- [maximum](_nodes_binary_.binary.md#maximum)
- [minimum](_nodes_binary_.binary.md#minimum)
- [multiply](_nodes_binary_.binary.md#multiply)
- [notBetween](_nodes_binary_.binary.md#notbetween)
- [notEq](_nodes_binary_.binary.md#noteq)
- [notEqAll](_nodes_binary_.binary.md#noteqall)
- [notEqAny](_nodes_binary_.binary.md#noteqany)
- [notInAll](_nodes_binary_.binary.md#notinall)
- [notInAny](_nodes_binary_.binary.md#notinany)
- [notInVal](_nodes_binary_.binary.md#notinval)
- [quotedArray](_nodes_binary_.binary.md#quotedarray)
- [quotedNode](_nodes_binary_.binary.md#quotednode)
- [subtract](_nodes_binary_.binary.md#subtract)
- [sum](_nodes_binary_.binary.md#sum)
- [toSQL](_nodes_binary_.binary.md#tosql)
- [when](_nodes_binary_.binary.md#when)

## Constructors

### constructor

\+ **new Binary**(`left`: L, `right`: R): _[Binary](_nodes_binary_.binary.md)_
...
**Returns:** _[Binary](_nodes_binary_.binary.md)_
