...
[Nodes](../modules/nodes.md) / DistinctOn
...
- [constructor](nodes.distincton.md#constructor)

### Properties

- [expr](nodes.distincton.md#expr)

### Accessors

- [value](nodes.distincton.md#value)

### Methods

- [add](nodes.distincton.md#add)
- [and](nodes.distincton.md#and)
- [as](nodes.distincton.md#as)
- [asc](nodes.distincton.md#asc)
- [average](nodes.distincton.md#average)
- [between](nodes.distincton.md#between)
- [bitwiseAnd](nodes.distincton.md#bitwiseand)
- [bitwiseNot](nodes.distincton.md#bitwisenot)
- [bitwiseOr](nodes.distincton.md#bitwiseor)
- [bitwiseShiftLeft](nodes.distincton.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.distincton.md#bitwiseshiftright)
- [bitwiseXor](nodes.distincton.md#bitwisexor)
- [coalesce](nodes.distincton.md#coalesce)
- [concat](nodes.distincton.md#concat)
- [count](nodes.distincton.md#count)
- [createAnd](nodes.distincton.md#createand)
- [createFalse](nodes.distincton.md#createfalse)
- [createJoin](nodes.distincton.md#createjoin)
- [createOn](nodes.distincton.md#createon)
- [createStringJoin](nodes.distincton.md#createstringjoin)
- [createTableAlias](nodes.distincton.md#createtablealias)
- [createTrue](nodes.distincton.md#createtrue)
- [desc](nodes.distincton.md#desc)
- [divide](nodes.distincton.md#divide)
- [doesNotMatch](nodes.distincton.md#doesnotmatch)
- [doesNotMatchAll](nodes.distincton.md#doesnotmatchall)
- [doesNotMatchAny](nodes.distincton.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.distincton.md#doesnotmatchregexp)
- [eq](nodes.distincton.md#eq)
- [eqAll](nodes.distincton.md#eqall)
- [eqAny](nodes.distincton.md#eqany)
- [extract](nodes.distincton.md#extract)
- [grouping](nodes.distincton.md#grouping)
- [groupingAll](nodes.distincton.md#groupingall)
- [groupingAny](nodes.distincton.md#groupingany)
- [gt](nodes.distincton.md#gt)
- [gtAll](nodes.distincton.md#gtall)
- [gtAny](nodes.distincton.md#gtany)
- [gteq](nodes.distincton.md#gteq)
- [gteqAll](nodes.distincton.md#gteqall)
- [gteqAny](nodes.distincton.md#gteqany)
- [inAll](nodes.distincton.md#inall)
- [inAny](nodes.distincton.md#inany)
- [inVal](nodes.distincton.md#inval)
- [isDistinctFrom](nodes.distincton.md#isdistinctfrom)
- [isInfinity](nodes.distincton.md#isinfinity)
- [isNotDistinctFrom](nodes.distincton.md#isnotdistinctfrom)
- [isOpenEnded](nodes.distincton.md#isopenended)
- [isUnboundable](nodes.distincton.md#isunboundable)
- [lower](nodes.distincton.md#lower)
- [lt](nodes.distincton.md#lt)
- [ltAll](nodes.distincton.md#ltall)
- [ltAny](nodes.distincton.md#ltany)
- [lteq](nodes.distincton.md#lteq)
- [lteqAll](nodes.distincton.md#lteqall)
- [lteqAny](nodes.distincton.md#lteqany)
- [matches](nodes.distincton.md#matches)
- [matchesAll](nodes.distincton.md#matchesall)
- [matchesAny](nodes.distincton.md#matchesany)
- [matchesRegexp](nodes.distincton.md#matchesregexp)
- [maximum](nodes.distincton.md#maximum)
- [minimum](nodes.distincton.md#minimum)
- [multiply](nodes.distincton.md#multiply)
- [not](nodes.distincton.md#not)
- [notBetween](nodes.distincton.md#notbetween)
- [notEq](nodes.distincton.md#noteq)
- [notEqAll](nodes.distincton.md#noteqall)
- [notEqAny](nodes.distincton.md#noteqany)
- [notInAll](nodes.distincton.md#notinall)
- [notInAny](nodes.distincton.md#notinany)
- [notInVal](nodes.distincton.md#notinval)
- [or](nodes.distincton.md#or)
- [quotedArray](nodes.distincton.md#quotedarray)
- [quotedNode](nodes.distincton.md#quotednode)
- [subtract](nodes.distincton.md#subtract)
- [sum](nodes.distincton.md#sum)
- [toSQL](nodes.distincton.md#tosql)
- [when](nodes.distincton.md#when)

## Constructors

### constructor

\+ **new DistinctOn**(`expr`: [_Visitable_](../modules/visitors.md#visitable)):
...
**Returns:** [_DistinctOn_](nodes.distincton.md)
