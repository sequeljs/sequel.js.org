...
[Nodes](../modules/nodes.md) / Preceding
...
- [constructor](nodes.preceding.md#constructor)

### Properties

- [expr](nodes.preceding.md#expr)

### Accessors

- [value](nodes.preceding.md#value)

### Methods

- [add](nodes.preceding.md#add)
- [and](nodes.preceding.md#and)
- [as](nodes.preceding.md#as)
- [asc](nodes.preceding.md#asc)
- [average](nodes.preceding.md#average)
- [between](nodes.preceding.md#between)
- [bitwiseAnd](nodes.preceding.md#bitwiseand)
- [bitwiseNot](nodes.preceding.md#bitwisenot)
- [bitwiseOr](nodes.preceding.md#bitwiseor)
- [bitwiseShiftLeft](nodes.preceding.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.preceding.md#bitwiseshiftright)
- [bitwiseXor](nodes.preceding.md#bitwisexor)
- [coalesce](nodes.preceding.md#coalesce)
- [concat](nodes.preceding.md#concat)
- [count](nodes.preceding.md#count)
- [createAnd](nodes.preceding.md#createand)
- [createFalse](nodes.preceding.md#createfalse)
- [createJoin](nodes.preceding.md#createjoin)
- [createOn](nodes.preceding.md#createon)
- [createStringJoin](nodes.preceding.md#createstringjoin)
- [createTableAlias](nodes.preceding.md#createtablealias)
- [createTrue](nodes.preceding.md#createtrue)
- [desc](nodes.preceding.md#desc)
- [divide](nodes.preceding.md#divide)
- [doesNotMatch](nodes.preceding.md#doesnotmatch)
- [doesNotMatchAll](nodes.preceding.md#doesnotmatchall)
- [doesNotMatchAny](nodes.preceding.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.preceding.md#doesnotmatchregexp)
- [eq](nodes.preceding.md#eq)
- [eqAll](nodes.preceding.md#eqall)
- [eqAny](nodes.preceding.md#eqany)
- [extract](nodes.preceding.md#extract)
- [grouping](nodes.preceding.md#grouping)
- [groupingAll](nodes.preceding.md#groupingall)
- [groupingAny](nodes.preceding.md#groupingany)
- [gt](nodes.preceding.md#gt)
- [gtAll](nodes.preceding.md#gtall)
- [gtAny](nodes.preceding.md#gtany)
- [gteq](nodes.preceding.md#gteq)
- [gteqAll](nodes.preceding.md#gteqall)
- [gteqAny](nodes.preceding.md#gteqany)
- [inAll](nodes.preceding.md#inall)
- [inAny](nodes.preceding.md#inany)
- [inVal](nodes.preceding.md#inval)
- [isDistinctFrom](nodes.preceding.md#isdistinctfrom)
- [isInfinity](nodes.preceding.md#isinfinity)
- [isNotDistinctFrom](nodes.preceding.md#isnotdistinctfrom)
- [isOpenEnded](nodes.preceding.md#isopenended)
- [isUnboundable](nodes.preceding.md#isunboundable)
- [lower](nodes.preceding.md#lower)
- [lt](nodes.preceding.md#lt)
- [ltAll](nodes.preceding.md#ltall)
- [ltAny](nodes.preceding.md#ltany)
- [lteq](nodes.preceding.md#lteq)
- [lteqAll](nodes.preceding.md#lteqall)
- [lteqAny](nodes.preceding.md#lteqany)
- [matches](nodes.preceding.md#matches)
- [matchesAll](nodes.preceding.md#matchesall)
- [matchesAny](nodes.preceding.md#matchesany)
- [matchesRegexp](nodes.preceding.md#matchesregexp)
- [maximum](nodes.preceding.md#maximum)
- [minimum](nodes.preceding.md#minimum)
- [multiply](nodes.preceding.md#multiply)
- [not](nodes.preceding.md#not)
- [notBetween](nodes.preceding.md#notbetween)
- [notEq](nodes.preceding.md#noteq)
- [notEqAll](nodes.preceding.md#noteqall)
- [notEqAny](nodes.preceding.md#noteqany)
- [notInAll](nodes.preceding.md#notinall)
- [notInAny](nodes.preceding.md#notinany)
- [notInVal](nodes.preceding.md#notinval)
- [or](nodes.preceding.md#or)
- [quotedArray](nodes.preceding.md#quotedarray)
- [quotedNode](nodes.preceding.md#quotednode)
- [subtract](nodes.preceding.md#subtract)
- [sum](nodes.preceding.md#sum)
- [toSQL](nodes.preceding.md#tosql)
- [when](nodes.preceding.md#when)

## Constructors

### constructor

\+ **new Preceding**(`expr?`: _any_): [_Preceding_](nodes.preceding.md)
...
**Returns:** [_Preceding_](nodes.preceding.md)

Inherited from: [Unary](nodes.unary.md)

Defined in:
[src/nodes/Preceding.ts:3](https://github.com/sequeljs/ast/blob/6632050/src/nodes/Preceding.ts#L3)
