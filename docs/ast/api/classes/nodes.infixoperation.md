...
[Nodes](../modules/nodes.md) / InfixOperation
...
- _WhenPredication_
  ...
  ↳↳ [_BitwiseOr_](nodes.bitwiseor.md)
  ...
  ↳↳ [_Concat_](nodes.concat.md)

  ↳↳ [_Division_](nodes.division.md)

  ↳↳ [_Multiplication_](nodes.multiplication.md)

  ↳↳ [_Subtraction_](nodes.subtraction.md)

## Index

### Constructors

- [constructor](nodes.infixoperation.md#constructor)

### Properties

- [left](nodes.infixoperation.md#left)
- [operator](nodes.infixoperation.md#operator)
- [right](nodes.infixoperation.md#right)

### Methods

- [add](nodes.infixoperation.md#add)
- [and](nodes.infixoperation.md#and)
- [as](nodes.infixoperation.md#as)
- [asc](nodes.infixoperation.md#asc)
- [average](nodes.infixoperation.md#average)
- [between](nodes.infixoperation.md#between)
- [bitwiseAnd](nodes.infixoperation.md#bitwiseand)
- [bitwiseNot](nodes.infixoperation.md#bitwisenot)
- [bitwiseOr](nodes.infixoperation.md#bitwiseor)
- [bitwiseShiftLeft](nodes.infixoperation.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.infixoperation.md#bitwiseshiftright)
- [bitwiseXor](nodes.infixoperation.md#bitwisexor)
- [coalesce](nodes.infixoperation.md#coalesce)
- [concat](nodes.infixoperation.md#concat)
- [count](nodes.infixoperation.md#count)
- [createAnd](nodes.infixoperation.md#createand)
- [createFalse](nodes.infixoperation.md#createfalse)
- [createJoin](nodes.infixoperation.md#createjoin)
- [createOn](nodes.infixoperation.md#createon)
- [createStringJoin](nodes.infixoperation.md#createstringjoin)
- [createTableAlias](nodes.infixoperation.md#createtablealias)
- [createTrue](nodes.infixoperation.md#createtrue)
- [desc](nodes.infixoperation.md#desc)
- [divide](nodes.infixoperation.md#divide)
- [doesNotMatch](nodes.infixoperation.md#doesnotmatch)
- [doesNotMatchAll](nodes.infixoperation.md#doesnotmatchall)
- [doesNotMatchAny](nodes.infixoperation.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.infixoperation.md#doesnotmatchregexp)
- [eq](nodes.infixoperation.md#eq)
- [eqAll](nodes.infixoperation.md#eqall)
- [eqAny](nodes.infixoperation.md#eqany)
- [extract](nodes.infixoperation.md#extract)
- [grouping](nodes.infixoperation.md#grouping)
- [groupingAll](nodes.infixoperation.md#groupingall)
- [groupingAny](nodes.infixoperation.md#groupingany)
- [gt](nodes.infixoperation.md#gt)
- [gtAll](nodes.infixoperation.md#gtall)
- [gtAny](nodes.infixoperation.md#gtany)
- [gteq](nodes.infixoperation.md#gteq)
- [gteqAll](nodes.infixoperation.md#gteqall)
- [gteqAny](nodes.infixoperation.md#gteqany)
- [inAll](nodes.infixoperation.md#inall)
- [inAny](nodes.infixoperation.md#inany)
- [inVal](nodes.infixoperation.md#inval)
- [isDistinctFrom](nodes.infixoperation.md#isdistinctfrom)
- [isInfinity](nodes.infixoperation.md#isinfinity)
- [isNotDistinctFrom](nodes.infixoperation.md#isnotdistinctfrom)
- [isOpenEnded](nodes.infixoperation.md#isopenended)
- [isUnboundable](nodes.infixoperation.md#isunboundable)
- [lower](nodes.infixoperation.md#lower)
- [lt](nodes.infixoperation.md#lt)
- [ltAll](nodes.infixoperation.md#ltall)
- [ltAny](nodes.infixoperation.md#ltany)
- [lteq](nodes.infixoperation.md#lteq)
- [lteqAll](nodes.infixoperation.md#lteqall)
- [lteqAny](nodes.infixoperation.md#lteqany)
- [matches](nodes.infixoperation.md#matches)
- [matchesAll](nodes.infixoperation.md#matchesall)
- [matchesAny](nodes.infixoperation.md#matchesany)
- [matchesRegexp](nodes.infixoperation.md#matchesregexp)
- [maximum](nodes.infixoperation.md#maximum)
- [minimum](nodes.infixoperation.md#minimum)
- [multiply](nodes.infixoperation.md#multiply)
- [not](nodes.infixoperation.md#not)
- [notBetween](nodes.infixoperation.md#notbetween)
- [notEq](nodes.infixoperation.md#noteq)
- [notEqAll](nodes.infixoperation.md#noteqall)
- [notEqAny](nodes.infixoperation.md#noteqany)
- [notInAll](nodes.infixoperation.md#notinall)
- [notInAny](nodes.infixoperation.md#notinany)
- [notInVal](nodes.infixoperation.md#notinval)
- [or](nodes.infixoperation.md#or)
- [quotedArray](nodes.infixoperation.md#quotedarray)
- [quotedNode](nodes.infixoperation.md#quotednode)
- [subtract](nodes.infixoperation.md#subtract)
- [sum](nodes.infixoperation.md#sum)
- [toSQL](nodes.infixoperation.md#tosql)
- [when](nodes.infixoperation.md#when)

## Constructors

### constructor

\+ **new InfixOperation**(`operator`: _string_, `left`: _any_, `right`: _any_):
...
**Returns:** [_InfixOperation_](nodes.infixoperation.md)
