...
[Nodes](../modules/nodes.md) / Ordering
...
- _NullsFirstPredication_

- _NullsLastPredication_
...
- [constructor](nodes.ordering.md#constructor)

### Properties

- [expr](nodes.ordering.md#expr)

### Accessors

- [value](nodes.ordering.md#value)

### Methods

- [add](nodes.ordering.md#add)
- [and](nodes.ordering.md#and)
- [as](nodes.ordering.md#as)
- [asc](nodes.ordering.md#asc)
- [average](nodes.ordering.md#average)
- [between](nodes.ordering.md#between)
- [bitwiseAnd](nodes.ordering.md#bitwiseand)
- [bitwiseNot](nodes.ordering.md#bitwisenot)
- [bitwiseOr](nodes.ordering.md#bitwiseor)
- [bitwiseShiftLeft](nodes.ordering.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.ordering.md#bitwiseshiftright)
- [bitwiseXor](nodes.ordering.md#bitwisexor)
- [coalesce](nodes.ordering.md#coalesce)
- [concat](nodes.ordering.md#concat)
- [count](nodes.ordering.md#count)
- [createAnd](nodes.ordering.md#createand)
- [createFalse](nodes.ordering.md#createfalse)
- [createJoin](nodes.ordering.md#createjoin)
- [createOn](nodes.ordering.md#createon)
- [createStringJoin](nodes.ordering.md#createstringjoin)
- [createTableAlias](nodes.ordering.md#createtablealias)
- [createTrue](nodes.ordering.md#createtrue)
- [desc](nodes.ordering.md#desc)
- [divide](nodes.ordering.md#divide)
- [doesNotMatch](nodes.ordering.md#doesnotmatch)
- [doesNotMatchAll](nodes.ordering.md#doesnotmatchall)
- [doesNotMatchAny](nodes.ordering.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.ordering.md#doesnotmatchregexp)
- [eq](nodes.ordering.md#eq)
- [eqAll](nodes.ordering.md#eqall)
- [eqAny](nodes.ordering.md#eqany)
- [extract](nodes.ordering.md#extract)
- [grouping](nodes.ordering.md#grouping)
- [groupingAll](nodes.ordering.md#groupingall)
- [groupingAny](nodes.ordering.md#groupingany)
- [gt](nodes.ordering.md#gt)
- [gtAll](nodes.ordering.md#gtall)
- [gtAny](nodes.ordering.md#gtany)
- [gteq](nodes.ordering.md#gteq)
- [gteqAll](nodes.ordering.md#gteqall)
- [gteqAny](nodes.ordering.md#gteqany)
- [inAll](nodes.ordering.md#inall)
- [inAny](nodes.ordering.md#inany)
- [inVal](nodes.ordering.md#inval)
- [isDistinctFrom](nodes.ordering.md#isdistinctfrom)
- [isInfinity](nodes.ordering.md#isinfinity)
- [isNotDistinctFrom](nodes.ordering.md#isnotdistinctfrom)
- [isOpenEnded](nodes.ordering.md#isopenended)
- [isUnboundable](nodes.ordering.md#isunboundable)
- [lower](nodes.ordering.md#lower)
- [lt](nodes.ordering.md#lt)
- [ltAll](nodes.ordering.md#ltall)
- [ltAny](nodes.ordering.md#ltany)
- [lteq](nodes.ordering.md#lteq)
- [lteqAll](nodes.ordering.md#lteqall)
- [lteqAny](nodes.ordering.md#lteqany)
- [matches](nodes.ordering.md#matches)
- [matchesAll](nodes.ordering.md#matchesall)
- [matchesAny](nodes.ordering.md#matchesany)
- [matchesRegexp](nodes.ordering.md#matchesregexp)
- [maximum](nodes.ordering.md#maximum)
- [minimum](nodes.ordering.md#minimum)
- [multiply](nodes.ordering.md#multiply)
- [not](nodes.ordering.md#not)
- [notBetween](nodes.ordering.md#notbetween)
- [notEq](nodes.ordering.md#noteq)
- [notEqAll](nodes.ordering.md#noteqall)
- [notEqAny](nodes.ordering.md#noteqany)
- [notInAll](nodes.ordering.md#notinall)
- [notInAny](nodes.ordering.md#notinany)
- [notInVal](nodes.ordering.md#notinval)
- [nullsFirst](nodes.ordering.md#nullsfirst)
- [nullsLast](nodes.ordering.md#nullslast)
- [or](nodes.ordering.md#or)
- [quotedArray](nodes.ordering.md#quotedarray)
- [quotedNode](nodes.ordering.md#quotednode)
- [subtract](nodes.ordering.md#subtract)
- [sum](nodes.ordering.md#sum)
- [toSQL](nodes.ordering.md#tosql)
- [when](nodes.ordering.md#when)

## Constructors

### constructor

\+ **new Ordering**(`expr`: [_Visitable_](../modules/visitors.md#visitable)):
...
**Returns:** [_Ordering_](nodes.ordering.md)
...
Defined in:
[src/mixins/NullsFirstPredication.ts:6](https://github.com/sequeljs/ast/blob/6632050/src/mixins/NullsFirstPredication.ts#L6)
...
Defined in:
[src/mixins/NullsLastPredication.ts:6](https://github.com/sequeljs/ast/blob/6632050/src/mixins/NullsLastPredication.ts#L6)
