...
- [constructor](nodes.as.md#constructor)

### Properties

- [left](nodes.as.md#left)
- [right](nodes.as.md#right)
...
- [as](nodes.as.md#as)
- [asc](nodes.as.md#asc)
- [average](nodes.as.md#average)
- [between](nodes.as.md#between)
- [bitwiseAnd](nodes.as.md#bitwiseand)
- [bitwiseNot](nodes.as.md#bitwisenot)
- [bitwiseOr](nodes.as.md#bitwiseor)
- [bitwiseShiftLeft](nodes.as.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.as.md#bitwiseshiftright)
- [bitwiseXor](nodes.as.md#bitwisexor)
- [coalesce](nodes.as.md#coalesce)
- [concat](nodes.as.md#concat)
- [count](nodes.as.md#count)
- [createAnd](nodes.as.md#createand)
- [createFalse](nodes.as.md#createfalse)
- [createJoin](nodes.as.md#createjoin)
- [createOn](nodes.as.md#createon)
- [createStringJoin](nodes.as.md#createstringjoin)
- [createTableAlias](nodes.as.md#createtablealias)
- [createTrue](nodes.as.md#createtrue)
- [desc](nodes.as.md#desc)
- [divide](nodes.as.md#divide)
- [doesNotMatch](nodes.as.md#doesnotmatch)
- [doesNotMatchAll](nodes.as.md#doesnotmatchall)
- [doesNotMatchAny](nodes.as.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.as.md#doesnotmatchregexp)
- [eq](nodes.as.md#eq)
- [eqAll](nodes.as.md#eqall)
- [eqAny](nodes.as.md#eqany)
- [extract](nodes.as.md#extract)
- [grouping](nodes.as.md#grouping)
- [groupingAll](nodes.as.md#groupingall)
- [groupingAny](nodes.as.md#groupingany)
- [gt](nodes.as.md#gt)
- [gtAll](nodes.as.md#gtall)
- [gtAny](nodes.as.md#gtany)
- [gteq](nodes.as.md#gteq)
- [gteqAll](nodes.as.md#gteqall)
- [gteqAny](nodes.as.md#gteqany)
- [inAll](nodes.as.md#inall)
- [inAny](nodes.as.md#inany)
- [inVal](nodes.as.md#inval)
- [isDistinctFrom](nodes.as.md#isdistinctfrom)
- [isInfinity](nodes.as.md#isinfinity)
- [isNotDistinctFrom](nodes.as.md#isnotdistinctfrom)
- [isOpenEnded](nodes.as.md#isopenended)
- [isUnboundable](nodes.as.md#isunboundable)
- [lower](nodes.as.md#lower)
- [lt](nodes.as.md#lt)
- [ltAll](nodes.as.md#ltall)
- [ltAny](nodes.as.md#ltany)
- [lteq](nodes.as.md#lteq)
- [lteqAll](nodes.as.md#lteqall)
- [lteqAny](nodes.as.md#lteqany)
- [matches](nodes.as.md#matches)
- [matchesAll](nodes.as.md#matchesall)
- [matchesAny](nodes.as.md#matchesany)
- [matchesRegexp](nodes.as.md#matchesregexp)
- [maximum](nodes.as.md#maximum)
- [minimum](nodes.as.md#minimum)
- [multiply](nodes.as.md#multiply)
- [not](nodes.as.md#not)
- [notBetween](nodes.as.md#notbetween)
- [notEq](nodes.as.md#noteq)
- [notEqAll](nodes.as.md#noteqall)
- [notEqAny](nodes.as.md#noteqany)
- [notInAll](nodes.as.md#notinall)
- [notInAny](nodes.as.md#notinany)
- [notInVal](nodes.as.md#notinval)
- [or](nodes.as.md#or)
- [quotedArray](nodes.as.md#quotedarray)
- [quotedNode](nodes.as.md#quotednode)
- [subtract](nodes.as.md#subtract)
- [sum](nodes.as.md#sum)
- [toSQL](nodes.as.md#tosql)
- [when](nodes.as.md#when)

## Constructors

### constructor

\+ **new As**(`left`: _any_, `right`: _any_): [_As_](nodes.as.md)
