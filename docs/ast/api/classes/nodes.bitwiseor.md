...
[Nodes](../modules/nodes.md) / BitwiseOr
...
- [constructor](nodes.bitwiseor.md#constructor)

### Properties

- [left](nodes.bitwiseor.md#left)
- [operator](nodes.bitwiseor.md#operator)
- [right](nodes.bitwiseor.md#right)

### Methods

- [add](nodes.bitwiseor.md#add)
- [and](nodes.bitwiseor.md#and)
- [as](nodes.bitwiseor.md#as)
- [asc](nodes.bitwiseor.md#asc)
- [average](nodes.bitwiseor.md#average)
- [between](nodes.bitwiseor.md#between)
- [bitwiseAnd](nodes.bitwiseor.md#bitwiseand)
- [bitwiseNot](nodes.bitwiseor.md#bitwisenot)
- [bitwiseOr](nodes.bitwiseor.md#bitwiseor)
- [bitwiseShiftLeft](nodes.bitwiseor.md#bitwiseshiftleft)
- [bitwiseShiftRight](nodes.bitwiseor.md#bitwiseshiftright)
- [bitwiseXor](nodes.bitwiseor.md#bitwisexor)
- [coalesce](nodes.bitwiseor.md#coalesce)
- [concat](nodes.bitwiseor.md#concat)
- [count](nodes.bitwiseor.md#count)
- [createAnd](nodes.bitwiseor.md#createand)
- [createFalse](nodes.bitwiseor.md#createfalse)
- [createJoin](nodes.bitwiseor.md#createjoin)
- [createOn](nodes.bitwiseor.md#createon)
- [createStringJoin](nodes.bitwiseor.md#createstringjoin)
- [createTableAlias](nodes.bitwiseor.md#createtablealias)
- [createTrue](nodes.bitwiseor.md#createtrue)
- [desc](nodes.bitwiseor.md#desc)
- [divide](nodes.bitwiseor.md#divide)
- [doesNotMatch](nodes.bitwiseor.md#doesnotmatch)
- [doesNotMatchAll](nodes.bitwiseor.md#doesnotmatchall)
- [doesNotMatchAny](nodes.bitwiseor.md#doesnotmatchany)
- [doesNotMatchRegexp](nodes.bitwiseor.md#doesnotmatchregexp)
- [eq](nodes.bitwiseor.md#eq)
- [eqAll](nodes.bitwiseor.md#eqall)
- [eqAny](nodes.bitwiseor.md#eqany)
- [extract](nodes.bitwiseor.md#extract)
- [grouping](nodes.bitwiseor.md#grouping)
- [groupingAll](nodes.bitwiseor.md#groupingall)
- [groupingAny](nodes.bitwiseor.md#groupingany)
- [gt](nodes.bitwiseor.md#gt)
- [gtAll](nodes.bitwiseor.md#gtall)
- [gtAny](nodes.bitwiseor.md#gtany)
- [gteq](nodes.bitwiseor.md#gteq)
- [gteqAll](nodes.bitwiseor.md#gteqall)
- [gteqAny](nodes.bitwiseor.md#gteqany)
- [inAll](nodes.bitwiseor.md#inall)
- [inAny](nodes.bitwiseor.md#inany)
- [inVal](nodes.bitwiseor.md#inval)
- [isDistinctFrom](nodes.bitwiseor.md#isdistinctfrom)
- [isInfinity](nodes.bitwiseor.md#isinfinity)
- [isNotDistinctFrom](nodes.bitwiseor.md#isnotdistinctfrom)
- [isOpenEnded](nodes.bitwiseor.md#isopenended)
- [isUnboundable](nodes.bitwiseor.md#isunboundable)
- [lower](nodes.bitwiseor.md#lower)
- [lt](nodes.bitwiseor.md#lt)
- [ltAll](nodes.bitwiseor.md#ltall)
- [ltAny](nodes.bitwiseor.md#ltany)
- [lteq](nodes.bitwiseor.md#lteq)
- [lteqAll](nodes.bitwiseor.md#lteqall)
- [lteqAny](nodes.bitwiseor.md#lteqany)
- [matches](nodes.bitwiseor.md#matches)
- [matchesAll](nodes.bitwiseor.md#matchesall)
- [matchesAny](nodes.bitwiseor.md#matchesany)
- [matchesRegexp](nodes.bitwiseor.md#matchesregexp)
- [maximum](nodes.bitwiseor.md#maximum)
- [minimum](nodes.bitwiseor.md#minimum)
- [multiply](nodes.bitwiseor.md#multiply)
- [not](nodes.bitwiseor.md#not)
- [notBetween](nodes.bitwiseor.md#notbetween)
- [notEq](nodes.bitwiseor.md#noteq)
- [notEqAll](nodes.bitwiseor.md#noteqall)
- [notEqAny](nodes.bitwiseor.md#noteqany)
- [notInAll](nodes.bitwiseor.md#notinall)
- [notInAny](nodes.bitwiseor.md#notinany)
- [notInVal](nodes.bitwiseor.md#notinval)
- [or](nodes.bitwiseor.md#or)
- [quotedArray](nodes.bitwiseor.md#quotedarray)
- [quotedNode](nodes.bitwiseor.md#quotednode)
- [subtract](nodes.bitwiseor.md#subtract)
- [sum](nodes.bitwiseor.md#sum)
- [toSQL](nodes.bitwiseor.md#tosql)
- [when](nodes.bitwiseor.md#when)

## Constructors

### constructor

\+ **new BitwiseOr**(`left`: _any_, `right`: _any_):
...
**Returns:** [_BitwiseOr_](nodes.bitwiseor.md)

Inherited from: [InfixOperation](nodes.infixoperation.md)

Defined in:
[src/nodes/BitwiseOr.ts:3](https://github.com/sequeljs/ast/blob/6632050/src/nodes/BitwiseOr.ts#L3)
